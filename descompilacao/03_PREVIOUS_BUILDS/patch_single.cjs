const fs = require('fs');
const filePath = 'D:/naruto Online/single_class_as3/scripts/Processors/Game/Lobby/Account/TProcessorAccount.as';
...
if (!regex.test(content)) {
  ...
  console.log('Successfully patched single_class_as3 TProcessorAccount.as!');
}
