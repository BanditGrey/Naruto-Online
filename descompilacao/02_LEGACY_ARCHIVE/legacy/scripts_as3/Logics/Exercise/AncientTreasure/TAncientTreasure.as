package Logics.Exercise.AncientTreasure
{
   import Logics.Exercise.TBaseActivity;
   import Logics.Exercise.TBaseBox;
   import Logics.Inventories.TInventories;
   
   public class TAncientTreasure extends TBaseActivity
   {
      ...
      public function TAncientTreasure()
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         super();
      ...
      public function CheckStatus() : Boolean
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(this.FSignStatus == TBaseActivity.STATUS_CANGET)
         {
            return true;
         }
         return false;
