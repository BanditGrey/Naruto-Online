package Logics.Exercise.NinjaTreasure
{
   ...
   public class TNinjaTreasureDatas
   {
      ...
      public function TNinjaTreasureDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TNinjaTreasure1,TNinjaTreasure2,TNinjaTreasure5,TNinjaTreasure6]);
         super();
      ...
      public function ChangeSingleActivityStatus(param1:int) : Boolean
      {
         ...
         switch(param1)
         {
            ...
            case ACTIVITY_2_ID:
               ...
               break;
            case ACTIVITY_3_ID:
               _loc2_ = this.ChangeStatus5();
               break;
            case ACTIVITY_4_ID:
               _loc2_ = this.ChangeStatus6();
         }
      ...
      public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TNinjaTreasure1 = null;
         _loc3_ = this.FActivities[0] as TNinjaTreasure1;
      ...
      public function ChangeStatus2() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TNinjaTreasure2 = null;
         _loc3_ = this.FActivities[1] as TNinjaTreasure2;
      ...
      public function ChangeStatus3() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TNinjaTreasure3 = null;
         _loc3_ = this.FActivities[2] as TNinjaTreasure3;
         _loc2_ = int(_loc3_.ArrestCountReward.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            if(_loc3_.ArrestCountReward[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
         }
         _loc2_ = int(_loc3_.OpenBoxReward.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            if(_loc3_.OpenBoxReward[_loc1_].Min >= _loc3_.OpenBoxReward[_loc1_].Max)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
         }
         _loc2_ = int(_loc3_.RewardList.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            if(_loc3_.RewardList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
         }
         if(_loc3_.SpecialReward[0].Status == TBaseActivity.STATUS_CANGET)
         {
            return TBaseActivity.STATUS_CANGET;
         }
         return TBaseActivity.STATUS_CANNOTGET;
      ...
      public function ChangeStatus5() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TNinjaTreasure5 = null;
         _loc3_ = this.FActivities[2] as TNinjaTreasure5;
         _loc1_ = 0;
      ...
      public function ChangeStatus6() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TNinjaTreasure6 = null;
         _loc3_ = this.FActivities[3] as TNinjaTreasure6;
         if(_loc3_.Count > 0)
         {
            return TBaseActivity.STATUS_CANGET;
         }
