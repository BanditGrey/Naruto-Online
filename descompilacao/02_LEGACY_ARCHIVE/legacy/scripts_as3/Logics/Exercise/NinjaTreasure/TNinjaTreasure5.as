package Logics.Exercise.NinjaTreasure
{
   ...
   public class TNinjaTreasure5 extends TBaseActivity
   {
      ...
      public function TNinjaTreasure5()
      {
         super();
      ...
      public function ChangeStatus() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(this.FHeroList.length > 0)
         {
            if(this.FHeroList[0].Status == TBaseActivity.STATUS_CANNOTGET && FRankPoint >= this.FHeroList[0].Price)
            {
