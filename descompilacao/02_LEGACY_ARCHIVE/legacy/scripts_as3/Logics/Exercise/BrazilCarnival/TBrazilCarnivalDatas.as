package Logics.Exercise.BrazilCarnival
{
   ...
   public class TBrazilCarnivalDatas
   {
      ...
      public function TBrazilCarnivalDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TBrazilCarnivalSign,TBrazilCarnivalColorEgg,TBrazilCarnivalRank,TBrazilCarnivalSock]);
         super();
      ...
      public function ChangeSingleActivityStatus(param1:int) : Boolean
      {
         ...
         {
            case ACTIVITY_1_ID:
               _loc2_ = (this.FActivities[0] as TBrazilCarnivalSign).CurStatus;
               break;
            case ACTIVITY_2_ID:
      ...
      public function ChangeColorEggStatus() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TBrazilCarnivalColorEgg = null;
         _loc3_ = this.FActivities[1] as TBrazilCarnivalColorEgg;
      ...
      public function ChangeRankStatus() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TBrazilCarnivalRank = null;
         _loc3_ = this.FActivities[2] as TBrazilCarnivalRank;
         _loc1_ = 0;
         while(_loc1_ < _loc3_.BoxList.length)
         {
            if(_loc3_.BoxList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
      ...
      public function ChangeSockStatus() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TBrazilCarnivalSock = null;
         _loc3_ = this.FActivities[3] as TBrazilCarnivalSock;
         return TBaseActivity.STATUS_CANNOTGET;
      }
