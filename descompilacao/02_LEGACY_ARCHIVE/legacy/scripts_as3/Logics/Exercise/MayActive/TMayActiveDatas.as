package Logics.Exercise.MayActive
{
   ...
   public class TMayActiveDatas
   {
      ...
      public function TMayActiveDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TMayActive1,TMayActive2,TMayActive3,TMayActive4]);
         super();
      ...
      public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TMayActive1 = null;
         _loc3_ = this.FActivities[0] as TMayActive1;
      ...
      public function ChangeStatus3() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TMayActive3 = null;
         _loc3_ = this.FActivities[2] as TMayActive3;
         _loc2_ = int(_loc3_.GiftList.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            if(_loc3_.GiftList[_loc1_].Count > 0)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
         }
         _loc2_ = int(_loc3_.KillReward.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            if(_loc3_.KillReward[_loc1_].Count >= _loc3_.KillReward[_loc1_].Price)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
      ...
      public function ChangeStatus4() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TMayActive4 = null;
         _loc3_ = this.FActivities[3] as TMayActive4;
         if(_loc3_.Count > 0)
         {
            return TBaseActivity.STATUS_CANGET;
         }
