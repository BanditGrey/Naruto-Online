package Logics.Streamization.WorldMatch
{
   ...
   public class TUnstreamizerWorldMatchStreak extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerWorldMatchStreak()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         _loc7_ = param2 as Dictionary;
         _loc4_ = uint(param1.readShort());
         _loc5_ = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = new TWorldMatchStreak();
            ...
            _loc7_[_loc6_.Identifier] = _loc6_;
            this.UnstreamizationInventory(null,_loc6_,_loc6_.GlobalArenaStreak);
            _loc5_++;
         }
      }
      ...
      protected function UnstreamizationInventory(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc10_:TGlobalArenaStreak = null;
         var _loc11_:TWorldMatchStreak = null;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         var _loc15_:int = 0;
         ...
         _loc11_ = param2 as TWorldMatchStreak;
         _loc10_ = param3 as TGlobalArenaStreak;
         _loc12_ = int(_loc10_.RewardArr.length);
         _loc13_ = 0;
         while(_loc13_ < _loc12_)
         {
            _loc9_ = _loc10_.RewardArr[_loc13_];
         ...
         _loc6_.length = 0;
         _loc7_.length = 0;
         _loc12_ = int(_loc10_.Rewards1Arr.length);
         _loc13_ = 0;
         while(_loc13_ < _loc12_)
         {
            _loc9_ = _loc10_.Rewards1Arr[_loc13_];
            _loc15_ = int(_loc9_.type);
            _loc16_ = int(_loc9_.code);
            _loc14_ = int(CONST_COMMON.GetItemIDByType(_loc15_,_loc16_,_loc8_));
            _loc6_.push(_loc14_);
