package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerBaseInventories extends TUnstreamizer
   {
      ...
      public function TUnstreamizerBaseInventories()
      {
         super();
