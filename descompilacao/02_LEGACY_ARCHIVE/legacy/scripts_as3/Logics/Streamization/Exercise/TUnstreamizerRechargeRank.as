package Logics.Streamization.Exercise
{
   ...
   import Logics.Exercise.RechargeRank.TRechargeRankInfo;
   import Logics.Exercise.RechargeRank.TRechargeRankReward;
   ...
   public class TUnstreamizerRechargeRank extends TUnstreamizer
   {
      
      public var TAB_TYPE_TOTAL_RANK:int = TProcessorRechargeRank.TAB_TYPE_TOTAL_RANK;
      
      public var TAB_TYPE_POINT_REWARD:int = TProcessorRechargeRank.TAB_TYPE_POINT_REWARD;
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerRechargeRank()
      {
         super();
      ...
      {
         var _loc4_:TRechargeRank = null;
         _loc4_ = SLogicsCore.RechargeRank;
         _loc4_ = param2 as TRechargeRank;
      ...
      protected function UnstreamizationPerform_TotalRank(param1:ByteArray, param2:Object) : void
      {
         ...
         var _loc16_:TRechargeRank = null;
         var _loc17_:TRechargeRankInfo = null;
         var _loc18_:TRechargeRankReward = null;
         var _loc19_:TBins = null;
         _loc19_ = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_Article);
         _loc16_ = param2 as TRechargeRank;
         ...
         while(_loc3_ < _loc5_)
         {
            _loc18_ = new TRechargeRankReward();
         ...
         while(_loc3_ < _loc5_)
         {
            ...
            _loc9_ = CONST_COMMON.GetItemIDByType(_loc8_,_loc7_,_loc19_);
            _loc12_.push(_loc9_);
         ...
         _loc16_.RechargeShowItems = _loc11_;
         _loc12_.length = 0;
         _loc13_.length = 0;
         _loc14_.length = 0;
         _loc15_.length = 0;
         ...
         _loc16_.RechargeEquipments = _loc11_;
      }
      ...
      protected function UnstreamizationPerform_PointReward(param1:ByteArray, param2:Object) : void
      {
         ...
         var _loc11_:TRechargeRank = null;
         var _loc12_:TPerReward = null;
         _loc11_ = param2 as TRechargeRank;
