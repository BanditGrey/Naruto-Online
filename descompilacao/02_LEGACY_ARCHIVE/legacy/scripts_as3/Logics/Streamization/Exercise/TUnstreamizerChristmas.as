package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerChristmas extends TUnstreamizer
   {
      ...
      public function TUnstreamizerChristmas()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:TChristmasDatas = null;
         var _loc7_:TBaseActivity = null;
         var _loc8_:int = 0;
         var _loc9_:TBins = null;
         _loc6_ = param2 as TChristmasDatas;
         ...
         {
            case ACTIVITY_1_ID:
               this.UnstreamizationPerform_ChristmasSign(param1,_loc6_,_loc9_);
               break;
            case ACTIVITY_2_ID:
               this.UnstreamizationPerform_ChristmasCollect(param1,_loc6_,_loc9_);
               break;
            case ACTIVITY_3_ID:
               this.UnstreamizationPerform_ChristmasColorEgg(param1,_loc6_,_loc9_);
               break;
            case ACTIVITY_4_ID:
               this.UnstreamizationPerform_ChristmasRank(param1,_loc6_,_loc9_);
               break;
            case ACTIVITY_5_ID:
               this.UnstreamizationPerform_ChristmasSock(param1,_loc6_,_loc9_);
         }
      }
      
      protected function UnstreamizationPerform_ChristmasSign(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         ...
         var _loc16_:TChristmasDatas = null;
         var _loc17_:TChristmasSign = null;
         _loc13_ = new Vector.<uint>();
         _loc14_ = new Vector.<uint>();
         _loc16_ = param2 as TChristmasDatas;
         _loc17_ = _loc16_.GetActivityByIdentify(ACTIVITY_1_ID) as TChristmasSign;
      ...
      protected function UnstreamizationPerform_ChristmasCollect(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         ...
         var _loc15_:TBaseBox = null;
         var _loc16_:TChristmasDatas = null;
         var _loc17_:TChristmasCollect = null;
         _loc13_ = new Vector.<uint>();
         _loc14_ = new Vector.<uint>();
         _loc16_ = param2 as TChristmasDatas;
         _loc17_ = _loc16_.GetActivityByIdentify(ACTIVITY_2_ID) as TChristmasCollect;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc17_.ActivityDesc = TUtilityString.FetchUTF(param1);
         _loc17_.CollectNum = param1.readUnsignedInt();
      ...
      protected function UnstreamizationPerform_ChristmasColorEgg(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         ...
         _loc14_ = new Vector.<uint>();
         _loc16_ = param2 as TChristmasDatas;
         _loc17_ = _loc16_.GetActivityByIdentify(ACTIVITY_3_ID) as TChristmasColorEgg;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc17_.ActivityDesc = TUtilityString.FetchUTF(param1);
      ...
      protected function UnstreamizationPerform_ChristmasRank(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         ...
         var _loc15_:TBaseBox = null;
         var _loc16_:TChristmasDatas = null;
         var _loc17_:TChristmasRank = null;
         _loc13_ = new Vector.<uint>();
         _loc14_ = new Vector.<uint>();
         _loc16_ = param2 as TChristmasDatas;
         _loc17_ = _loc16_.GetActivityByIdentify(ACTIVITY_4_ID) as TChristmasRank;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc17_.ActivityDesc = TUtilityString.FetchUTF(param1);
         _loc17_.ActivityName = TUtilityString.FetchUTF(param1);
      ...
      protected function UnstreamizationPerform_ChristmasSock(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         ...
         _loc14_ = new Vector.<uint>();
         _loc16_ = param2 as TChristmasDatas;
         _loc17_ = _loc16_.GetActivityByIdentify(ACTIVITY_5_ID) as TChristmasSock;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc17_.ActivityDesc = TUtilityString.FetchUTF(param1);
         _loc17_.Score = param1.readUnsignedInt();
