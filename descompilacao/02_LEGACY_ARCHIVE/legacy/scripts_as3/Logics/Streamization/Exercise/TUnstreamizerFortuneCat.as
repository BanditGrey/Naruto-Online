package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerFortuneCat extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerFortuneCat()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc17_:TFortuneCat = null;
         _loc13_ = new Vector.<uint>();
         _loc14_ = new Vector.<uint>();
         _loc17_ = param2 as TFortuneCat;
         _loc15_ = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_Article);
         _loc17_.Identify = CONST_BASEACTIVITY.TYPE_NewActiveList_FortuneCat;
         ...
         _loc17_.NeedGold = param1.readInt();
         _loc17_.NeedVip = param1.readInt();
         _loc17_.RechargeGold = param1.readInt();
         _loc17_.CurCount = param1.readUnsignedInt();
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc17_.ConsumeGift[_loc4_] = _loc16_;
            _loc4_++;
         }
      }
