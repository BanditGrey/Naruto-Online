package Logics.DatebaseVO.VO
{
   ...
   public class TArchiveUpgrade extends TDatebaseVO
   {
      ...
      protected var FAddAttribute:uint;
      
      public function TArchiveUpgrade()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         param1.writeUnsignedInt(this.FAddAttribute);
      }
      ...
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         ...
         this.FAddAttribute = param1.readUnsignedInt();
      }
      ...
      public function get AddAttribute() : uint
      {
