package Logics.DatebaseVO.VO
{
   ...
   public class TPetImage extends TDatebaseVO
   {
      ...
      protected var FHeadPic:int;
      
      public function TPetImage()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         TUtilityString.FlushUTF(param1,this.FLockDesc);
         param1.writeUnsignedInt(this.FHeadPic);
      }
      ...
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         ...
         this.FLockDesc = TUtilityString.FetchUTF(param1);
         this.FHeadPic = param1.readUnsignedInt();
      }
      ...
      public function get HeadPic() : int
      {
