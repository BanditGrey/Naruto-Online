package Rendering.Overlayers.TongLingAnimal
{
   ...
   public class TongLingOtherMsg extends TOverlayer
   {
      ...
      public static var TongLingMsgTip:TongLingOtherMsg = null;
      ...
      public function TongLingOtherMsg(param1:TUIComponent)
      {
         ...
         this.namePainter = ConstructPainterTextEffect(COLOR_ContextDefault);
      ...
      public static function getTipIntence(param1:TUIComponent) : TongLingOtherMsg
      {
         if(!TongLingMsgTip)
         {
            TongLingMsgTip = new TongLingOtherMsg(param1);
         }
      ...
      override protected function EvaluationPerform_Context() : void
      {
         ...
         while(_loc3_ < 5)
         {
            this.VecFivePainter[_loc3_].visible = false;
            this.VecFiveBound[_loc3_].Y = 0;
            _loc3_++;
         }
         this.b = 0;
         ...
         else
         {
            ...
            while(_loc6_ < this.TongLingArr.length)
            {
               ...
               {
                  BoundsAlignDown(this.VecFiveBound[_loc6_ + _loc2_]);
                  this.VecFivePainter[_loc6_ + _loc2_].Text = STRING_TONGLING.TONGLING_XIE + ":  " + _loc4_.Name + STRING_COMMON.FORMAT_Level + _loc7_.lv + "\n";
                  this.VecFivePainter[_loc6_ + _loc2_].Font.Color = QUALITYCOLOR_INDEX[_loc4_.Rarity];
                  this.VecFivePainter[_loc6_ + _loc2_].Evaluate(this.VecFiveBound[_loc6_ + _loc2_]);
                  BoundsContextUnion(this.VecFiveBound[_loc6_ + _loc2_]);
                  this.VecFivePainter[_loc6_ + _loc2_].visible = true;
               }
               _loc6_++;
            }
         }
