package Rendering.Overlayers.NationalDay
{
   ...
   public class TOverlayerFund extends TOverlayer
   {
      ...
      public function TOverlayerFund(param1:TUIComponent)
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         ...
         this.FPainterExplain2 = ConstructPainterTextEffect(QUALITYCOLOR_Blue);
      ...
      protected function EvaluationPerform_Explain2() : void
      {
         ...
         this.FBaseBox = FContext as TBaseBox;
         this.FContextExplain2 = "";
         this.FContextExplain2 = "\n" + TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_BAR_TEXT2,this.FBaseBox.Price);
