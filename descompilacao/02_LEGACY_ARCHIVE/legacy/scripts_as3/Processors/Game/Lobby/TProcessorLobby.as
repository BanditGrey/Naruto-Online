package Processors.Game.Lobby
{
   ...
   public class TProcessorLobby extends TProcessorGame
   {
      ...
      protected function ConstructProcessorsWindows() : void
      {
         ...
         this.FProcessorWarehouse.OnDialogMsg = this.ProcessorOnDialogMsg;
         ...
         .FProcessorAccountTransfer,this.FProcessorWindowUndertown,this.FProcessorOnLineLiBao,this.FProcessorZhenAoYi,this.FProcessorMasterRoadOld,this.FProcessorLostShenQiMain,this.FProcessorWing,this.FProcessorWindowAddSoul,this.FProcessorIllustrated,this.FProcessorMarried,this.FProcessorHomeland,this.FProcessorMarryRank,this.FSpecialJade,this.FProcessorAline,this.FProcessorRank,this.FProcessorKingWar,this.FProcessorVipWelfare,this.FProcessorMicrologinLibao,this.FProcessorMedal,this.FProcessorInviteCode,this.FProcessorWuxing,this.FProcessorWarehouse,this.FProcessorDiscord,this.FProcessorWindowShop,this.FProcessorConsumeVip,this.FProcessorEmblem,this.FProcessorChristmasDay,this.FProcessorNinjaTalent,this.FProcessorChallengeCamp,this.FProcessorTalentLevelGifts,this.FProcessorHeroLevelGifts,this.FProcessorWorldMatchStreak,this.FProcessorGlobalBoss,this.FProcessorGlobalBossMain,this.FProcessorGlobalbossChapter,this.FProcessorDayRechargeGift,this.FProcessorRecruit,this.FProcessorSlave,this.FProcessorTalentGifts
         ,this.FProcessorLeadLevelGifts]);
      }
      ...
      protected function PacketPerform_SC_Enter_Town(param1:TPacket) : void
      {
         ...
         if(Boolean(SParametersCore.Is1377Display) || Boolean(SParametersCore.IsBound))
         {
            ...
            {
               this.ProcessorShortcutAccountTransfer(null);
            }
         }
      }
