package Processors.Game.Lobby.ActivityInner.Components
{
   ...
   public class TActivityRewardPsychicBeast extends TUIComponent
   {
      ...
      public function TActivityRewardPsychicBeast(param1:TUIComponent, param2:int = 0, param3:int = 4)
      {
         super(param1);
         this.FCount = param3;
         this.FType = param2;
      ...
      protected function Initialization() : void
      {
         ...
         this.FMC_RewardItem = TUtilityReflection.CreateDisplayObjectInstance(CONST_ACTIVITYINNER.RESOURCE_ClassName_MC_RewardPsychicBeastItem) as MovieClip;
         this.FTF_RankText = this.FMC_RewardItem["TF_Tip"];
      ...
      {
         if(param1 >= this.FSlotList.length)
         {
            return;
         }
