package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   public class TProcessorWindowActivityInnerTalisman extends TProcessorWindowWonderfulActivity
   {
      ...
      protected static const KEY_Talisman_Power:uint = CONST_COUNTER.KEY_Talisman_Power;
      
      protected static const KEY_Talisman_Intellect:uint = CONST_COUNTER.KEY_Talisman_Intellect;
      
      protected static const KEY_Talisman_Life:uint = CONST_COUNTER.KEY_Talisman_Life;
      
      protected static const KEY_Talisman_Agility:uint = CONST_COUNTER.KEY_Talisman_Agility;
      ...
      public function TProcessorWindowActivityInnerTalisman(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function LogicsPerform_Signals() : void
      {
         ...
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         _loc1_ = SLogicsCore.SignalRetrieve(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_Talisman_Ret);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         switch(_loc2_)
         {
            case KEY_Talisman_Power:
               this.FCurNCount[0] = _loc3_;
               break;
            case KEY_Talisman_Intellect:
               this.FCurNCount[1] = _loc3_;
               break;
            case KEY_Talisman_Life:
               this.FCurNCount[2] = _loc3_;
               break;
            case KEY_Talisman_Agility:
      ...
      protected function UpdateReward() : void
      {
         ...
         while(_loc10_ < ROW_COUNT)
         {
            ...
            _loc4_ = STRING_ACTIVITYINNER.STRING_TALISMAN_LEVEL[_loc10_];
      ...
      {
         this.FCountKey.push(KEY_Talisman_Power);
         this.FCountKey.push(KEY_Talisman_Intellect);
         this.FCountKey.push(KEY_Talisman_Life);
         this.FCountKey.push(KEY_Talisman_Agility);
         SLogicsCore.SignalPost(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_Talisman_Req,0,0,this.FCountKey);
      }
