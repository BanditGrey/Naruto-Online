package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   import Rendering.Overlayers.PurpleNinja.TOverlayerPurpleNinja;
   ...
   public class TProcessorWindowActivityInnerPurpleNinja extends TProcessorWindowWonderfulActivity
   {
      ...
      protected static const KEY_PurpleNinja_lv30:uint = CONST_COUNTER.KEY_PurpleNinja_lv30;
      
      protected static const KEY_PurpleNinja_lv50:uint = CONST_COUNTER.KEY_PurpleNinja_lv50;
      ...
      protected var FOverlayerHint:TOverlayerPurpleNinja;
      
      public function TProcessorWindowActivityInnerPurpleNinja(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function LogicsPerform() : void
      {
         ...
         if(this.FInitialized && this.Visible)
         {
            ...
            _loc6_ = 0;
            while(_loc6_ < this.FRewardList.length)
            {
               _loc5_ = this.FActivityAtoms.GetActivityAtomByIndex(_loc6_).Tips[0];
               this.FRewardList[_loc6_].UpdateSlot();
               this.FRewardList[_loc6_].setTipStr(_loc5_);
               _loc1_ = _loc5_.indexOf(":") + 1;
               if(_loc1_ >= 0)
               {
                  this.FOverlayerHint.BeginIndex = _loc1_;
               }
               _loc6_++;
            }
         }
      ...
      protected function LogicsPerform_Signals() : void
      {
         ...
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         _loc1_ = SLogicsCore.SignalRetrieve(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_PurpleNinja_Ret);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function UpdateReward() : void
      {
         ...
         while(_loc10_ < this.FActivityAtoms.Count)
         {
            ...
            this.FRewardList[_loc10_].SetTextFormat(1);
      ...
      {
         this.FCountKey.push(KEY_PurpleNinja_lv30);
         this.FCountKey.push(KEY_PurpleNinja_lv50);
         SLogicsCore.SignalPost(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_PurpleNinja_Req,0,0,this.FCountKey);
      }
      ...
      override protected function MouseOnHitOver(param1:Object, param2:THint) : void
      {
         var _loc3_:TCoordinate = new TCoordinate();
         this.FOverlayerHint.Context = param2;
         this.FOverlayerHint.Render(FUICore.MouseCoordinate);
         this.FOverlayerHint.Visible = true;
      }
      
      override protected function MouseOnHitOut(param1:Object) : void
      {
      ...
      public function Init(param1:MovieClip) : void
      {
         ...
         while(_loc2_ < _loc3_)
         {
            ...
            _loc4_.HintOnMove = this.MouseOnHitOver;
            _loc4_.HintOnOut = this.MouseOnHitOut;
            _loc4_.Init();
         ...
         this.FOverlayerHint = new TOverlayerPurpleNinja(this.Parent.Parent);
         this.FOverlayerHint.visible = false;
