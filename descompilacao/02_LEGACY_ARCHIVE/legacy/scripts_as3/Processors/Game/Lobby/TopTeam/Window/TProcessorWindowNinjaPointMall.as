package Processors.Game.Lobby.TopTeam.Window
{
   ...
   import Processors.Game.Windows.Information.TUIWindowBuyGoods;
   ...
   public class TProcessorWindowNinjaPointMall extends TProcessorWindowTemplate
   {
      ...
      protected var FUIWindowBuyGoods:TUIWindowBuyGoods;
      ...
      public function TProcessorWindowNinjaPointMall(param1:TUIComponent)
      {
         super(param1);
         this.Init();
      }
      ...
      {
         this.FMallItemList = new Vector.<TUIMallItem>(CONST_TOPTEAM.Capacity_MallItems);
         this.FMC_Tab = new TUITab(this);
         this.FUIPage = new TUIPage(this);
         this.FCurrentInventorySamples = new TInventorySamples();
         this.FInventorySamples = SLogicsCore.TopTeamData.InventorySamples;
      }
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         FMainUI = TUtilityReflection.CreateDisplayObjectInstance("MC_NinjaPointMall") as Sprite;
         UIDispatch();
         _loc2_ = CONST_TOPTEAM.Capacity_Tabs;
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
         ...
         _loc6_.text = "0/0";
         this.FUIPage.PageSize = CONST_TOPTEAM.Capacity_MallItems;
         this.FUIPage.Init();
         ...
         this.FUIWindowBuyGoods = new TUIWindowBuyGoods(this,CONST_MODULES.MODULE_TopTeam);
      ...
      {
         this.FTF_NinjaPoint.text = SLogicsCore.TopTeamData.NinjaPoint.toString();
      }
      ...
      {
         if(SLogicsCore.TopTeamData.NinjaPoint <= 0)
         {
            FOnEffectText(STRING_TOPTEAM.STRING_NinjaPointUseless);
            return;
         }
         this.FUIWindowBuyGoods.Reset();
         if(this.FOnMallBuy != null)
         {
            this.FOnMallBuy(this,this.FUIWindowBuyGoods.Value,this.FInventorySample.Indentifier);
         }
      }
      ...
      protected function ProcessorLookUpOnClick(param1:Object, param2:Object) : void
      {
         ...
         this.FProcessorWindowRecruit.SetHeroData(_loc4_.FunctionValue);
      }
      ...
      protected function SlotsOnQuerySequenceContext(param1:Object, param2:Object, param3:TQueryAnimationSequence, param4:uint = 0) : void
      {
         ...
         {
            _loc6_.LoadSecondary(_loc5_.IDTexture,CONST_MODULES.MODULE_TopTeam);
         }
      }
