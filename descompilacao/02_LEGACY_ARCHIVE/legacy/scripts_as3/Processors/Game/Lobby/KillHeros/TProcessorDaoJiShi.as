package Processors.Game.Lobby.KillHeros
{
   ...
   public class TProcessorDaoJiShi extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorDaoJiShi(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FThisPanel = TUtilityReflection.CreateDisplayObjectInstance("MC_WanXaingDaoJiShi") as Sprite;
