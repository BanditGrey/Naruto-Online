package Processors.Game.Lobby.Exercise.NinjaTreasure
{
   ...
   public class TProcessorNinjaTreasureRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorNinjaTreasureRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550136849);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_NinjaTreasureRank") as MovieClip;
      ...
      {
         if(this.FNinjaTreasure5.MyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FNinjaTreasure5.MyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FNinjaTreasure5.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FNinjaTreasure5.RankRewardList.length)
            {
               _loc4_ = this.FNinjaTreasure5.RankRewardList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FNinjaTreasure5.RankList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FNinjaTreasure5.RankList.length)
            {
               _loc8_ = this.FNinjaTreasure5.RankList[_loc2_];
               if(this.FCurPage == 0)
               {
