package Processors.Game.Lobby.Exercise.SpringFestival.Compoents
{
   ...
   public class TUISpringFestivalTaiko extends TUIBaseWindow
   {
      ...
      protected var FSpringFestivalTaiko:TSpringFestivalTaiko;
      
      protected var FTextFormat:TextFormat;
      
      public function TUISpringFestivalTaiko(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function Resources_UIDispatch(param1:MovieClip) : void
      {
         ...
         TGameUtil.setButtonMode(FMC_Scene.MC_Drum,true);
         FMC_Scene.MC_Drum.addEventListener(MouseEvent.CLICK,this.ProcessorOnClickTaiko);
         ...
         FMC_Scene.MC_Stick.mouseChildren = false;
         FMC_Scene.MC_Click.mouseEnabled = false;
         FMC_Scene.MC_Stick.mouseEnabled = false;
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         while(_loc1_ < BOX_COUNT)
         {
            ...
            if(_loc1_ < this.FSpringFestivalTaiko.BoxList.length)
            {
               _loc4_ = this.FSpringFestivalTaiko.BoxList[_loc1_];
               _loc5_ = this.FSpringFestivalTaiko.BoxList[this.FSpringFestivalTaiko.BoxList.length - 1];
               _loc3_.MC_Count.TF_Count.text = "*" + (_loc4_.Price + (this.FSpringFestivalTaiko.Round - 1) * _loc5_.Price);
      ...
      protected function UpdateHero() : void
      {
         ...
         while(_loc1_ < HERO_COUNT)
         {
            ...
            if(_loc1_ < this.FSpringFestivalTaiko.HeroList.length)
            {
               _loc4_ = this.FSpringFestivalTaiko.HeroList[_loc1_];
      ...
      {
         var _loc1_:int = 0;
         if(Boolean(this.FSpringFestivalTaiko) && Boolean(this.FSpringFestivalTaiko.HeroList.length > 0) && Boolean(this.FHeroList[0]))
         {
            _loc1_ = 0;
            while(_loc1_ < HERO_COUNT)
            {
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FSpringFestivalTaiko.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FSpringFestivalTaiko.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Times.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_AMOUNT,this.FSpringFestivalTaiko.Count);
         FMC_Scene.TF_Count.text = "*" + this.FSpringFestivalTaiko.Score;
         FMC_Scene.TF_Desc.text = this.FSpringFestivalTaiko.ActivityName;
      }
      ...
      protected function ProcessorOnClickTaiko(param1:MouseEvent) : void
      {
         ...
         if(FOnBuyBox != null && Boolean(this.FSpringFestivalTaiko))
         {
            if(this.FSpringFestivalTaiko.Count > 0)
            {
               FOnBuyBox(ACTIVITY_3_ID,TProcessorSpringFestival.TAIKO_BUY_BOX,this.FSpringFestivalTaiko.Cost,0,TBaseActivity.SWEET_TYPE_FREE);
            }
            else
            {
               FOnBuyBox(ACTIVITY_3_ID,TProcessorSpringFestival.TAIKO_BUY_BOX,this.FSpringFestivalTaiko.Cost,0,TBaseActivity.SWEET_TYPE_GOLD);
            }
         }
      }
      ...
      protected function ProcessorOnTaikoOver(param1:MouseEvent) : void
      {
         if(FOnShowTip != null)
         {
            FOnShowTip(this.FSpringFestivalTaiko.ActivityDesc2);
         }
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FSpringFestivalTaiko) && _loc2_ < this.FSpringFestivalTaiko.BoxList.length)
         {
            if(this.FSpringFestivalTaiko.BoxList[_loc2_].Status == TBaseActivity.STATUS_CANGET)
            {
               FOnGetBox(ACTIVITY_3_ID,TProcessorSpringFestival.TAIKO_GET_BOX,_loc2_ + 1);
            }
         }
      }
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnItemOver != null) && Boolean(this.FSpringFestivalTaiko) && _loc3_ < this.FSpringFestivalTaiko.BoxList.length)
         {
            _loc2_ = this.FSpringFestivalTaiko.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      override protected function ProcessorOnBoxOut(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = int(String(param1.currentTarget.name).slice(6));
         if(Boolean(FOnItemOut != null) && Boolean(this.FSpringFestivalTaiko) && _loc3_ < this.FSpringFestivalTaiko.BoxList.length)
         {
            _loc2_ = this.FSpringFestivalTaiko.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      protected function ProcessorOnGetHeroUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FSpringFestivalTaiko) && _loc2_ < this.FSpringFestivalTaiko.HeroList.length)
         {
            if(this.FSpringFestivalTaiko.HeroList[_loc2_].Status == TBaseActivity.STATUS_CANGET)
            {
               FOnGetBox(ACTIVITY_3_ID,TProcessorSpringFestival.TAIKO_GET_HERO);
            }
         }
      }
      ...
      protected function ProcessorOnHeroUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnShowRecruit != null) && Boolean(this.FSpringFestivalTaiko) && _loc3_ < this.FSpringFestivalTaiko.HeroList.length)
         {
            _loc2_ = uint(this.FSpringFestivalTaiko.HeroList[_loc3_].Identify);
            FOnShowRecruit(_loc2_,this.FSpringFestivalTaiko.HeroList[_loc3_].Type);
         }
      }
      ...
      protected function ProcessorOnHeroOver(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = int(String(param1.currentTarget.parent.name).slice(7));
         if(Boolean(FOnShowHeroTip != null) && Boolean(this.FSpringFestivalTaiko) && _loc3_ < this.FSpringFestivalTaiko.HeroList.length)
         {
            this.FHeroList[_loc3_].MC_Hero.filters = [TGameUtil.highLightFilters];
            _loc2_ = this.FSpringFestivalTaiko.HeroList[_loc3_];
      ...
      {
         this.FSpringFestivalTaiko = SLogicsCore.SpringFestivalDatas.GetActivityByIdentify(ACTIVITY_3_ID) as TSpringFestivalTaiko;
         this.UpdateBox();
         this.UpdateHero();
         this.UpdateText();
      }
