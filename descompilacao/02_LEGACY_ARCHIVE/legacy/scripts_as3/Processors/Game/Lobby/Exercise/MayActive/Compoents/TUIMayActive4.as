package Processors.Game.Lobby.Exercise.MayActive.Compoents
{
   ...
   public class TUIMayActive4 extends TUIBaseWindow
   {
      ...
      protected var FMayActive4:TMayActive4;
      ...
      protected function UpdateBox() : void
      {
         ...
         while(_loc1_ < BOX_COUNT)
         {
            ...
            if(_loc1_ < this.FMayActive4.BoxList.length)
            {
               _loc3_.visible = true;
               _loc4_ = this.FMayActive4.BoxList[_loc1_];
               _loc3_.TF_Count.text = "*" + this.FMayActive4.BoxList[_loc1_].Price;
               _loc3_.TF_limitCount.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_LIMIT_COUNT,_loc4_.LimitCount);
               if(this.FMayActive4.Score >= _loc4_.Price && _loc4_.LimitCount > 0)
               {
      ...
      protected function ProcessorOnSweetUp(param1:MouseEvent) : void
      {
         ...
         if(FOnBuyBox != null)
         {
            ...
            {
               FOnBuyBox(ACTIVITY_4_ID,TProcessorMayActive.ACTIVITY_4_GET_SWEET,_loc3_.Price,_loc2_ + 1,TBaseActivity.SWEET_TYPE_FREE);
            }
            else
            {
               FOnBuyBox(ACTIVITY_4_ID,TProcessorMayActive.ACTIVITY_4_GET_SWEET,_loc3_.Price,_loc2_ + 1,TBaseActivity.SWEET_TYPE_GOLD);
            }
         }
      }
      ...
      protected function ProcessorOnTenUp(param1:MouseEvent) : void
      {
         ...
         {
            FMC_Scene.MC_Click.visible = false;
            FOnBuyBox(ACTIVITY_4_ID,TProcessorMayActive.ACTIVITY_4_GET_TEN,this.FMayActive4.TenPrice,0,TBaseActivity.SWEET_TYPE_GOLD);
         }
      }
      ...
      protected function ProcessorOnBoxUp(param1:MouseEvent) : void
      {
         ...
         {
            if(this.FMayActive4.BoxList[_loc2_].LimitCount > 0)
            {
               FOnGetBox(ACTIVITY_4_ID,TProcessorMayActive.ACTIVITY_4_GET_BOX,_loc2_ + 1);
            }
            else
            {
      ...
      protected function ProcessorOnGetHeroUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FMayActive4) && Boolean(this.FMayActive4.HeroList[0]))
         {
            ...
            {
               FOnGetBox(ACTIVITY_4_ID,TProcessorMayActive.ACTIVITY_4_GET_HERO,1);
            }
         }
      }
      ...
      protected function ProcessorOnHeroOver(param1:MouseEvent) : void
      {
         ...
         {
            FOnShowHtmlTip(this.FMayActive4.HeroList[0].Desc1);
         }
      }
      ...
      {
         this.FMayActive4 = SLogicsCore.MayActiveDatas.GetActivityByIdentify(ACTIVITY_4_ID) as TMayActive4;
         this.UpdateSweet();
         this.UpdateBox();
         this.UpdateHero();
         this.UpdateText();
