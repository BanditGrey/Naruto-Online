package Processors.Game.Lobby.Exercise.Hallowmas
{
   ...
   public class TProcessorHallowmasRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorHallowmasRank(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_HallowmasRank") as MovieClip;
      ...
      protected function UpdateText() : void
      {
         ...
         {
            this.FMC_Scene["TF_CurRank"].text = this.FHallowmas.CurRank.toString();
         }
         this.FMC_Scene["TF_KillCount"].text = this.FHallowmas.KilledTimes.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            _loc6_ = this.FHallowmas.KillBox[_loc1_];
            ...
            _loc7_ = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_KILL_COUNT,_loc6_.Price);
      ...
      protected function UpdateRank() : void
      {
         ...
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc9_ < this.FHallowmas.KillRank.length)
            {
               _loc8_.visible = true;
               _loc6_ = this.FHallowmas.KillRank[_loc9_];
               _loc5_ = _loc6_.Inventories;
