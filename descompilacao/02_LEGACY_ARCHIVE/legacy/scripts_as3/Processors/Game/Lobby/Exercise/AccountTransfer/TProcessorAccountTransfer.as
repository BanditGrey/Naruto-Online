package Processors.Game.Lobby.Exercise.AccountTransfer
{
   ...
   public class TProcessorAccountTransfer extends TProcessorLobbyWindows
   {
      ...
      public static const REWARD_ID_1:int = 60380008;
      
      public static const REWARD_ID_2:int = 60380008;
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FTF_Input = this.FMC_Scene["MC_Input"]["TF_PassWord"];
         ...
         this.FTF_PassWord = this.FMC_Scene["MC_PassWord"]["TF_PassWord"];
         ...
         SExternalCore.CallBackRegister = this.RegisterSuccessCallBack;
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         TGameUtil.setButtonMode(this.FMC_Scene.BTN_Ok,false);
      ...
      protected function UpdateText() : void
      {
         ...
         {
            this.FMC_Scene.MC_Input.visible = true;
            this.FTF_Input.text = "";
            this.FMC_Scene.BTN_Ok.visible = true;
            this.FMC_Scene.MC_PassWord.visible = false;
            this.FMC_Scene.MC_Got.visible = false;
            TGameUtil.setButtonMode(this.FMC_Scene.BTN_Ok,false);
         }
         else
         {
            this.FMC_Scene.MC_Input.visible = false;
            this.FMC_Scene.BTN_Ok.visible = false;
            this.FMC_Scene.MC_PassWord.visible = true;
            this.FTF_PassWord.text = SParametersCore.PassWord;
            this.FMC_Scene.TF_UserName.text = SParametersCore.Email;
      ...
      {
         if(this.FTF_Input.text.length >= 6 && this.FTF_Input.text.length > 0)
         {
      ...
      override public function Mount(param1:ByteArray = null) : void
      {
         ...
         {
            SExternalCore.VkCallJs(20150428);
         }
      }
