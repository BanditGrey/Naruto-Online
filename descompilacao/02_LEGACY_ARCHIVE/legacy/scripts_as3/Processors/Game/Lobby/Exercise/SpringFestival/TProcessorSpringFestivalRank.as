package Processors.Game.Lobby.Exercise.SpringFestival
{
   ...
   public class TProcessorSpringFestivalRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorSpringFestivalRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550136833);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_TaikoRank") as MovieClip;
      ...
      {
         if(this.FSpringFestivalTaiko.MyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FSpringFestivalTaiko.MyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FSpringFestivalTaiko.Score.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FSpringFestivalTaiko.RankRewardList.length)
            {
               _loc4_ = this.FSpringFestivalTaiko.RankRewardList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FSpringFestivalTaiko.RankList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FSpringFestivalTaiko.RankList.length)
            {
               _loc8_ = this.FSpringFestivalTaiko.RankList[_loc2_];
               if(this.FCurPage == 0)
               {
