package Processors.Game.Lobby.Exercise.ConsumeRank.Compoents
{
   ...
   public class TUIPerReward extends TUIComponent
   {
      ...
      protected function Initialization() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance(CONST_CONSUMERANK.RESOURCE_ClassName_MC_PerReward) as MovieClip;
      ...
      protected function UpdateContent() : void
      {
         ...
         _loc1_ = this.FConsumeRank.PerRewardList[this.FIndex];
         this.FMC_Scene.TF_Text.text = _loc1_.Score + STRING_CONSUMERANK.FORMAT_SCORE_NAME;
      }
      ...
      protected function UpdateBtn() : void
      {
         var _loc1_:TPerReward = null;
         _loc1_ = this.FConsumeRank.PerRewardList[this.FIndex];
         if(this.FConsumeRank.PerScore >= _loc1_.Score)
         {
            if(_loc1_.Status == 0)
            {
      ...
      protected function UpdateItem() : void
      {
         ...
         _loc3_ = this.FConsumeRank.PerRewardList[this.FIndex].Inventories;
         _loc1_ = 0;
         while(_loc1_ < this.BOX_COUNT)
         {
      ...
      {
         this.FIndex = param1;
         this.FUIPage.TotalQuantity = this.FConsumeRank.PerRewardList[this.FIndex].Inventories.Count;
         this.FUIPage.Update();
         this.UpdateContent();
         this.UpdateBtn();
         this.UpdateItem();
