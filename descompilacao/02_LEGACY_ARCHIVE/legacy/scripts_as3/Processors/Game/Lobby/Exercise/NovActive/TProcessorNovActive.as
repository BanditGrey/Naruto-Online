package Processors.Game.Lobby.Exercise.NovActive
{
   ...
   import Logics.Streamization.Exercise.TUnstreamizerNovActive;
   ...
   import Processors.Game.Lobby.Exercise.NovActive.Compoents.TUIMayActive4;
   import Processors.Game.Lobby.Exercise.NovActive.Compoents.TUINovActive1;
   ...
   public class TProcessorNovActive extends TProcessorBaseActivity
   {
      ...
      public static const ACTIVITY_1_START_LABA:int = 2;
      
      public static const ACTIVITY_1_AUTO_LABA:int = 3;
      
      public static const ACTIVITY_1_EXCHANGE_ITEM:int = 4;
      
      public static const ACTIVITY_1_GET_REWARD:int = 5;
      ...
      protected var ACTIVITY_REFERENCE:Vector.<Class> = Vector.<Class>([TUINovActive1,TUIMayActive4]);
      ...
      protected var FUnstreamizerNovActive:TUnstreamizerNovActive;
      ...
      public function TProcessorNovActive(param1:TUIComponent, param2:TLobbyParameters, param3:uint)
      {
         super(param1,param2,param3);
         FActivityID = param3;
         this.FNovActiveDatas = SLogicsCore.NovActiveDatas;
         this.FActivityTaskData = SLogicsCore.ActivityTaskData;
         this.FUnstreamizerNovActive = new TUnstreamizerNovActive(param3);
      ...
      override protected function UpdateUI() : void
      {
         ...
         var _loc4_:TNovActive1 = null;
         super.UpdateUI();
         _loc1_ = 0;
         while(_loc1_ < this.TAB_COUNT)
         {
            _loc2_ = this.FTabList[_loc1_];
            _loc3_ = this.FNovActiveDatas.GetActivityByIndex(_loc1_);
            ...
            if(this.FNovActiveDatas.Activities[_loc1_].NeedShine == TBaseActivity.STATUS_CANGET)
            {
      ...
      protected function ProcessorOnChangePage(param1:MouseEvent) : void
      {
         ...
         _loc3_ = this.FNovActiveDatas.GetActivityByIndex(_loc2_);
      ...
      {
         FProcessorWindowDesc.BaseActivity = this.FNovActiveDatas.GetActivityByIndex(this.FChangeTabIndex);
      ...
      override public function ProcessorOnLoadInfoRet(param1:TPacket = null) : void
      {
         ...
         this.FUnstreamizerNovActive.Unstreamize(_loc2_,this.FNovActiveDatas,null);
      ...
      override public function ProcessorActivityThirdLoadLogRet(param1:TPacket = null) : void
      {
         ...
         _loc5_ = this.FNovActiveDatas.GetActivityByIdentify(_loc4_) as TBaseActivity;
      ...
      override public function ProcessorChangeGold(param1:TPacket = null) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:TNovActive1 = null;
         var _loc10_:TNovActive2 = null;
         _loc2_ = param1.Data;
         _loc2_.readShort();
         ...
         {
            case ACTIVITY_1_ID:
               _loc9_ = this.FNovActiveDatas.GetActivityByIdentify(_loc6_) as TNovActive1;
               break;
            case ACTIVITY_2_ID:
               _loc10_ = this.FNovActiveDatas.GetActivityByIdentify(_loc6_) as TNovActive2;
               if(this.FIsOpen)
               {
                  this.PerformPacket_CS_LoadInfoReq();
               }
      ...
      override public function ProcessorAllRet(param1:TPacket = null) : void
      {
         ...
         var _loc24_:TNovActive1 = null;
         var _loc25_:TNovActive2 = null;
         var _loc26_:int = 0;
         var _loc27_:int = 0;
         var _loc28_:int = 0;
         var _loc29_:int = 0;
         ...
         {
            case ACTIVITY_1_ID:
               _loc24_ = this.FNovActiveDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TNovActive1;
               if(_loc10_ == ACTIVITY_1_GET_SERVER_BOX)
               {
                  --_loc24_.ServerList.Count;
                  _loc24_.RankPoint = _loc2_.readUnsignedInt();
                  _loc24_.ShopExchangePoint = _loc2_.readUnsignedInt();
                  _loc4_ = STRING_BASEACTIVITY.FORMAT_GET_SUCCESSED;
                  _loc6_ = 0;
                  while(_loc6_ < _loc24_.ServerList.Inventories.Count)
                  {
                     _loc9_ = _loc24_.ServerList.Inventories.GetInventoryByIndex(_loc6_);
                     _loc4_ += _loc9_.Name + "*" + _loc9_.Quantity + "\n";
                     _loc6_++;
                  }
                  _loc24_.ChangeStatus();
                  ProcessorEffectText(_loc4_);
                  this.FNovActiveDatas.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FNovActiveDatas.CheckStatus());
                  this.UpdateUI();
               }
                  ...
                  if(_loc33_ != null)
                  {
                     ...
                     while(_loc5_ < _loc33_.TaskAward[_loc33_.Step].Count)
                     {
                        ...
                        else if(_loc24_.ItemIDB == _loc9_.IDTemplate)
                        {
                           ...
                           _loc24_.ShopExchangePoint += _loc9_.Quantity;
                        }
                        _loc5_++;
                     }
                     ++_loc33_.Step;
               ...
               else if(_loc10_ == ACTIVITY_1_START_LABA)
               {
                  _loc24_.Result.length = 0;
                  _loc5_ = 0;
                  while(_loc5_ < 3)
                  {
                     _loc24_.Result.push(_loc2_.readUnsignedInt() - 1);
                     _loc5_++;
                  }
                  _loc24_.MyScore = _loc2_.readUnsignedInt();
                  _loc24_.ResultScore = _loc2_.readUnsignedInt();
                  _loc24_.ServerList.Count = _loc2_.readUnsignedInt();
                  _loc24_.TotalCount = _loc2_.readUnsignedInt();
                  _loc24_.RankPoint += _loc24_.ResultScore;
                  _loc24_.ShopExchangePoint += _loc24_.ResultScore;
                  _loc24_.ChangeStatus();
                  this.FUIWindowVect[0].PlayMovie(1);
               }
               else if(_loc10_ == ACTIVITY_1_AUTO_LABA)
               {
                  _loc24_.Result.length = 0;
                  _loc5_ = 0;
                  while(_loc5_ < 30)
               ...
               break;
            case ACTIVITY_2_ID:
               _loc25_ = this.FNovActiveDatas.GetActivityByIdentify(ACTIVITY_2_ID) as TNovActive2;
               if(_loc10_ == ACTIVITY_4_GET_SWEET)
               {
                  ...
                  _loc25_.Score += _loc14_;
                  _loc4_ = STRING_BASEACTIVITY.FORMAT_GET_SUCCESSED;
                  if(_loc14_ > 0)
                  {
                     _loc4_ += _loc22_[ACTIVITY_4_DROP_ITEM_INDEX] + "*" + _loc14_ + "\n";
                  }
                  _loc14_ = _loc2_.readUnsignedInt();
                  if(_loc14_ > 0)
                  {
                     _loc4_ += _loc22_[ACTIVITY_3_DROP_ITEM_INDEX] + "*" + _loc14_ + "\n";
                  }
                  _loc5_ = 0;
                  ...
                  this.FNovActiveDatas.ChangeSingleActivityStatus(ACTIVITY_2_ID);
                  ProcessorCheckEffect(FActivityID,this.FNovActiveDatas.CheckStatus());
                  this.UpdateUI();
               }
               else if(_loc10_ == ACTIVITY_4_GET_TEN)
               {
                  _loc25_.Amount1List.length = 0;
                  _loc25_.Amount2List.length = 0;
                  _loc25_.IndexList.length = 0;
                  _loc25_.StatusList.length = 0;
                  _loc5_ = 0;
                  while(_loc5_ < 10)
                  {
                     _loc25_.Amount1List[_loc5_] = _loc2_.readUnsignedInt();
                     _loc25_.Amount2List[_loc5_] = _loc2_.readUnsignedInt();
               ...
               {
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc15_ = _loc25_.BoxList[_loc5_];
                  --_loc15_.LimitCount;
      ...
      public function TestInit0() : ByteArray
      {
         ...
         TUtilityString.FlushUTF(_loc3_,"是否花费%0金币补齐拉霸券");
         TUtilityString.FlushUTF(_loc3_,"全服收集物达到%0个可领");
