package Processors.Game.Lobby.Exercise.FebActive
{
   ...
   public class TProcessorFebActiveWaterLog extends TProcessorLobbyWindow
   {
      ...
      protected function UpdateText() : void
      {
         ...
         {
            if(_loc1_ < this.FFebActive2.WaterLogList.length)
            {
               _loc2_ = this.FFebActive2.WaterLogList[_loc1_];
               this.FMC_Scene["TF_Desc" + _loc1_].text = TUtilityString.Format(this.FFebActive2.DescListNew[17],TUtilityDate.FormatDate(new Date(STimingCore.GetClientShowTime(_loc2_.GetTime) * 1000)),_loc2_.Count,_loc2_.Identify);
         ...
         this.FMC_Scene["TF_RechargeDesc"].text = TUtilityString.Format(this.FFebActive2.DescListNew[16],this.FFebActive2.TotalRecharge,this.FFebActive2.RechargeAddTimes);
      }
      ...
      private function ProcessorOnClose(param1:MouseEvent) : void
      {
         ...
         {
            this.FOnCloseUp(TProcessorFebActive.WINDOW_ALL_LOG);
         }
      }
      ...
      {
         this.FFebActive2 = SLogicsCore.FebActiveDatas.GetActivityByIdentify(2) as TFebActive2;
         this.UpdateText();
      }
   }
}
