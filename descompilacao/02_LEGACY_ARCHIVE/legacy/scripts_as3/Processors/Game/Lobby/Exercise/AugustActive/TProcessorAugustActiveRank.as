package Processors.Game.Lobby.Exercise.AugustActive
{
   ...
   public class TProcessorAugustActiveRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorAugustActiveRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550137096);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_AugustActiveRank") as MovieClip;
      ...
      {
         if(this.FAugustActive1.CurMyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FAugustActive1.CurMyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FAugustActive1.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FAugustActive1.RankGiftList.length)
            {
               _loc4_ = this.FAugustActive1.RankGiftList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FAugustActive1.RankPlayerList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FAugustActive1.RankPlayerList.length)
            {
               _loc8_ = this.FAugustActive1.RankPlayerList[_loc2_];
               if(this.FCurPage == 0)
               {
