package Processors.Game.Lobby.FightPet
{
   ...
   import Resources.Strings.STRING_FIGHTPET;
   ...
   public class TLayerOver extends TProcessorLobbyWindow
   {
      ...
      public function TLayerOver(param1:TUIComponent)
      {
         super(param1);
         ...
         this.FTimeCoolDown = new TTimeCoolDown(CONST_COMMON.TIME_COOLDOWN_FightPet_DieCD);
         SLogicsCore.Character.TimeCoolDowns.Add(this.FTimeCoolDown);
         this.FFightPetCoolDown = new TTimeCoolDown(CONST_COMMON.TIME_COOLDOWN_FightPet_INIT);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         _loc1_ = TUtilityReflection.CreateDisplayObjectInstance(CONST_FIGHTPET.RESOURCE_ClassName_FightPet) as Sprite;
         addChild(_loc1_);
         ...
         this.FMC_FightCD = TUtilityReflection.CreateDisplayObjectInstance(CONST_FIGHTPET.RESOURCE_ClassName_MC_FightCD) as Sprite;
         ...
         this.FMC_EnterTownCD = TUtilityReflection.CreateDisplayObjectInstance(CONST_FIGHTPET.RESOURCE_ClassName_MC_EnterTownCD) as Sprite;
         ...
         this.FMC_ResurrectionCD = TUtilityReflection.CreateDisplayObjectInstance(CONST_FIGHTPET.RESOURCE_ClassName_MC_ResurrectionCD) as Sprite;
         ...
         this.FMC_McAutoFire = TUtilityReflection.CreateDisplayObjectInstance(CONST_FIGHTPET.RESOURCE_ClassName_MC_AutoFire) as MovieClip;
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         _loc1_ = this.FConfigValue.GetDatebaseByIdentifier(CONST_CONFIGVALUE.FIGHTPET_REVIVECOST) as TConfigValue;
      ...
      override protected function LogicsPerform() : void
      {
         ...
         if(this.FIsInit)
         {
            ...
            if(!this.FFightPetData.GameOver && SLogicsCore.Character.RoleSencePosition == CONST_COMMON.SCENEPOSITION_FightPet)
            {
         ...
         if(this.FIsDie)
         {
            ...
            if(this.FIsResurrectionOnMove)
            {
               ...
               this.FHint.Caption = TUtilityString.Format(STRING_FIGHTPET.FORMAT_MONSTER_Resurrection,_loc2_);
      ...
      private function updateMonterInfo(param1:TFightPet) : void
      {
         ...
         this.FTF_MonsterName.text = TUtilityString.Format(STRING_FIGHTPET.FORMAT_MONSTER_NAME,param1.MonsterLV,param1.MonsterName);
         this.FTF_HP.text = TUtilityString.Format(STRING_FIGHTPET.FORMAT_HP,_loc5_,_loc4_);
      ...
      private function updateRank(param1:TFightPet) : void
      {
         ...
         this.FTF_MyDamage.text = TUtilityString.Format(STRING_FIGHTPET.FORMAT_MONSTER_RANK,_loc4_,_loc5_.toFixed(2));
         ...
         while(_loc2_ < _loc3_)
         {
            ...
            _loc5_ = _loc4_ / param1.MonsterTotaleHP * 100;
            this.FRankList[_loc2_]["TF_Name"].text = TUtilityString.Format(STRING_FIGHTPET.FORMAT_MONSTER_RANK_NAME,_loc2_ + 1,_loc6_);
            this.FRankList[_loc2_]["TF_Damage"].text = TUtilityString.Format(STRING_FIGHTPET.FORMAT_MONSTER_RANK,_loc4_,_loc5_.toFixed(2));
      ...
      protected function UpdateActivityColdTime() : void
      {
         ...
         this.FUpdateReturnHomePanel(this,STRING_FIGHTPET.STRING_FightPet,STRING_COMMON.STRING_EndTime + TGameUtil.fomatTime(_loc1_));
      }
      ...
      private function MoraleUpOnClick(param1:MouseEvent) : void
      {
         ...
         var _loc10_:uint = 0;
         var _loc11_:uint = 0;
         _loc2_ = this.FConfigValue.GetDatebaseByIdentifier(CONST_CONFIGVALUE.FIGHTPET_MORALENUMBER) as TConfigValue;
         _loc3_ = uint(_loc2_.Value[this.FFightPetData.InspireCount]);
         _loc5_ = "";
         _loc9_ = 0;
         _loc2_ = this.FConfigValue.GetDatebaseByIdentifier(CONST_CONFIGVALUE.FIGHTPET_MORALEUP_PROPERTY) as TConfigValue;
         _loc7_ = _loc2_.Value as Vector.<Object>;
         _loc2_ = this.FConfigValue.GetDatebaseByIdentifier(CONST_CONFIGVALUE.FIGHTPET_MORALEUP_POINT) as TConfigValue;
         ...
         this.FUIWindowInformation.Text = TUtilityString.Format(STRING_FIGHTPET.FORMAT_MONSTER_MoraleUp,_loc3_,_loc5_);
      ...
      private function DescriptionOnMove(param1:MouseEvent) : void
      {
         ...
         _loc2_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_SystemLanguage,CONST_SYSTEMLANGUAGE.HELPTIPS_FIGHTPET) as TSystemLanguage;
      ...
      {
         var _loc1_:TConfigValue = null;
         _loc1_ = this.FConfigValue.GetDatebaseByIdentifier(CONST_CONFIGVALUE.FIGHTPET_MORALENUMBER) as TConfigValue;
