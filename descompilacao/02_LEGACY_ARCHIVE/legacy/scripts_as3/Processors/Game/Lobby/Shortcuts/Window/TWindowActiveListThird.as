package Processors.Game.Lobby.Shortcuts.Window
{
   ...
   public class TWindowActiveListThird extends TUIComponent
   {
      
      public static const POSITION_ActiveListThird:uint = CONST_SHORTCUTS.POSITION_ActiveListThird;
      
      public static const ACTIVELIST_THIRD_TYPE:Vector.<uint> = CONST_SHORTCUTS.ACTIVELIST_THIRD_TYPE;
      
      public static const RESOURCE_ClassName_ActiveListThird_Btns:Vector.<String> = CONST_SHORTCUTS.RESOURCE_ClassName_ActiveListThird_Btns;
      ...
      public function TWindowActiveListThird(param1:TUIComponent)
      {
         super(param1);
         this.FActivityThirdModes = SLogicsCore.ActivityThirdModes;
         this.FUIShortcut = new TUIShortcut(this);
         this.FUIShortcut.Capacity = ACTIVELIST_THIRD_TYPE.length;
      ...
      protected function Resources_UIDispatch() : void
      {
         ...
         _loc2_ = int(ACTIVELIST_THIRD_TYPE.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            _loc3_ = RESOURCE_ClassName_ActiveListThird_Btns[_loc1_];
      ...
      public function ProcessorOpenStatusNotification() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            _loc3_ = this.FActivityThirdModes.getActivityStatus(ACTIVELIST_THIRD_TYPE[_loc1_]);
      ...
      protected function ComponentsAlign() : void
      {
         ...
         _loc1_ = this.GetFirstShowButton();
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function ProcessorShortcutShowEffect(param1:uint, param2:Boolean) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:Vector.<uint> = CONST_SHORTCUTS.ACTIVELIST_THIRD_TYPE;
