package Processors.Game.Windows.Information
{
   ...
   public class TUIWindowCrossSeverBuyGoods extends TUIWindow
   {
      ...
      public function TUIWindowCrossSeverBuyGoods(param1:TUIComponent, param2:uint)
      {
         super(param1);
      ...
      {
         this.FLabel.text = this.FInventorySample.Inventory.Name;
      ...
      protected function UpdatePrice() : void
      {
         ...
         {
            this.FTF_Desc.text = TUtilityString.Format(TUtilityString.GetText(80002365),TOrangeInventorySample(this.FInventorySample).ExchangeCount * this.FGoodsNum);
         }
         else if(this.FInventorySample is TTokenInventorySample)
         {
            this.FTF_Desc.text = TUtilityString.Format(TUtilityString.GetText(80002365),TTokenInventorySample(this.FInventorySample).ExchangeCount * this.FGoodsNum);
         }
      }
      ...
      protected function TextFieldOnChange(param1:Event) : void
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         this.FGoodsNum = uint(this.FText.text) > 0 ? int(uint(this.FText.text)) : 1;
         if(this.FInventorySample is TOrangeInventorySample)
         {
            _loc3_ = uint(SLogicsCore.EliteRecord.OrangeSoulCount);
            _loc2_ = uint(_loc3_ / TOrangeInventorySample(this.FInventorySample).ExchangeCount);
         }
         else if(this.FInventorySample is TTokenInventorySample)
         {
            _loc3_ = uint(SLogicsCore.EliteRecord.TokenCount);
            _loc2_ = uint(_loc3_ / TTokenInventorySample(this.FInventorySample).ExchangeCount);
         }
      ...
      {
         this.FInventorySample = FContext as TInventoryReference;
