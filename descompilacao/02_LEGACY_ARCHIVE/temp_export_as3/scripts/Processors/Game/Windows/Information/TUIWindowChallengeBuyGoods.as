package Processors.Game.Windows.Information
{
   ...
   public class TUIWindowChallengeBuyGoods extends TUIWindow
   {
      ...
      public function TUIWindowChallengeBuyGoods(param1:TUIComponent, param2:uint)
      {
         super(param1);
      ...
      protected function UpdatePrice() : void
      {
         ...
         _loc1_ = new ConsumeFrameCopy(STRING_CHALLENGE.STRING_003).DescribeString;
         this.FTF_Desc.text = TUtilityString.Format(_loc1_,this.FInventorySample.Integration * this.FGoodsNum);
      }
      ...
      protected function TextFieldOnChange(param1:Event) : void
      {
         ...
         _loc3_ = uint(SLogicsCore.Challenge.Point);
