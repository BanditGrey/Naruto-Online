package Processors.Game.Windows.Information
{
   ...
   public class TUIWindowWorldMatchBuyGoods extends TUIWindow
   {
      ...
      public function TUIWindowWorldMatchBuyGoods(param1:TUIComponent, param2:uint)
      {
         super(param1);
      ...
      protected function AddOnClick(param1:MouseEvent) : void
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         _loc3_ = uint(SLogicsCore.Character.Appliances.GetAllCountByTempletID(this.PointId));
         ++this.FGoodsNum;
