package Processors.Game.Lobby.Exercise.Christmas.Compoents
{
   ...
   public class TUIChristmasColorEgg extends TUIChristmasBase
   {
      
      protected static const BOX_COUNT:int = 3;
      
      protected static const ACTIVITY_3_ID:int = TProcessorChristmas.ACTIVITY_3_ID;
      
      protected var FBoxList:Vector.<MovieClip>;
      
      protected var FChristmasColorEgg:TChristmasColorEgg;
      
      public function TUIChristmasColorEgg(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateBox() : void
      {
         ...
         while(_loc1_ < BOX_COUNT)
         {
            ...
            _loc3_.TF_Count.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_LIMIT_COUNT,this.FChristmasColorEgg.BoxList[_loc1_].Count);
            _loc3_.TF_Buff.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_SAVE_PERCENT,this.FChristmasColorEgg.BoxList[_loc1_].Discount);
            if(this.FChristmasColorEgg.Status != TBaseActivity.STATUS_CANNOTGET)
            {
               _loc3_.MC_Mask.visible = false;
               if(this.FChristmasColorEgg.BoxList[_loc1_].BuyCount >= this.FChristmasColorEgg.BoxList[_loc1_].Count)
               {
               ...
               _loc4_ = this.FChristmasColorEgg.BoxList[_loc1_].Inventories.GetInventoryByIndex(0);
      ...
      protected function UpdateGift() : void
      {
         ...
         else if(this.FChristmasColorEgg.Status == TBaseActivity.STATUS_CANGET)
         {
            FMC_Scene.MC_Gift.gotoAndStop(1);
            if(FMC_Scene.MC_Gift.MC_GetBox)
            {
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FChristmasColorEgg.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FChristmasColorEgg.EndTime) - 1) * 1000)));
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(this.FChristmasColorEgg.Status != TBaseActivity.STATUS_CANGET)
         {
            return;
         }
         if(FOnGetBox != null)
         {
            FOnGetBox(ACTIVITY_3_ID,TProcessorChristmas.CHRISTMAS_COLOREGG_GIFT);
         }
      }
      ...
      protected function ProcessorOnBuyBoxUp(param1:MouseEvent) : void
      {
         ...
         if(this.FChristmasColorEgg.BoxList[_loc2_].BuyCount >= this.FChristmasColorEgg.BoxList[_loc2_].Count)
         {
            return;
         }
         if(FOnBuyBox != null)
         {
            FOnBuyBox(ACTIVITY_3_ID,TProcessorChristmas.CHRISTMAS_COLOREGG_BUY_BOX,this.FChristmasColorEgg.BoxList[_loc2_].Price,_loc2_ + 1);
         }
      }
      ...
      protected function ProcessorOnBuyBoxOver(param1:MouseEvent) : void
      {
         ...
         _loc2_ = int(String(param1.currentTarget.parent.name).slice(6));
         if(this.FChristmasColorEgg.BoxList[_loc2_] == null)
         {
            return;
         }
         if(this.FChristmasColorEgg.BoxList[_loc2_].BuyCount >= this.FChristmasColorEgg.BoxList[_loc2_].Count)
         ...
         if(FOnShowTip != null)
         {
            ...
            {
               _loc3_ = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_BAR_TEXT2,this.FChristmasColorEgg.BoxList[_loc2_].Price);
            }
            FOnShowTip(_loc3_);
         }
      }
      ...
      protected function ProcessorOnMaskOver(param1:MouseEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:String = null;
         if(FOnShowTip != null && this.FChristmasColorEgg.BoxList[0] != null)
         {
            _loc2_ = int(String(param1.currentTarget.parent.name).slice(6));
            _loc3_ = this.FChristmasColorEgg.BoxList[_loc2_].Title;
            FOnShowTip(_loc3_);
         }
      }
      ...
      {
         if(FOnHideTip != null && this.FChristmasColorEgg.BoxList[0] != null)
         {
            FOnHideTip();
         }
      }
      ...
      protected function ProcessorOnGiftOver(param1:MouseEvent) : void
      {
         ...
         if(FOnItemOver != null && this.FChristmasColorEgg.Inventories.Count > 0)
         {
            _loc2_ = this.FChristmasColorEgg.Inventories.GetInventoryByIndex(0);
      ...
      {
         var _loc2_:TInventory = null;
         if(FOnItemOut != null && this.FChristmasColorEgg.Inventories.Count > 0)
         {
            _loc2_ = this.FChristmasColorEgg.Inventories.GetInventoryByIndex(0);
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         var _loc2_:TInventory = null;
         var _loc3_:int = 0;
         if(FOnItemOut != null && this.FChristmasColorEgg.BoxList[0] != null)
         {
            _loc3_ = int(String(param1.currentTarget.parent.name).slice(6));
            _loc2_ = this.FChristmasColorEgg.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
            FOnItemOver(this,_loc2_);
         }
      }
      ...
      override public function LogicsPerform() : void
      {
         ...
         {
            if(Boolean(FMC_Scene) && Boolean(this.FChristmasColorEgg))
            {
               FMC_Scene.TF_Time.text = TGameUtil.fomatTime(this.FChristmasColorEgg.EndTime - STimingCore.GetServerTick());
            }
         }
      }
      ...
      {
         this.FChristmasColorEgg = SLogicsCore.ChristmasDatas.GetActivityByIdentify(ACTIVITY_3_ID) as TChristmasColorEgg;
         this.UpdateBox();
         this.UpdateGift();
         this.UpdateText();
      }
