package Processors.Game.Lobby.Exercise.Christmas
{
   ...
   public class TProcessorChristmasRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorChristmasRank(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_ChristmasRank") as MovieClip;
      ...
      {
         if(this.FChristmasRank.MyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FChristmasRank.MyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FChristmasRank.Score.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FChristmasRank.RankRewardList.length)
            {
               _loc4_ = this.FChristmasRank.RankRewardList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FChristmasRank.RankList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FChristmasRank.RankList.length)
            {
               _loc7_ = this.FChristmasRank.RankList[_loc2_];
               if(this.FCurPage == 0)
               {
