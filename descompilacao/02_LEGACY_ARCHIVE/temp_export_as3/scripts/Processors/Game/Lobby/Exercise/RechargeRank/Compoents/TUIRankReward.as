package Processors.Game.Lobby.Exercise.RechargeRank.Compoents
{
   ...
   public class TUIRankReward extends TUIComponent
   {
      ...
      protected function Initialization() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance(CONST_RECHARGERANK.RESOURCE_ClassName_MC_RankReward) as MovieClip;
      ...
      protected function UpdateContent() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TRechargeRankReward = null;
         var _loc4_:MovieClip = null;
         var _loc5_:int = 0;
         _loc3_ = this.FRechargeRank.RankRewardList[this.FIndex];
         if(_loc3_.MinLimit == _loc3_.MaxLimit)
         {
            this.FMC_Scene.TF_Text.text = TUtilityString.Format(STRING_RECHARGERANK.FORMAT_RankText,_loc3_.MinLimit);
         }
         else
         {
            this.FMC_Scene.TF_Text.text = TUtilityString.Format(STRING_RECHARGERANK.FORMAT_RankText2,_loc3_.MinLimit,_loc3_.MaxLimit);
         }
         ...
         while(_loc1_ < this.MAX_COUNT)
         {
            ...
            if(_loc1_ < _loc2_)
            {
               ...
               {
                  _loc4_.TF_Gold.text = _loc3_.NeedGold[_loc1_].toString();
                  _loc4_.TF_Rate.text = STRING_RECHARGERANK.FORMAT_NONE_RATE;
               }
            }
            else
            {
      ...
      protected function UpdateItem() : void
      {
         ...
         _loc3_ = this.FRechargeRank.RankRewardList[this.FIndex].Inventories;
         _loc1_ = 0;
         while(_loc1_ < this.BOX_COUNT)
         {
