package Processors.Game.Lobby.Exercise.NinjaTreasure.Compoents
{
   ...
   public class TUINinjaTreasure1 extends TUIBaseWindow
   {
      ...
      protected var FNinjaTreasure1:TNinjaTreasure1;
      ...
      public function TUINinjaTreasure1(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateRoad() : void
      {
         ...
         this.FUIPage.TotalQuantity = TNinjaTreasure1.MAX_COUNT;
         this.FUIPage.Update();
         if(this.FNinjaTreasure1.CurIndex == -1 && this.FCurPage == 0)
         {
            FMC_Scene.MC_Head.visible = true;
            FMC_Scene.MC_HeadEnd.visible = false;
            FMC_Scene.MC_Road.MC_LastBox.MC_Got.visible = false;
         }
         else if(this.FNinjaTreasure1.CurIndex == TNinjaTreasure1.MAX_COUNT - 1 && this.FCurPage == 1)
         {
         ...
         if(this.FNinjaTreasure1.CurIndex == TNinjaTreasure1.MAX_COUNT - 1)
         {
         ...
         while(_loc1_ < ROAD_COUNT)
         {
            ...
            _loc4_ = this.FNinjaTreasure1.BoxList[_loc3_];
            ...
            if(_loc3_ == this.FNinjaTreasure1.CurIndex)
            {
         ...
         if(this.FCurPage == 0)
         {
            FMC_Scene.MC_BackPic.gotoAndStop(1);
         ...
         {
            FMC_Scene.MC_BackPic.gotoAndStop(2);
      ...
      {
         if(this.FNinjaTreasure1.SignStatus == TBaseActivity.STATUS_CANGET)
         {
            TGameUtil.setButtonMode(FMC_Scene.BTN_Sign,true);
      ...
      protected function UpdateText() : void
      {
         ...
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FNinjaTreasure1.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FNinjaTreasure1.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FNinjaTreasure1.DescListNew[1];
         _loc1_ = this.FNinjaTreasure1.GetNextBoxIndex();
         if(_loc1_ != -1)
         {
            _loc2_ = this.FNinjaTreasure1.BoxList[_loc1_].Inventories;
            this.FNextBox.UpdateUI(_loc2_);
            FMC_Scene.TF_NextBox.text = TUtilityString.Format(this.FNinjaTreasure1.DescListNew[2],_loc1_ - this.FNinjaTreasure1.CurIndex);
         }
         FMC_Scene.TF_LastBox.text = TUtilityString.Format(this.FNinjaTreasure1.DescListNew[2],this.FNinjaTreasure1.BoxList.length - 1 - this.FNinjaTreasure1.CurIndex);
      }
      
      protected function ProcessorOnSignUp(param1:MouseEvent) : void
      {
         if(FOnGetBox != null && this.FNinjaTreasure1.SignStatus == TBaseActivity.STATUS_CANGET && !FIsPlaying)
         {
            FOnGetBox(ACTIVITY_1_ID,TProcessorNinjaTreasure.ACTIVITY_1_SIGN);
         }
      }
      ...
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FNinjaTreasure1) && this.FNinjaTreasure1.DescList.length >= 4)
         {
            FOnShowHtmlTip(this.FNinjaTreasure1.DescListNew[3]);
         }
      }
      ...
      override public function LogicsPerform() : void
      {
         ...
         {
            if(this.FNinjaTreasure1)
            {
               FMC_Scene.TF_Time.text = TGameUtil.fomatTime(this.FNinjaTreasure1.EndTime - STimingCore.GetServerTick());
               _loc1_ = 0;
               while(_loc1_ < ROAD_COUNT)
               {
      ...
      {
         this.FNinjaTreasure1 = SLogicsCore.NinjaTreasureDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TNinjaTreasure1;
         this.UpdatePage();
         this.UpdateWindow();
      }
      ...
      {
         if(this.FNinjaTreasure1.CurIndex >= ROAD_COUNT)
         {
      ...
      override public function MovieEnd() : void
      {
         ...
         if(this.FMovieType == MOVIE_ROTATION_DISK)
         {
            this.FMoveIndex = this.FNinjaTreasure1.CurIndex;
            this.FEndIndex = Math.min(TNinjaTreasure1.MAX_COUNT - 1,this.FNinjaTreasure1.CurIndex + this.FStep);
         ...
         {
            FIsPlaying = false;
            this.FNinjaTreasure1.CurIndex = this.FEndIndex;
            if(Boolean(this.FNinjaTreasure1.BoxList[this.FEndIndex]) && Boolean(this.FNinjaTreasure1.BoxList[this.FEndIndex].Type > 0) && FOnShowFlowText != null)
            {
               _loc2_ = this.FNinjaTreasure1.BoxList[this.FEndIndex].Inventories.GetInventoryByIndex(0);
