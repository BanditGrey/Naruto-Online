package Processors.Game.Lobby.Recruit
{
   ...
   import Processors.Game.Windows.Information.TUIWindowRecruitBuyGoods;
   ...
   public class TProcessorWindowRecruitMall extends TProcessorWindowTemplate
   {
      ...
      protected var FUIWindowBuyGoods:TUIWindowRecruitBuyGoods;
      
      protected var FProcessorWindowRecruit:Processors.Game.Lobby.Tavern.TProcessorWindowRecruit;
      ...
      public function TProcessorWindowRecruitMall(param1:TUIComponent)
      {
         super(param1);
         this.Init();
      }
      ...
      {
         this.FMallItemList = new Vector.<TUIMallItem>(CONST_GLOBALBATTLE.Capacity_MallItems);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         FMainUI = TUtilityReflection.CreateDisplayObjectInstance("MC_RecruitMall") as Sprite;
         UIDispatch();
         _loc2_ = CONST_GLOBALBATTLE.CAPACITY_Mall_Tabs;
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
         ...
         _loc6_.text = "0/0";
         this.FUIPage.PageSize = CONST_GLOBALBATTLE.Capacity_MallItems;
         this.FUIPage.Init();
         ...
         this.FUIWindowBuyGoods = new TUIWindowRecruitBuyGoods(this,CONST_MODULES.MODULE_DrawNinaja);
         ...
         this.FProcessorWindowRecruit = new Processors.Game.Lobby.Tavern.TProcessorWindowRecruit(this);
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         this.FUnstreamizerRecruit.UnstreamizeInventorySamplesByDatabase(null,this.FInventorySamples,null);
         _loc2_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_ConfigValue,CONST_CONFIGVALUE.GlobalBattleMall) as TConfigValue;
      ...
      protected function UpdateNinjaPoint(param1:int) : void
      {
         this.FTF_NinjaPoint.text = param1.toString();
      }
      ...
      public function UpdateNinjaPointUI(param1:int) : void
      {
         this.UpdateNinjaPoint(param1);
      }
