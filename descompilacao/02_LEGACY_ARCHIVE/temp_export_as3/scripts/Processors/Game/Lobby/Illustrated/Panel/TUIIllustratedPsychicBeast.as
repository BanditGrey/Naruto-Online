package Processors.Game.Lobby.Illustrated.Panel
{
   ...
   public class TUIIllustratedPsychicBeast extends TUIBaseWindow
   {
      ...
      public function TUIIllustratedPsychicBeast(param1:TUIComponent)
      {
         super(param1);
      }
      ...
      {
         TIllustratedModel.PsychicBeasts = TIllustratedModel.Sort(TIllustratedModel.PsychicBeasts);
         if(this._maxPage == -1)
         {
            this._maxPage = Math.ceil(TIllustratedModel.PsychicBeasts.length / 8);
            this.page = 1;
         }
         else
         {
      ...
      override public function LogicsPerform() : void
      {
         ...
         var _loc2_:int = Math.min(this._page * 8,TIllustratedModel.PsychicBeasts.length);
         var _loc3_:int = 0;
         while(_loc3_ < 8)
         {
            if(_loc1_ + _loc3_ < _loc2_)
            {
               _loc4_ = TIllustratedModel.PsychicBeasts[_loc1_ + _loc3_];
               _loc5_ = TIllustratedModel.Psychics.GetDatebaseByIdentifier(_loc4_.SuitIdVector[0]) as TBB_Status;
               TGameUtil.ShowImageByID(TGameUtil.Type_Pet,this._psychics[_loc3_],CONST_MODULES.MODULE_TongLing,_loc5_.SmPic,1);
            }
            _loc3_++;
         }
      }
      ...
      public function set page(param1:int) : void
      {
         ...
         var _loc3_:int = Math.min(this._page * 8,TIllustratedModel.PsychicBeasts.length);
         var _loc4_:int = 0;
         while(_loc4_ < 8)
         {
            ...
            {
               _loc5_ = TIllustratedModel.PsychicBeasts[_loc2_ + _loc4_];
               ...
               _loc7_ = TIllustratedModel.Psychics.GetDatebaseByIdentifier(_loc5_.SuitIdVector[0]) as TBB_Status;
               TGameUtil.ShowImageByID(TGameUtil.Type_Pet,this._psychics[_loc4_],CONST_MODULES.MODULE_TongLing,_loc7_.SmPic,1);
            }
            _loc4_++;
         }
      }
