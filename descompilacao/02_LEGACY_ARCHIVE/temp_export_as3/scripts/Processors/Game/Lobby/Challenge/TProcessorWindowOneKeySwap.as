package Processors.Game.Lobby.Challenge
{
   ...
   public class TProcessorWindowOneKeySwap extends TProcessorLobbyWindow
   {
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_OneKeySwap = TUtilityReflection.CreateDisplayObjectInstance("MC_ChallengeOneKeySwap") as MovieClip;
      ...
      protected function ProcessorHeroHeadOnLcick(param1:Object, param2:Object) : void
      {
         ...
         if(_loc4_ == null)
         {
            ...
            {
               FOnEffectText(STRING_HEROS.STRING_ExchangeDifferent);
            }
            return;
         }
      ...
      protected function OneKeySwapOnClick(param1:MouseEvent) : void
      {
         ...
         while(_loc4_ < _loc5_)
         {
            ...
            {
               FOnEffectText(STRING_HEROS.STRING_RequireLevelNoReach);
               return;
            }
            _loc4_++;
         }
         ...
         while(_loc4_ < _loc5_)
         {
            ...
            {
               FOnEffectText(STRING_HEROS.STRING_QualityNoReach);
               return;
            }
            _loc4_++;
         }
         ...
         {
            FOnEffectText(STRING_HEROS.STRING_CanNotUseOneKeySwap);
            return;
         }
      ...
      public function UpdataBitmap() : void
      {
         var _loc1_:int = 0;
         _loc1_ = 0;
         while(_loc1_ < this.CAPACITY_HeroHead)
         {
            if(Boolean(this.FHeroHeadList) && _loc1_ < this.FHeroHeadList.length)
            {
               this.FHeroHeadList[_loc1_].UpdateBitmap();
            }
            _loc1_++;
         }
         this.FMC_HeadFirst.UpdateBitmap();
         this.FMC_HeadSecond.UpdateBitmap();
      }
   }
}
