package Processors.Game.Lobby.InviteCode
{
   ...
   import Processors.Game.Lobby.InviteCode.Components.TInviteCodeUser;
   import flash.display.MovieClip;
   
   public class TProcessorInviteCodeUser
   {
      ...
      public function TProcessorInviteCodeUser()
      {
         super();
      }
      ...
      protected function ResourcesPerformUIDispatch(param1:MovieClip) : void
      {
         ...
         this.FScrollBar = new TScrollBar(this.FMCScene["mc_list"],390,false,0);
      ...
      public function UpdateInviteCodeList(param1:Array) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:TInviteCodeUser = null;
         ...
         while(_loc3_ < _loc2_)
         {
            _loc4_ = new TInviteCodeUser(this.FMCScene);
