package Processors.Game.TopTeamBattle
{
   ...
   public class TTopTeamLoading extends TProcessor
   {
      ...
      public function TTopTeamLoading(param1:TUIComponent)
      {
         super(param1);
         Visible = false;
      ...
      protected function InitWindow() : void
      {
         ...
         this.FBattleScene = TUtilityReflection.CreateDisplayObjectInstance(CONST_BATTLE.RESOURCE_ClassName_TopTeamBattle_BattleLoad) as MovieClip;
