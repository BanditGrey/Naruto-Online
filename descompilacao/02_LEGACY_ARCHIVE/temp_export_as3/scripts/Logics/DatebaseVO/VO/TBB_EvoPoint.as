package Logics.DatebaseVO.VO
{
   ...
   public class TBB_EvoPoint extends TDatebaseVO
   {
      
      protected var FTargetId:int;
      
      protected var FGetPoint:int;
      
      public function TBB_EvoPoint()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         param1.writeUnsignedInt(this.FTargetId);
         param1.writeUnsignedInt(this.FGetPoint);
      }
      
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         this.FTargetId = param1.readUnsignedInt();
