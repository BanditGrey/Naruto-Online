package Logics.DatebaseVO.VO
{
   ...
   public class TWeddingTime extends TDatebaseVO
   {
      
      protected var FStartTime:String;
      
      protected var FEndTime:String;
      
      public function TWeddingTime()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         TUtilityString.FlushUTF(param1,this.FStartTime);
         TUtilityString.FlushUTF(param1,this.FEndTime);
      }
      
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         this.FStartTime = TUtilityString.FetchUTF(param1);
         this.FEndTime = TUtilityString.FetchUTF(param1);
      }
