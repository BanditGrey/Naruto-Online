package Logics.DatebaseVO.VO
{
   ...
   public class TTalentLevelGifts extends TDatebaseVO
   {
      
      protected var FTalentLevel:int;
      ...
      public function TTalentLevelGifts()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         param1.writeUnsignedInt(this.FTalentLevel);
      ...
      {
         this.FTalentLevel = param1.readUnsignedInt();
