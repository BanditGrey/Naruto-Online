package Logics.DatebaseVO.VO
{
   ...
   public class TActivityDesc extends TDatebaseVO
   {
      
      protected var FDesc:String;
      
      public function TActivityDesc()
      {
         super();
      }
               ...
               else
               {
                  ...
                  if(hasOwnProperty(_loc3_.slice(1)))
                  {
                     ...
                     else if(this[_loc3_] is String)
                     {
                        ...
                        this[_loc3_] = String(this[_loc3_]).split("&gt;").join(">");
                        this[_loc3_] = String(this[_loc3_]).split("%s%").join(" ");
                        this[_loc3_] = String(this[_loc3_]).split("%n%").join("\n");
                     }
                     else
                     {
                        this[_loc3_] = _loc4_;
