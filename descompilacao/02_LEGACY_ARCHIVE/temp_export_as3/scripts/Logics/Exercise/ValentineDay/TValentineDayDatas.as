package Logics.Exercise.ValentineDay
{
   ...
   public class TValentineDayDatas
   {
      ...
      public function TValentineDayDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TValentineDay1,TValentineDay2,TValentineDay3,TValentineDay4]);
         super();
      ...
      public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TValentineDay1 = null;
         _loc3_ = this.FActivities[0] as TValentineDay1;
         if(_loc3_.Status == TBaseActivity.STATUS_CANGET || _loc3_.CurStatus == TBaseActivity.STATUS_CANGET || _loc3_.FreeCount > 0)
         {
      ...
      public function ChangeStatus3() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TValentineDay3 = null;
         return TBaseActivity.STATUS_CANNOTGET;
      }
