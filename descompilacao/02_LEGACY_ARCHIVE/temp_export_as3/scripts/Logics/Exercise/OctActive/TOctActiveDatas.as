package Logics.Exercise.OctActive
{
   ...
   public class TOctActiveDatas
   {
      ...
      protected var ACTIVITY_COUNT:int = 3;
      ...
      public function TOctActiveDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TOctActive1,TOctActive2,TOctActive3]);
         super();
      ...
      public function ChangeStatus1() : int
      {
         ...
         _loc1_ = 0;
         while(_loc1_ < _loc3_.ServerList.length)
         {
            if(_loc3_.ServerList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
      ...
      public function ChangeStatus2() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TOctActive2 = null;
         _loc3_ = this.FActivities[1] as TOctActive2;
         if(_loc3_.BigCannon.Min == _loc3_.BigCannon.Max)
         {
            return TBaseActivity.STATUS_CANGET;
         }
         return TBaseActivity.STATUS_CANNOTGET;
      ...
      public function ChangeStatus3() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TOctActive3 = null;
         _loc3_ = this.FActivities[2] as TOctActive3;
         return TBaseActivity.STATUS_CANNOTGET;
      }
