package Logics.Exercise.WanSheng2
{
   ...
   public class TWanSheng2 extends TBaseActivity
   {
      ...
      public function ChangeStatus() : void
      {
         ...
         if(Boolean(this.Hero) && Boolean(this.Hero.Status != TBaseActivity.STATUS_GETED) && ShopExchangePoint >= this.Hero.Price)
         {
