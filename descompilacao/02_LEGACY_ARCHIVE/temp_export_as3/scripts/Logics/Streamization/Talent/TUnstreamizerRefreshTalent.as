package Logics.Streamization.Talent
{
   ...
   public class TUnstreamizerRefreshTalent extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerRefreshTalent()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc7_:TTalentGiftsData = null;
         _loc7_ = param2 as TTalentGiftsData;
         _loc7_.Clear();
         _loc4_ = uint(param1.readShort());
         _loc5_ = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = new TTalentGifts();
            _loc6_.Identifier = param1.readInt();
            _loc6_.Reward = param1.readInt();
            _loc6_.TopReward = param1.readInt();
            _loc7_.Add(_loc6_);
            this.UnstreamizationInventory(null,_loc6_,_loc6_.RefreshTalentGifts);
            _loc5_++;
         }
      }
      ...
      protected function UnstreamizationInventory(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc10_:TRefreshTalentGifts = null;
         var _loc11_:TTalentGifts = null;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         var _loc15_:int = 0;
         ...
         _loc11_ = param2 as TTalentGifts;
         _loc10_ = param3 as TRefreshTalentGifts;
