package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerMidAutumn extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerMidAutumn()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc17_:TMidAutumn = null;
         _loc17_ = param2 as TMidAutumn;
         _loc15_ = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_Article);
         _loc17_.Identify = CONST_BASEACTIVITY.TYPE_NewActiveList_MidAutumn;
         ...
         _loc17_.FreeBoxStatus = param1.readInt();
         ...
         if(_loc17_.NeedConfig)
         {
            ...
            while(_loc4_ < _loc6_)
            {
               ...
               _loc16_.OverlayerType = TBaseBox.OVERLAYER_TYPE_GET_ONE;
            ...
            while(_loc4_ < _loc6_)
            {
               ...
               _loc16_.ExchangeInventories = _loc9_;
               _loc17_.PetVect[_loc4_] = _loc16_;
               _loc4_++;
            }
         }
      }
