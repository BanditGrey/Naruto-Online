package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerNinjaCrystal extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerNinjaCrystal()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         _loc21_.GiftPrice = param1.readUnsignedInt();
         _loc21_.GiftCount = param1.readUnsignedInt();
         ...
         _loc21_.LotteryPrice.length = 0;
         _loc21_.LotteryItems.length = 0;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            _loc21_.LotteryPrice[_loc4_] = param1.readUnsignedInt();
            _loc15_.length = 0;
            _loc16_.length = 0;
            _loc11_ = new TInventories();
            _loc8_ = int(param1.readUnsignedShort());
            ...
            while(_loc5_ < _loc8_)
            {
               _loc22_ = int(param1.readUnsignedInt());
               _loc14_ = param1.readUnsignedInt();
               _loc13_ = param1.readUnsignedInt();
               _loc12_ = CONST_COMMON.GetItemIDByType(_loc14_,_loc13_,_loc17_);
               _loc15_.push(_loc12_);
            ...
            while(_loc5_ < _loc8_)
            {
               _loc10_ = _loc11_.GetInventoryByIndex(_loc5_);
               _loc10_.Quantity = _loc16_[_loc5_];
               _loc10_.ShowFire = _loc22_;
               _loc5_++;
            }
            _loc21_.LotteryItems[_loc4_] = _loc11_;
            _loc4_++;
         }
         _loc18_ = new TBaseBox();
