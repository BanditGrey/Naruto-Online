package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerWanSheng2 extends TUnstreamizer
   {
      ...
      public function TUnstreamizerWanSheng2(param1:int)
      {
         super();
