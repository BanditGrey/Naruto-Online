package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerJanActive extends TUnstreamizer
   {
      ...
      public function TUnstreamizerJanActive(param1:int)
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:TJanActiveDatas = null;
         var _loc7_:TBaseActivity = null;
         var _loc8_:int = 0;
         var _loc9_:TBins = null;
         _loc6_ = param2 as TJanActiveDatas;
      ...
      protected function UnstreamizationPerform_1(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         ...
         var _loc17_:TJanActive1 = null;
         var _loc18_:TJanActiveDatas = null;
         ...
         _loc18_ = param2 as TJanActiveDatas;
         _loc17_ = _loc18_.GetActivityByIdentify(ACTIVITY_1_ID) as TJanActive1;
         ...
         _loc17_.IceIndex = param1.readUnsignedInt();
         _loc17_.MaxCount = param1.readUnsignedInt();
         _loc17_.AutoPrice = param1.readUnsignedInt();
         _loc17_.ScorePrice = param1.readUnsignedInt();
         _loc17_.FirstPlay = param1.readUnsignedInt();
         _loc17_.PriceList.length = 0;
         _loc6_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc6_)
         {
            _loc17_.PriceList[_loc4_] = param1.readUnsignedInt();
            _loc4_++;
         }
         ...
         while(_loc4_ < _loc6_)
         {
            _loc17_.IceList[_loc4_] = param1.readUnsignedInt();
            _loc4_++;
         }
      ...
      protected function UnstreamizationPerform_2(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         ...
         _loc20_ = new Vector.<int>();
         _loc18_ = param2 as TJanActiveDatas;
         _loc17_ = _loc18_.GetActivityByIdentify(ACTIVITY_2_ID) as TJanActive2;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc17_.DescList.length = 0;
         _loc6_ = param1.readShort();
         ...
         while(_loc4_ < _loc6_)
         {
            _loc17_.PointList[_loc4_] = param1.readInt();
            _loc4_++;
         }
         _loc17_.RechargeList.length = 0;
         _loc6_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc6_)
         {
            ...
            _loc16_.Inventories = _loc9_;
            _loc17_.RechargeList[_loc4_] = _loc16_;
            _loc4_++;
         }
         _loc16_ = new TBaseBox();
         _loc16_.Status = param1.readInt();
