package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerMarchActive extends TUnstreamizer
   {
      ...
      public function TUnstreamizerMarchActive(param1:int)
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:TMarchActiveDatas = null;
         var _loc7_:TBaseActivity = null;
         var _loc8_:int = 0;
         var _loc9_:TBins = null;
         _loc6_ = param2 as TMarchActiveDatas;
      ...
      protected function UnstreamizationPerform_1(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         ...
         var _loc17_:TMarchActive1 = null;
         var _loc18_:TMarchActiveDatas = null;
         ...
         _loc18_ = param2 as TMarchActiveDatas;
         _loc17_ = _loc18_.GetActivityByIdentify(ACTIVITY_1_ID) as TMarchActive1;
         ...
         _loc17_.Double = param1.readUnsignedInt();
         ...
         _loc17_.IceList.length = 0;
         _loc6_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc6_)
         {
            _loc17_.IceList[_loc4_] = param1.readInt();
            _loc4_++;
         }
         _loc13_.length = 0;
         _loc14_.length = 0;
      ...
      protected function UnstreamizationPerform_2(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         ...
         var _loc15_:Vector.<int> = null;
         var _loc16_:TBaseBox = null;
         var _loc17_:TMarchActive2 = null;
         var _loc18_:TMarchActiveDatas = null;
         var _loc19_:Vector.<int> = null;
         var _loc20_:Vector.<int> = null;
         ...
         _loc20_ = new Vector.<int>();
         _loc18_ = param2 as TMarchActiveDatas;
         _loc17_ = _loc18_.GetActivityByIdentify(ACTIVITY_2_ID) as TMarchActive2;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc17_.DescList.length = 0;
         _loc6_ = param1.readShort();
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc17_.NewsList[_loc4_] = _loc21_;
            _loc4_++;
         }
      }
