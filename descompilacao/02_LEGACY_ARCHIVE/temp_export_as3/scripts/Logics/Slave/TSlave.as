package Logics.Slave
{
   public class TSlave
   {
      ...
      protected var FDiscipleList:Vector.<TSlaveDisciple>;
      
      protected var FStartWorkTime:uint;
      
      protected var FTodayBuyCount:uint;
      
      public function TSlave()
      {
         super();
         this.FDiscipleList = new Vector.<TSlaveDisciple>(this.CAPACITY_Disciples);
      }
      ...
      public function get DiscipleList() : Vector.<TSlaveDisciple>
      {
         return this.FDiscipleList;
      }
      
      public function set DiscipleList(param1:Vector.<TSlaveDisciple>) : void
      {
      ...
      public function get TodayBuyCount() : uint
      {
         return this.FTodayBuyCount;
      }
      
      public function set TodayBuyCount(param1:uint) : void
      {
         this.FTodayBuyCount = param1;
      }
      
      public function GetDiscipleByID(param1:uint, param2:uint) : TSlaveDisciple
      {
         var _loc3_:int = 0;
         var _loc4_:uint = 0;
