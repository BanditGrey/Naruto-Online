package Rendering.Overlayers.MidAutumn
{
   ...
   public class TOverlayerSimpleSprite extends TOverlayer
   {
      ...
      public function TOverlayerSimpleSprite(param1:TUIComponent)
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         ...
         this.FPainterExplain2 = ConstructPainterTextEffect(QUALITYCOLOR_Red);
         this.FBoundsExplain2 = new TBounds();
         this.FPainterExplain3 = ConstructPainterTextEffect(QUALITYCOLOR_Green);
      ...
      protected function EvaluationPerform_Explain0() : void
      {
         ...
         this.FContextExplain0 = "";
         this.FContextExplain0 = STRING_BASEACTIVITY.FORMAT_ACTIVITY_PET_STRING;
      ...
      protected function EvaluationPerform_Explain1() : void
      {
         ...
         var _loc2_:int = 0;
         this.FContextExplain1 = "";
         this.FContextExplain1 = "\n" + SLogicsCore.MidAutumn.ActivityName;
      ...
      protected function EvaluationPerform_Explain2() : void
      {
         ...
         this.FTitleConfig = FContext as TActivityPetConfig;
         this.FContextExplain2 = "";
         this.FContextExplain2 = "\n" + SLogicsCore.MidAutumn.ActivityTabName;
      ...
      protected function EvaluationPerform_Explain3() : void
      {
         ...
         this.FTitleConfig = FContext as TActivityPetConfig;
         this.FContextExplain3 = "";
         this.FContextExplain3 = "\n" + SLogicsCore.MidAutumn.ActivityDesc2;
      ...
      protected function SketchingPerform_Explain2() : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:Array = null;
         this.FPainterExplain1.RenderBounds(this.FBoundsExplain2,TAlignment.HORIZONTAL_Center);
      }
      ...
      protected function SketchingPerform_Explain3() : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:Array = null;
         this.FPainterExplain1.RenderBounds(this.FBoundsExplain3,TAlignment.HORIZONTAL_Center);
      }
