package Rendering.Overlayers.MidAutumn
{
   ...
   public class TOverlayerMidAutumn extends TOverlayer
   {
      ...
      public function TOverlayerMidAutumn(param1:TUIComponent)
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
      ...
      protected function EvaluationPerform_Explain0() : void
      {
         ...
         this.FContextExplain0 = "";
         this.FContextExplain0 = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_ROUND_COUNT,this.FBaseBox.Identify);
      ...
      protected function EvaluationPerform_Explain1() : void
      {
         ...
         this.FContextExplain1 = "";
         this.FContextExplain1 = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_EXPLORE_PRICE,_loc3_.Price);
      ...
      protected function EvaluationPerform_Explain2() : void
      {
         ...
         this.FContextExplain2 = "";
         if(_loc4_.OverlayerType == TBaseBox.OVERLAYER_TYPE_GET_ONE)
         {
            this.FContextExplain2 = STRING_BASEACTIVITY.FORMAT_ONE_ITEM;
         }
         else if(_loc4_.OverlayerType == TBaseBox.OVERLAYER_TYPE_GET_ALL)
         {
            this.FContextExplain2 = STRING_BASEACTIVITY.FORMAT_ALL_ITEM;
         }
      ...
      protected function EvaluationPerform_Explain3() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            ...
            if(this.Item_ID.indexOf(_loc3_.IDTemplate) == -1)
            {
      ...
      protected function SketchingPerform_Explain3() : void
      {
         ...
         while(_loc4_ < this.FInventories.Count)
         {
            ...
            this.FPainterExplain3.SetTextFormat(this.FExplainTextFormat,_loc2_,_loc3_);
            _loc2_ = _loc3_;
            _loc4_++;
         }
      }
