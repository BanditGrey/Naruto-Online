package Rendering.Overlayers.MasterRoad
{
   ...
   public class TOverlayerMasterRoadPalace extends TOverlayer
   {
      ...
      protected var FMasterRoadVenue:TMasterRoadVenue;
      
      public function TOverlayerMasterRoadPalace(param1:TUIComponent)
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
      ...
      {
         return param1 is TMasterRoadVenue;
      }
      ...
      protected function EvaluationPerform_Explain0() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         this.FMasterRoadVenue = FContext as TMasterRoadVenue;
         this.FContextExplain0 = this.FMasterRoadVenue.name;
      ...
      {
         this.FMasterRoadVenue = FContext as TMasterRoadVenue;
         this.FContextExplain1 = new ConsumeFrameCopy(STRING_MASTERROAD.STRING_001).DescribeString + this.FMasterRoadVenue.CurPoint + "\n";
      ...
      protected function EvaluationPerform_Explain2() : void
      {
         ...
         _loc1_ = (this.FMasterRoadVenue.CurPoint * 100 / this.FMasterRoadVenue.allAchievePoint).toFixed(2);
         this.FMasterRoadVenue = FContext as TMasterRoadVenue;
         this.FContextExplain2 = new ConsumeFrameCopy(STRING_MASTERROAD.STRING_002).DescribeString + _loc1_ + "%\n";
      ...
      protected function EvaluationPerform_Explain3() : void
      {
         ...
         this.FMasterRoadVenue = FContext as TMasterRoadVenue;
         _loc3_ = "";
         _loc4_ = this.FMasterRoadVenue.MedalAttribute;
         _loc1_ = 0;
         while(_loc1_ < _loc4_.length)
         {
            _loc2_ = BASEATTRIBUTENAMES.indexOf(_loc4_[_loc1_][0]);
            if(_loc4_[_loc1_][2] == 0)
            {
               _loc3_ += TUtilityString.Format(STRING_OVERLAYEREQUIPMENT.FORMAT_AppendAttributes,STRINGS_BASEATTRIBUTENAMES[_loc2_],_loc4_[_loc1_][1]);
            }
            else
            {
               _loc3_ += TUtilityString.Format(STRING_OVERLAYEREQUIPMENT.FORMAT_AppendAttributesPercentage,STRINGS_BASEATTRIBUTENAMES[_loc2_],int(_loc4_[_loc1_][1] * 100).toFixed(0));
            }
            _loc1_++;
         }
         if(this.FMasterRoadVenue.Status == TBaseActivity.STATUS_GETED)
         {
            _loc3_ = TUtilityString.Format(new ConsumeFrameCopy(STRING_MASTERROAD.STRING_011).DescribeString,_loc3_);
            this.FExplainTextFormat.color = QUALITYCOLOR_INDEX[2];
         }
         else
         {
            _loc3_ = TUtilityString.Format(new ConsumeFrameCopy(STRING_MASTERROAD.STRING_010).DescribeString,_loc3_);
            this.FExplainTextFormat.color = 4291611852;
         }
         ...
         this.FPainterExplain3.SetTextFormat(this.FExplainTextFormat);
