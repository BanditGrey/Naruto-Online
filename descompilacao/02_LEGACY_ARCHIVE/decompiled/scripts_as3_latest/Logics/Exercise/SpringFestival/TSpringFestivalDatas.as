package Logics.Exercise.SpringFestival
{
   ...
   public class TSpringFestivalDatas
   {
      ...
      public function TSpringFestivalDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TSpringFestivalFireworks,TSpringFestivalFish,TSpringFestivalTaiko,TSpringFestivalCollect]);
         super();
      ...
      public function ChangeSingleActivityStatus(param1:int) : Boolean
      {
         ...
         {
            case ACTIVITY_1_ID:
               _loc2_ = this.ChangeFireworkStatus();
               break;
            case ACTIVITY_2_ID:
               _loc2_ = this.ChangeFishStatus();
               break;
            case ACTIVITY_3_ID:
               _loc2_ = this.ChangeTaikoStatus();
               break;
            case ACTIVITY_4_ID:
               _loc2_ = this.ChangeCollectStatus();
         }
      ...
      public function ChangeFireworkStatus() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSpringFestivalFireworks = null;
         _loc3_ = this.FActivities[0] as TSpringFestivalFireworks;
         _loc1_ = 0;
         ...
         _loc1_ = 0;
         while(_loc1_ < _loc3_.FishList.length)
         {
            if(_loc3_.FishList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
         }
         if(_loc3_.FireworkStatus == TBaseActivity.STATUS_CANGET)
         {
            return TBaseActivity.STATUS_CANGET;
         }
      ...
      public function ChangeFishStatus() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSpringFestivalFish = null;
         _loc3_ = this.FActivities[1] as TSpringFestivalFish;
         _loc1_ = 0;
         while(_loc1_ < _loc3_.BoxList.length)
         {
            if(_loc3_.BoxList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
      ...
      public function ChangeTaikoStatus() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSpringFestivalTaiko = null;
         _loc3_ = this.FActivities[2] as TSpringFestivalTaiko;
         _loc1_ = 0;
         while(_loc1_ < _loc3_.BoxList.length)
         {
            if(_loc3_.BoxList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
      ...
      public function ChangeCollectStatus() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSpringFestivalCollect = null;
         _loc3_ = this.FActivities[3] as TSpringFestivalCollect;
         if(_loc3_.Count > 0)
         {
            return TBaseActivity.STATUS_CANGET;
         }
