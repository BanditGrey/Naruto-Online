package Logics.Exercise.JulyActive
{
   ...
   public class TJulyActiveDatas
   {
      ...
      public function TJulyActiveDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TJulyActive1,TJulyActive2]);
         super();
      ...
      public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TJulyActive1 = null;
         _loc3_ = this.FActivities[0] as TJulyActive1;
         if(_loc3_.DailyStatus == TBaseActivity.STATUS_CANGET)
         {
            return TBaseActivity.STATUS_CANGET;
         }
         _loc2_ = int(_loc3_.BuyCountAwards.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            if(_loc3_.BuyCountAwards[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
      ...
      public function ChangeStatus2() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TJulyActive2 = null;
         _loc3_ = this.FActivities[1] as TJulyActive2;
         if(_loc3_.AllKillStatus == TBaseActivity.STATUS_CANGET)
         {
            return TBaseActivity.STATUS_CANGET;
         }
         _loc2_ = int(_loc3_.KillBoxList.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            if(_loc3_.KillBoxList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
