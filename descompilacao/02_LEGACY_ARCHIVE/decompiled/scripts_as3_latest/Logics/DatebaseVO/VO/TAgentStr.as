package Logics.DatebaseVO.VO
{
   ...
   public class TAgentStr extends TDatebaseVO
   {
      
      protected var FAgentName:String;
      
      protected var FPic:uint;
      
      public function TAgentStr()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         TUtilityString.FlushUTF(param1,this.FAgentName);
         param1.writeUnsignedInt(this.FPic);
      }
      
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         this.FAgentName = TUtilityString.FetchUTF(param1);
         this.FPic = param1.readUnsignedInt();
      }
