package Logics.DatebaseVO.VO
{
   ...
   public class TBaiDuMM extends TDatebaseVO
   {
      
      protected var FPlatformID:uint;
      
      protected var FConditions:uint;
      
      protected var FRewardID:uint;
      
      public function TBaiDuMM()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         param1.writeUnsignedInt(this.FRewardID);
      }
      ...
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         ...
         this.FRewardID = param1.readUnsignedInt();
      }
      ...
      public function get Conditions() : uint
      {
