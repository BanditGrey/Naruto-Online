package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerFateRoulette extends TUnstreamizer
   {
      ...
      public function TUnstreamizerFateRoulette(param1:int)
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         _loc21_.MyScore = param1.readUnsignedInt();
         ...
         _loc21_.RewardIndex = param1.readUnsignedInt();
         _loc21_.BallList.length = 0;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            _loc21_.BallList[_loc4_] = param1.readInt();
            _loc4_++;
         }
         _loc21_.GameReward.length = 0;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            _loc21_.GameReward[_loc4_] = new Object();
            _loc21_.GameReward[_loc4_].Score = param1.readUnsignedInt();
            _loc21_.GameReward[_loc4_].Count = param1.readUnsignedInt();
            _loc4_++;
         }
         ...
         _loc21_.TitleList.length = 0;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            _loc21_.TitleList[_loc4_] = param1.readUnsignedInt();
            _loc4_++;
         }
         ...
         this.FUnstreamizerBaseActivityTask.UnstreamizeNew(param1,_loc21_.ActivityTaskData,null);
      }
