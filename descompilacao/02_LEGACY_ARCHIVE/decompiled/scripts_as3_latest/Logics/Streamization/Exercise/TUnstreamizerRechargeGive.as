package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerRechargeGive extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerRechargeGive()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc17_:TRechargeGive = null;
         _loc17_ = param2 as TRechargeGive;
         _loc15_ = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_Article);
         _loc17_.Identify = CONST_BASEACTIVITY.TYPE_NewActiveList_RechargeGive;
         ...
         _loc17_.CurConsume = param1.readUnsignedInt();
         _loc17_.CurRecharge = param1.readUnsignedInt();
         _loc13_ = new Vector.<uint>();
         _loc14_ = new Vector.<uint>();
         _loc17_.ConsumeBoxVect.length = 0;
         _loc6_ = int(param1.readUnsignedShort());
         _loc4_ = 0;
         while(_loc4_ < _loc6_)
         {
            _loc16_ = new TBaseBox();
            _loc16_.Identify = _loc4_ + 1;
            ...
            _loc17_.ConsumeBoxVect.push(_loc16_);
            _loc4_++;
         }
         _loc17_.RechargeBoxVect.length = 0;
         _loc6_ = int(param1.readUnsignedShort());
         _loc4_ = 0;
         while(_loc4_ < _loc6_)
         {
            ...
            _loc16_.Inventories = _loc9_;
            _loc17_.RechargeBoxVect.push(_loc16_);
            _loc4_++;
         }
      }
