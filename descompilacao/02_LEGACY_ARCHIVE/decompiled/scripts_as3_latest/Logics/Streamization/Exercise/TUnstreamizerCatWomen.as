package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerCatWomen extends TUnstreamizer
   {
      ...
      public function TUnstreamizerCatWomen(param1:int)
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         _loc21_.ServerRechargeGold = param1.readUnsignedInt();
         _loc21_.CurDiscount = param1.readUnsignedInt();
         ...
         _loc18_.ReturnMoney = param1.readUnsignedInt();
