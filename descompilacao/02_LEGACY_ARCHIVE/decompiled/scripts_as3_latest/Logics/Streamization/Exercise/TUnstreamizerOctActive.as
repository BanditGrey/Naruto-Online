package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerOctActive extends TUnstreamizer
   {
      ...
      public function TUnstreamizerOctActive(param1:int)
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:TOctActiveDatas = null;
         var _loc7_:TBaseActivity = null;
         var _loc8_:int = 0;
         var _loc9_:TBins = null;
         _loc6_ = param2 as TOctActiveDatas;
      ...
      protected function UnstreamizationPerform_1(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         ...
         var _loc17_:TOctActive1 = null;
         var _loc18_:TOctActiveDatas = null;
         ...
         _loc18_ = param2 as TOctActiveDatas;
         _loc17_ = _loc18_.GetActivityByIdentify(ACTIVITY_1_ID) as TOctActive1;
         ...
         _loc17_.IsBoxVisible = param1.readUnsignedInt();
         _loc13_.length = 0;
         _loc14_.length = 0;
         _loc19_.length = 0;
         _loc20_.length = 0;
      ...
      protected function UnstreamizationPerform_2(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         ...
         _loc20_ = new Vector.<int>();
         _loc18_ = param2 as TOctActiveDatas;
         _loc17_ = _loc18_.GetActivityByIdentify(ACTIVITY_2_ID) as TOctActive2;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc17_.DescList.length = 0;
         _loc6_ = param1.readShort();
         ...
         _loc17_.InitDescListNew();
         _loc17_.PointDescNew.length = 0;
         _loc6_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc6_)
         {
            _loc17_.PointDescNew[_loc4_] = TUtilityString.FetchUTF(param1);
            _loc4_++;
         }
         _loc17_.InitPointDescNew();
         _loc17_.IsDescVisible = param1.readUnsignedInt();
         _loc17_.IsBoxVisible = param1.readUnsignedInt();
         _loc17_.MyScore = param1.readUnsignedInt();
         _loc17_.ScoreA = param1.readUnsignedInt();
         _loc17_.ScoreB = param1.readUnsignedInt();
         _loc17_.Rate = param1.readUnsignedInt();
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc16_.Max = param1.readUnsignedInt();
            _loc16_.Min = param1.readUnsignedInt();
            _loc17_.PointList[_loc4_] = _loc16_;
            _loc4_++;
         }
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc16_.Level = param1.readUnsignedInt();
            _loc17_.CannonList[_loc4_] = _loc16_;
            _loc4_++;
         }
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            while(_loc5_ < _loc7_ / 5)
            {
               ...
               _loc23_.SoureID = param1.readUnsignedInt();
               _loc5_++;
            }
            _loc9_ = new TInventories();
            this.FUnstreamizerInventoryReference.UnstreamizeGenerateInventoriesByIdentifiers(null,_loc9_,_loc13_);
            ...
            _loc23_.Inventory = _loc8_;
            _loc23_.Inventories = _loc9_;
            _loc17_.NewsList.push(_loc23_);
            _loc4_++;
         }
      }
      ...
      protected function UnstreamizationPerform_3(param1:ByteArray, param2:Object, param3:TBins) : void
      {
         ...
         _loc20_ = new Vector.<int>();
         _loc18_ = param2 as TOctActiveDatas;
         _loc17_ = _loc18_.GetActivityByIdentify(ACTIVITY_3_ID) as TOctActive3;
         _loc17_.BeginTime = param1.readUnsignedInt();
         _loc17_.EndTime = param1.readUnsignedInt();
         _loc6_ = param1.readShort();
         _loc4_ = 0;
