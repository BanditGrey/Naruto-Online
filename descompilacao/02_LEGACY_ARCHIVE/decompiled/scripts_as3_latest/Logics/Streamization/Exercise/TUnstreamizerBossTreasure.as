package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerBossTreasure extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerBossTreasure()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc21_:TBossTreasure = null;
         ...
         _loc21_ = param2 as TBossTreasure;
         ...
         _loc21_.CurConsumeGold = param1.readUnsignedInt();
         _loc21_.TotalConsumeGold = param1.readUnsignedInt();
         _loc21_.Discount.length = 0;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            _loc21_.Discount[_loc4_] = param1.readUnsignedInt();
            _loc4_++;
         }
         _loc21_.Equiplist.length = 0;
         ...
         while(_loc4_ < _loc7_)
         {
            ...
            _loc23_.length = 0;
            _loc24_.length = 0;
            _loc23_.push(param1.readUnsignedInt());
            _loc22_.push(param1.readUnsignedInt());
            _loc24_.push(param1.readUnsignedInt());
            ...
            _loc10_.MinPrice = _loc22_[0];
            _loc10_.MaxPrice = _loc23_[0];
            _loc10_.LimitCount = _loc24_[0];
            _loc18_.Inventories = _loc11_;
            _loc21_.Equiplist[_loc4_] = _loc18_;
            _loc4_++;
         }
         _loc21_.Accessorylist.length = 0;
         _loc7_ = int(param1.readUnsignedShort());
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            ...
            _loc10_.LimitCount = _loc24_[0];
            _loc18_.Inventories = _loc11_;
            _loc21_.Accessorylist[_loc4_] = _loc18_;
            _loc4_++;
         }
         _loc21_.Itemlist.length = 0;
         _loc7_ = int(param1.readUnsignedShort());
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            ...
            _loc10_.LimitCount = _loc24_[0];
            _loc18_.Inventories = _loc11_;
            _loc21_.Itemlist[_loc4_] = _loc18_;
            _loc4_++;
         }
