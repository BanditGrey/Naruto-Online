package Logics.Streamization.LevelGifts
{
   ...
   public class TUnstreamizerHeroLevelGifts extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerHeroLevelGifts()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc7_:THeroLevelGiftsData = null;
         _loc7_ = param2 as THeroLevelGiftsData;
         _loc7_.Clear();
         _loc4_ = uint(param1.readShort());
         _loc5_ = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = new THeroLevelGiftsVO();
            _loc6_.Identifier = param1.readUnsignedInt();
            _loc6_.Reward = param1.readInt();
            _loc6_.TopReward = param1.readInt();
            _loc7_.Add(_loc6_);
            this.UnstreamizationInventory(null,_loc6_,_loc6_.HeroLevelGifts);
            _loc5_++;
         }
      ...
      protected function UnstreamizationInventory(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc10_:THeroLevelGifts = null;
         var _loc11_:THeroLevelGiftsVO = null;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         var _loc15_:int = 0;
         ...
         _loc11_ = param2 as THeroLevelGiftsVO;
         _loc10_ = param3 as THeroLevelGifts;
