package Processors.Game.Lobby.Talent.Component
{
   ...
   public class TUIHeroLevelGifts extends TUIComponent
   {
      ...
      protected var FLevelGifts:THeroLevelGiftsVO;
      ...
      public function TUIHeroLevelGifts(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("box_heroLevelGifts") as MovieClip;
      ...
      public function SetDate(param1:THeroLevelGiftsVO) : void
      {
         ...
         if(this.FLevelGifts)
         {
            ...
            this.FMC_Scene["TF_Level"].text = this.FLevelGifts.HeroLevelGifts.Level;
      ...
      public function get LevelGifts() : THeroLevelGiftsVO
      {
