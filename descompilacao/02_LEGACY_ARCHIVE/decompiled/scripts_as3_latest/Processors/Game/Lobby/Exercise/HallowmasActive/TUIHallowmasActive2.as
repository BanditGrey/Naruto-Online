package Processors.Game.Lobby.Exercise.HallowmasActive
{
   ...
   public class TUIHallowmasActive2 extends TUIBaseWindow
   {
      ...
      protected var FHallowmasActive2:THallowmasActive2;
      
      public function TUIHallowmasActive2(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function Resources_UIDispatch(param1:MovieClip) : void
      {
         ...
         if(!FMC_Scene || !FMC_Scene.MC_Fish0)
         {
            return;
         }
         _loc2_ = 0;
      ...
      protected function UpdateBox() : void
      {
         ...
         var _loc5_:int = 0;
         _loc5_ = this.FHallowmasActive2.GetCurLevel();
         _loc3_ = FMC_Scene.MC_Box;
         if(_loc5_ < this.FHallowmasActive2.BoxList.length)
         {
            _loc3_.MC_Got.visible = false;
            _loc4_ = this.FHallowmasActive2.BoxList[_loc5_];
            _loc3_.TF_Desc1.visible = true;
            _loc3_.TF_Desc2.visible = true;
            _loc3_.TF_Desc1.text = _loc4_.Desc1;
            _loc3_.TF_Desc2.text = _loc4_.Desc2;
            _loc3_.MC_Box.gotoAndStop(_loc5_ + 1);
         ...
         else
         {
            ...
            TGameUtil.setButtonMode(_loc3_.BTN_Get,false);
            _loc3_.TF_Desc1.visible = false;
            _loc3_.TF_Desc2.visible = false;
         }
      }
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FHallowmasActive2.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FHallowmasActive2.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FHallowmasActive2.ActivityDesc3;
         FMC_Scene.TF_Count.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_AMOUNT,this.FHallowmasActive2.Count);
         FMC_Scene.TF_Money.text = TUtilityString.Format(this.FHallowmasActive2.ActivityDesc2,this.FHallowmasActive2.TotalMoney);
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null)
         {
            _loc2_ = this.FHallowmasActive2.GetCurLevel();
            FOnGetBox(ACTIVITY_2_ID,TProcessorHallowmasActive.ACTIVITY_2_GET_BOX,_loc2_ + 1);
         }
      }
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         if(Boolean(FOnItemOver != null) && Boolean(this.FHallowmasActive2) && this.FHallowmasActive2.BoxList.length > 0)
         {
            _loc3_ = this.FHallowmasActive2.GetCurLevel();
            if(_loc3_ < this.FHallowmasActive2.BoxList.length)
            {
               _loc2_ = this.FHallowmasActive2.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      override protected function ProcessorOnBoxOut(param1:MouseEvent) : void
      {
         var _loc2_:TInventory = null;
         var _loc3_:int = 0;
         if(Boolean(FOnItemOut != null) && Boolean(this.FHallowmasActive2) && this.FHallowmasActive2.BoxList.length > 0)
         {
            _loc3_ = this.FHallowmasActive2.GetCurLevel();
            if(_loc3_ < this.FHallowmasActive2.BoxList.length)
            {
      ...
      {
         if(!this.FHallowmasActive2 || this.FHallowmasActive2.Count <= 0)
         {
            return;
         }
         if(FOnGetBox != null)
         {
            FOnGetBox(ACTIVITY_2_ID,TProcessorHallowmasActive.ACTIVITY_2_GET_FISH);
         }
      }
      ...
      protected function ProcessorOnGetFishOver(param1:MouseEvent) : void
      {
         ...
         FMC_Scene.MC_Net.x = param1.localX + 400;
         FMC_Scene.MC_Net.y = param1.localY + 197;
         if(Boolean(this.FHallowmasActive2) && this.FHallowmasActive2.Count > 0)
         {
      ...
      protected function ProcessorOnFishOver(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnSpecialOver != null) && Boolean(this.FHallowmasActive2) && this.FHallowmasActive2.FishList.length > 0)
         {
            FOnSpecialOver(0,this.FHallowmasActive2.FishList[_loc2_]);
         }
      }
      ...
      {
         this.FHallowmasActive2 = SLogicsCore.HallowmasActiveDatas.GetActivityByIdentify(ACTIVITY_2_ID) as THallowmasActive2;
         this.UpdateBox();
         this.UpdateBtn();
         this.UpdateText();
      }
