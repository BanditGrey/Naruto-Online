package Processors.Game.Lobby.Exercise.ConsumeRank
{
   ...
   import Processors.Game.Lobby.Exercise.ConsumeRank.Compoents.TUIRankReward2;
   ...
   public class TProcessorWindowTotalRank2 extends TProcessorLobbyWindow
   {
      ...
      protected var FRewardList:Vector.<TUIRankReward2>;
      ...
      public function TProcessorWindowTotalRank2(param1:TUIComponent)
      {
         super(param1);
         this.FUIPage = new TUIPage(this);
         this.FRankList = new Vector.<Sprite>(MAX_COUNT);
         this.FRewardList = new Vector.<TUIRankReward2>();
      ...
      protected function Resources_UIDispatch(param1:MovieClip) : void
      {
         ...
         {
            _loc4_ = this.FMC_RankList[CONST_CONSUMERANK.RESOURCE_Link_MC_Rank + _loc2_];
      ...
      {
         this.FMC_ChangePage = this.FMC_RankList[CONST_CONSUMERANK.RESOURCE_Link_MC_ChangePage];
      ...
      protected function UpdateReward() : void
      {
         var _loc1_:int = 0;
         var _loc2_:uint = 0;
         var _loc3_:TUIRankReward2 = null;
         if(!this.FRewardList || this.FRewardList.length == 0)
         {
            _loc2_ = this.FConsumeRank.RankRewardList2.length;
            _loc1_ = 0;
            while(_loc1_ < _loc2_)
            {
               _loc3_ = new TUIRankReward2(this,2);
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FConsumeRank.RankInfoList2.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < MAX_COUNT)
         {
            _loc2_ = _loc1_ + this.FCurPage * MAX_COUNT;
            _loc3_ = this.FMC_RankList[CONST_CONSUMERANK.RESOURCE_Link_MC_Rank + _loc1_];
            _loc4_ = _loc3_.TF_Rank;
            _loc5_ = _loc3_.TF_ServerID;
            _loc6_ = _loc3_.TF_Name;
            _loc7_ = _loc3_.TF_Score;
            if(_loc2_ < this.FConsumeRank.RankInfoList2.length)
            {
               _loc4_.visible = true;
               _loc5_.visible = true;
               _loc6_.visible = true;
               _loc7_.visible = true;
               _loc4_.text = this.FConsumeRank.RankInfoList2[_loc2_].Rank.toString();
               _loc5_.text = this.FConsumeRank.RankInfoList2[_loc2_].ServerName;
               _loc6_.text = this.FConsumeRank.RankInfoList2[_loc2_].UserName;
               _loc7_.text = this.FConsumeRank.RankInfoList2[_loc2_].Score.toString();
            }
            else
            {
         ...
         this.FShowItem.UpdateUI(this.FConsumeRank.GiftShowItems);
      }
      
      protected function UpdateText() : void
      {
         this.FTF_CurScore.text = TUtilityString.Format(STRING_CONSUMERANK.FORMAT_CUR_SCORE,this.FConsumeRank.PerScore2);
         if(this.FConsumeRank.PerRank2 == 1)
         {
            this.FTF_DiffScore.visible = false;
         }
         else if(this.FConsumeRank.PerRank2 > RANK_COUNT)
         {
            this.FTF_DiffScore.visible = true;
            this.FTF_DiffScore.text = TUtilityString.Format(STRING_CONSUMERANK.FORMAT_DIFF_FIFTY_SCORE,this.FConsumeRank.DiffScore2);
         }
         else
         {
            this.FTF_DiffScore.visible = true;
            this.FTF_DiffScore.text = TUtilityString.Format(STRING_CONSUMERANK.FORMAT_DIFF_SCORE,this.FConsumeRank.DiffScore2);
         }
         if(this.FConsumeRank.PerRank2 > RANK_COUNT)
         {
            this.FTF_Rank.text = STRING_CONSUMERANK.FORMAT_CUR_RANK;
         }
         else
         {
            this.FTF_Rank.text = this.FConsumeRank.PerRank2.toString();
         }
         if(this.FConsumeRank.CurReturn2 > 0)
         {
            this.FMC_Scene.TF_CurReturn.text = this.FConsumeRank.CurReturn2 + "%";
         }
         else
         {
            this.FMC_Scene.TF_CurReturn.text = STRING_CONSUMERANK.FORMAT_NONE_RATE;
         }
         if(this.FConsumeRank.DiffGold2 > 0)
         {
            this.FMC_Scene.TF_NextReturn.text = TUtilityString.Format(this.FConsumeRank.Desc4,this.FConsumeRank.DiffGold2,this.FConsumeRank.NextReturn2);
         }
         else
         {
      ...
      protected function ProcessorOnNameUp(param1:MouseEvent) : void
      {
         ...
         {
            this.FOnNameUp(this.FConsumeRank.RankInfoList2[_loc3_].Identify0,this.FConsumeRank.RankInfoList2[_loc3_].Identify1);
         }
      }
      ...
      protected function ProcessorOnShowEquipDesc(param1:uint, param2:int = 0) : void
      {
         ...
         {
            this.FOnShowEquip(this.FConsumeRank.GiftEquipments);
         }
      }
      ...
      public function get OnShowEquip() : Function
      {
         return this.FOnShowEquip;
      }
