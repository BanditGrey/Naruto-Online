package Processors.Game.Lobby.Exercise.BrazilCarnival
{
   ...
   public class TProcessorBrazilCarnivalRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorBrazilCarnivalRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550136838);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_BrazilCarnivalRank") as MovieClip;
      ...
      {
         if(this.FBrazilCarnivalRank.MyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FBrazilCarnivalRank.MyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FBrazilCarnivalRank.Score.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FBrazilCarnivalRank.RankRewardList.length)
            {
               _loc4_ = this.FBrazilCarnivalRank.RankRewardList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FBrazilCarnivalRank.RankList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FBrazilCarnivalRank.RankList.length)
            {
               _loc7_ = this.FBrazilCarnivalRank.RankList[_loc2_];
               if(this.FCurPage == 0)
               {
