package Processors.Game.Lobby.Exercise.ConsumeRank.Compoents
{
   ...
   public class TUIRankReward extends TUIComponent
   {
      ...
      public function TUIRankReward(param1:TUIComponent, param2:int = 1)
      {
         super(param1);
      ...
      protected function UpdateContent() : void
      {
         ...
         var _loc5_:int = 0;
         _loc3_ = this.FConsumeRank.RankRewardList[this.FIndex];
      ...
      protected function UpdateItem(param1:TInventories = null) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:TInventories = null;
         var _loc5_:TInventory = null;
         _loc4_ = param1 == null ? this.FConsumeRank.RankRewardList[this.FIndex].Inventories : param1;
         _loc2_ = 0;
         while(_loc2_ < this.BOX_COUNT)
         {
            if(_loc2_ < _loc4_.Count)
            {
               _loc5_ = _loc4_.GetInventoryByIndex(_loc2_);
               this.FSlotList[_loc2_].Context = _loc5_;
