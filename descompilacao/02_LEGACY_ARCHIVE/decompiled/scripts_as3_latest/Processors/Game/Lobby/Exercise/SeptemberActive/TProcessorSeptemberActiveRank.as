package Processors.Game.Lobby.Exercise.SeptemberActive
{
   ...
   public class TProcessorSeptemberActiveRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorSeptemberActiveRank(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_SeptemberActiveRank") as MovieClip;
      ...
      {
         if(this.FSeptemberActive3.CurMyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FSeptemberActive3.CurMyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FSeptemberActive3.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FSeptemberActive3.RankGiftList.length)
            {
               _loc4_ = this.FSeptemberActive3.RankGiftList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FSeptemberActive3.RankPlayerList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FSeptemberActive3.RankPlayerList.length)
            {
               _loc8_ = this.FSeptemberActive3.RankPlayerList[_loc2_];
               if(this.FCurPage == 0)
               {
