package Processors.Game.Lobby.Exercise.Christmas.Compoents
{
   ...
   public class TUIChristmasSign extends TUIChristmasBase
   {
      ...
      protected static const ACTIVITY_1_ID:int = TProcessorChristmas.ACTIVITY_1_ID;
      
      protected var FMC_AllDays:Vector.<MovieClip>;
      
      protected var FChristmasSign:TChristmasSign;
      ...
      public function TUIChristmasSign(param1:TUIComponent)
      {
         super(param1);
      ...
      public function UpdateDays() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            ...
            _loc9_ = ++_loc7_ - 2;
            _loc8_ = _loc9_ + 1;
            if(this.FChristmasSign.DayList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               _loc10_.MC_SelectBox.visible = true;
               _loc10_.MC_Got.visible = false;
            }
            else if(this.FChristmasSign.DayList[_loc1_].Status == TBaseActivity.STATUS_CANNOTGET)
            {
            ...
            {
               if(this.FChristmasSign.DayList[_loc1_].Status == TBaseActivity.STATUS_GETED)
               {
            ...
            else
            {
               ...
               if(_loc5_.getTime() > STimingCore.GetClientShowTime(this.FChristmasSign.EndTime) * 1000)
               {
                  _loc10_.gotoAndStop(5);
               }
               else
      ...
      {
         if(this.FChristmasSign.DayList[this.FToday - 1].Status == TBaseActivity.STATUS_CANGET)
         {
         ...
         else
         {
            ...
            if(this.FToday >= new Date(STimingCore.GetClientShowTime(this.FChristmasSign.EndTime) * 1000).getDate())
            {
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FChristmasSign.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FChristmasSign.EndTime) - 1) * 1000)));
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null)
         {
            FOnGetBox(ACTIVITY_1_ID,TProcessorChristmas.CHRISTMAS_SIGN_BOX);
         }
      }
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         ...
         if(FOnBoxOver != null && Boolean(this.FChristmasSign))
         {
            if(this.FToday >= new Date(STimingCore.GetClientShowTime(this.FChristmasSign.EndTime) * 1000).getDate())
            {
               _loc2_ = this.FChristmasSign.DayList[this.FToday - 1].Inventories;
            }
            else if(this.FChristmasSign.DayList[this.FToday - 1].Status == TBaseActivity.STATUS_CANGET)
            {
               _loc2_ = this.FChristmasSign.DayList[this.FToday - 1].Inventories;
            }
            else
            {
               _loc2_ = this.FChristmasSign.DayList[this.FToday].Inventories;
            }
      ...
      protected function ProcessorOnDayOver(param1:MouseEvent) : void
      {
         ...
         if(FOnBoxOver != null)
         {
            ...
            _loc3_ = this.FChristmasSign.DayList[_loc2_ - this.FFirstDayIndex].Inventories;
      ...
      {
         this.FChristmasSign = SLogicsCore.ChristmasDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TChristmasSign;
         this.UpdateDays();
         this.UpdateToday();
         this.UpdateText();
      }
