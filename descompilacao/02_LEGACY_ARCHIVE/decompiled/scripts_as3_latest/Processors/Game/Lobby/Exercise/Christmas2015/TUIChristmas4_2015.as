package Processors.Game.Lobby.Exercise.Christmas2015
{
   ...
   public class TUIChristmas4_2015 extends TUIBaseWindow
   {
      ...
      protected var FChristmas4_2015:TChristmas4_2015;
      ...
      public function TUIChristmas4_2015(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function Resources_UIDispatch(param1:MovieClip) : void
      {
         ...
         while(_loc2_ < FUND_COUNT)
         {
            ...
            TGameUtil.setSpriteButton(_loc5_.BTN_Buy,true);
      ...
      protected function UpdateText() : void
      {
         ...
         var _loc3_:int = 0;
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FChristmas4_2015.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FChristmas4_2015.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FChristmas4_2015.DescListNew[1];
      }
      ...
      protected function UpdateFund() : void
      {
         ...
         while(_loc1_ < FUND_COUNT)
         {
            ...
            _loc3_ = this.FChristmas4_2015.FundList[_loc1_];
            _loc2_.TF_Desc0.text = TUtilityString.Format(this.FChristmas4_2015.DescListNew[2],this.FChristmas4_2015.TotalRechargeGold,_loc3_.Count);
            _loc2_.TF_Desc1.text = this.FChristmas4_2015.DescListNew[3 + _loc1_];
            _loc2_.TF_Desc2.text = TUtilityString.Format(this.FChristmas4_2015.DescListNew[7],_loc3_.Discount);
            _loc2_.TF_Desc3.text = TUtilityString.Format(this.FChristmas4_2015.DescListNew[8],_loc3_.ReturnMoney);
            if(this.FChristmas4_2015.CurFund == 0)
            {
               _loc2_.BTN_Buy.visible = true;
               _loc2_.MC_Got.visible = false;
               if(this.FChristmas4_2015.TotalRechargeGold >= _loc3_.Count)
               {
            ...
            else if(_loc1_ == this.FChristmas4_2015.CurFund - 1)
            {
      ...
      protected function UpdateEgg() : void
      {
         ...
         while(_loc1_ < EGG_COUNT)
         {
            ...
            _loc3_ = this.FChristmas4_2015.EggList[_loc1_];
         ...
         FMC_Scene.TF_Count.text = TUtilityString.Format(this.FChristmas4_2015.DescListNew[15],this.FChristmas4_2015.LimitCount);
         FMC_Scene.MC_Movie0.visible = false;
         if(FMC_Scene.MC_End)
         {
            FMC_Scene.MC_End.visible = this.FChristmas4_2015.LimitCount == 0 ? true : false;
         }
      }
      ...
      protected function UpdateLuckyPlayer() : void
      {
         ...
         FMC_Scene.MC_LuckyPlayer.TF_Desc.text = this.FChristmas4_2015.DescListNew[12];
         this.FUIPage_LuckyPlayer.TotalQuantity = this.FChristmas4_2015.LuckyList.length;
         this.FUIPage_LuckyPlayer.Update();
         _loc1_ = 0;
         while(_loc1_ < LUCKY_COUNT)
         {
            _loc2_ = _loc1_ + this.FCurPage_LuckyPlayer * LUCKY_COUNT;
            if(_loc2_ < this.FChristmas4_2015.LuckyList.length)
            {
               _loc5_ = this.FChristmas4_2015.LuckyList[_loc2_];
               _loc6_ = TUtilityDate.FormatMMDDChineseNew(new Date(STimingCore.GetClientShowTime(_loc5_.GetTime) * 1000));
               FMC_Scene.MC_LuckyPlayer["TF_Log" + _loc1_].text = TUtilityString.Format(this.FChristmas4_2015.DescListNew[9],_loc6_,_loc5_.PlayerNick,_loc5_.Count);
            }
            else
            {
      ...
      protected function UpdateNews() : void
      {
         ...
         var _loc5_:TLotteryNews = null;
         var _loc6_:String = null;
         this.FUIPage_News.TotalQuantity = this.FChristmas4_2015.NewsList.length;
         this.FUIPage_News.Update();
         _loc1_ = 0;
         while(_loc1_ < NEWS_COUNT)
         {
            _loc2_ = _loc1_ + this.FCurPage_News * NEWS_COUNT;
            if(_loc2_ < this.FChristmas4_2015.NewsList.length)
            {
               _loc5_ = this.FChristmas4_2015.NewsList[_loc2_];
               _loc6_ = TUtilityDate.FormatMMDDChineseNew(new Date(STimingCore.GetClientShowTime(_loc5_.GetTime) * 1000));
               if(_loc5_.NewsType == TChristmas4_2015.TYPE_GOLD)
               {
                  FMC_Scene.MC_News["TF_Log" + _loc1_].text = TUtilityString.Format(this.FChristmas4_2015.DescListNew[10],_loc6_,_loc5_.PlayerNick,_loc5_.Count);
               }
               else
               {
                  FMC_Scene.MC_News["TF_Log" + _loc1_].text = TUtilityString.Format(this.FChristmas4_2015.DescListNew[11],_loc6_,_loc5_.PlayerNick,_loc5_.Count);
               }
            }
            else
            {
      ...
      protected function ProcessorOnBuyFund(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnBuyBox != null && !FIsPlaying) && Boolean(this.FChristmas4_2015) && this.FChristmas4_2015.CurFund == 0)
         {
            FOnBuyBox(ACTIVITY_4_ID,TProcessorChristmas2015.ACTIVITY_4_BUY_FUND,this.FChristmas4_2015.FundList[_loc2_].Price,_loc2_ + 1);
         }
      }
      ...
      protected function ProcessorOnEggUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnBuyBox != null && !FIsPlaying) && Boolean(this.FChristmas4_2015) && this.FChristmas4_2015.EggList[_loc2_] == 0)
         {
            if(this.FChristmas4_2015.LimitCount <= 0)
            {
               FOnShowFlowText(this.FChristmas4_2015.DescListNew[16]);
            }
            else
            {
               FOnBuyBox(ACTIVITY_4_ID,TProcessorChristmas2015.ACTIVITY_4_OPEN_EGG,this.FChristmas4_2015.Price,_loc2_ + 1);
      ...
      protected function ProcessorOnEggOver(param1:MouseEvent) : void
      {
         var _loc2_:int = 0;
         _loc2_ = int(String(param1.currentTarget.parent.name).slice(6));
         if(Boolean(this.FChristmas4_2015) && this.FChristmas4_2015.EggList[_loc2_] == 0)
         {
      ...
      {
         this.FChristmas4_2015 = SLogicsCore.ChristmasDatas_2015.GetActivityByIdentify(ACTIVITY_4_ID) as TChristmas4_2015;
         this.UpdateText();
         this.UpdateFund();
         this.UpdateEgg();
         this.UpdateLuckyPlayer();
      ...
      override public function MovieEnd() : void
      {
         ...
         if(this.FMovieType == MOVIE_OF_OPEN_EGG_GOLD)
         {
            ...
            if(this.FChristmas4_2015.IsEnd == 1)
            {
         ...
         {
            FMC_Scene.MC_Movie0.visible = false;
            this.FChristmas4_2015.ResetEgg();
            this.UpdateUI();
         }
      }
