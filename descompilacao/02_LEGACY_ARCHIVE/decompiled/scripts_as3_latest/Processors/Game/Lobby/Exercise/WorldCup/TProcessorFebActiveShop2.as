package Processors.Game.Lobby.Exercise.WorldCup
{
   ...
   public class TProcessorFebActiveShop2 extends TProcessorLobbyWindow
   {
      
      public static const ACTIVITY_1_ID:int = 1;
      
      public static const SIZE_Window_Width:uint = 590;
      
      public static const SIZE_Window_Height:uint = 443;
      ...
      public function TProcessorFebActiveShop2(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_BaseActiveShop") as MovieClip;
      ...
      protected function UpdateExchange() : void
      {
         ...
         this.FMC_Scene.TF_Point.text = this.FWorldCupDatas.giftGold.toString();
         this.FUIPage0.TotalQuantity = this.FWorldCupDatas.ShopExchangeItems.length;
         this.FUIPage0.Update();
         _loc1_ = 0;
         while(_loc1_ < EXCHANGE_COUNT)
         {
            _loc3_ = _loc1_ + this.FCurPage0 * EXCHANGE_COUNT;
            if(_loc3_ < this.FWorldCupDatas.ShopExchangeItems.length)
            {
               this.FExchangeList[_loc1_].SetVisible(true);
               _loc5_ = this.FWorldCupDatas.ShopExchangeItems[_loc3_];
               ...
               if(this.FWorldCupDatas.giftGold < _loc5_.Price || _loc5_.LimitCount <= 0)
               {
      ...
      protected function ProcessorOnExchangeUp(param1:MouseEvent) : void
      {
         ...
         if(this.FOnExchange != null)
         {
            ...
            this.FOnExchange(this.FWorldCupDatas.ShopExchangeItems[_loc3_].Identify,1);
         }
      }
