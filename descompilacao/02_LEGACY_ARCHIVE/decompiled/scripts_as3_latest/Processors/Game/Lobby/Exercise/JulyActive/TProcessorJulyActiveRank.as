package Processors.Game.Lobby.Exercise.JulyActive
{
   ...
   public class TProcessorJulyActiveRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorJulyActiveRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550137093);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_JulyActiveRank") as MovieClip;
      ...
      {
         if(this.FJulyActive1.CurMyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FJulyActive1.CurMyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FJulyActive1.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FJulyActive1.RankGiftList.length)
            {
               _loc4_ = this.FJulyActive1.RankGiftList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FJulyActive1.RankPlayerList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FJulyActive1.RankPlayerList.length)
            {
               _loc8_ = this.FJulyActive1.RankPlayerList[_loc2_];
               if(this.FCurPage == 0)
               {
