package Processors.Game.Lobby.Exercise.MayActive
{
   ...
   public class TProcessorWindowMayActiveLog extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorWindowMayActiveLog(param1:TUIComponent)
      {
         super(param1);
         this.FLogList = new Vector.<TLotteryNews>();
         this.FTF_LogList = new Vector.<TextField>();
      }
      ...
      protected function UpdateLog() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:TextField = null;
         this.FUIPage.TotalQuantity = this.FLogList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < LOG_COUNT)
         {
            ...
            if(_loc2_ < this.FLogList.length)
            {
               _loc3_.visible = true;
               _loc3_.htmlText = this.MakeHtmlTextInfo(this.FLogList.length - _loc2_ - 1);
            }
            else
            {
