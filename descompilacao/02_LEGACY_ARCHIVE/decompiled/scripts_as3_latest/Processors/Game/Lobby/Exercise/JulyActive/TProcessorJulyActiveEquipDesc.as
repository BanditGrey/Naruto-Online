package Processors.Game.Lobby.Exercise.JulyActive
{
   ...
   public class TProcessorJulyActiveEquipDesc extends TProcessorLobbyWindow
   {
      
      protected static const SIZE_Window_Width:uint = 732;
      
      protected static const SIZE_Window_Height:uint = 641;
      ...
      public function TProcessorJulyActiveEquipDesc(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_JulyActiveEquipDesc") as MovieClip;
      ...
      protected function UpdateBox() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FJulyActive1.EquipItems.Count;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < BOX_COUNT)
         {
            ...
            if(_loc2_ < this.FJulyActive1.EquipItems.Count)
            {
               _loc3_.visible = true;
               _loc4_ = this.FJulyActive1.EquipItems.GetInventoryByIndex(_loc2_);
