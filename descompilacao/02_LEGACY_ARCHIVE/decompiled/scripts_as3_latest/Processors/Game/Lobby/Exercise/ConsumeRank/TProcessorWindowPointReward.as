package Processors.Game.Lobby.Exercise.ConsumeRank
{
   ...
   import Processors.Game.Lobby.Exercise.ConsumeRank.Compoents.TUIPerReward;
   ...
   public class TProcessorWindowPointReward extends TProcessorLobbyWindow
   {
      ...
      protected function UpdateReward() : void
      {
         ...
         {
            _loc2_ = this.FConsumeRank.PerRewardList.length;
            _loc1_ = 0;
            while(_loc1_ < _loc2_)
            {
      ...
      {
         this.FTF_Desc.text = this.FConsumeRank.Desc2;
         this.FTF_Rank.text = this.FConsumeRank.PerScore.toString();
      }
