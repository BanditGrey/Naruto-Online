package Processors.Game.Lobby.Exercise.NewLottery.Compoents
{
   ...
   public class TUINewExchangeItem extends TUIComponent
   {
      ...
      public function TUINewExchangeItem(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FMC_Scene = this.FResource as MovieClip;
         this.FMC_Slot.Resource = this.FMC_Scene[CONST_LOTTERY.RESOURCE_Link_MC_Slot];
      ...
      protected function UILocations() : void
      {
         ...
         this.FMC_Scene.Btn_Exchange.addEventListener(MouseEvent.CLICK,this.ExchangeOnClick);
      }
      
      protected function UpdateItemInfo() : void
      {
         var _loc1_:int = 0;
         this.FMC_Scene.TF_LimitCount.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_MAX_LIMIT,this.FExchangeItemData.LimitCount - this.FExchangeItemData.BuyCount);
         this.FMC_Scene.TF_Price.text = this.FExchangeItemData.OriginalCost.toString();
         this.FMC_Scene.TF_CurPrice.text = this.FExchangeItemData.CostPoint.toString();
         this.FMC_Scene.TF_Level.text = TUtilityString.Format(STRING_LOTTERY.FORMAT_EXCHANGE_LEVEL,this.FExchangeItemData.LimitLevel);
         this.FMC_Scene.MC_Hot.visible = this.FExchangeItemData.IsHot == 0 ? false : true;
         this.FMC_Scene.MC_None.visible = this.FExchangeItemData.BuyCount < this.FExchangeItemData.LimitCount ? false : true;
         this.FMC_Scene.MC_Own.visible = this.FExchangeItemData.IsOwn == 0 ? false : true;
         this.FMC_Scene.MC_Level.visible = SLogicsCore.Character.GetMainLevel() >= this.FExchangeItemData.LimitLevel ? false : true;
         _loc1_ = int(SLogicsCore.NewLottery.Score);
         if(Boolean(this.FExchangeItemData.IsOwn) || Boolean(this.FExchangeItemData.BuyCount >= this.FExchangeItemData.LimitCount) || SLogicsCore.Character.GetMainLevel() < this.FExchangeItemData.LimitLevel)
         {
            this.FMC_Scene.Btn_Exchange.visible = false;
         }
         else if(_loc1_ < this.FExchangeItemData.CostPoint)
         {
            this.FMC_Scene.Btn_Exchange.visible = true;
