package Processors.Game.Lobby.Exercise.ThanksgivingDay
{
   ...
   public class TUIThanksgivingDay2 extends TUIBaseWindow
   {
      ...
      protected var FThanksgivingDay2:TThanksgivingDay2;
      ...
      public function TUIThanksgivingDay2(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function Resources_UIDispatch(param1:MovieClip) : void
      {
         ...
         this.FBTN_Log.addEventListener(MouseEvent.CLICK,this.ProcessorOnLoadLog);
         ...
         FMC_Scene["MC_FreeBox"].MC_Box.buttonMode = true;
         FMC_Scene["MC_FreeBox"].MC_Box.addEventListener(MouseEvent.CLICK,this.ProcessorOnFreeBox);
         FMC_Scene["MC_FreeBox"].MC_Box.addEventListener(MouseEvent.MOUSE_MOVE,this.ProcessorOnFreeBoxOver);
         FMC_Scene["MC_FreeBox"].MC_Box.addEventListener(MouseEvent.MOUSE_OUT,ProcessorOnHideHtmlTip);
      }
      ...
      protected function ProcessorOnOpenSeekTipOver(param1:MouseEvent) : void
      {
         ...
         {
            FOnShowHtmlTip(this.FThanksgivingDay2.DescListNew[12]);
         }
      }
      ...
      protected function ProcessorOnOpenSeek(param1:MouseEvent) : void
      {
         ...
         _loc2_ = this.FThanksgivingDay2.SeekTreasureMapBoxList[this.FChangeTabIndex];
      ...
      protected function ProcessorOnFreeBox(param1:MouseEvent) : void
      {
         if(Boolean(this.FThanksgivingDay2) && this.FThanksgivingDay2.FreeTimes > 0)
         {
            FOnGetBox(ACTIVITY_2_ID,TProcessorThanksgivingDay.ACTIVITY_2_GET_FREE_BOX);
         }
      }
      
      protected function ProcessorOnFreeBoxOver(param1:MouseEvent) : void
      {
         if(FOnShowHtmlTip != null && this.FThanksgivingDay2.DescList.length > 15)
         {
            FOnShowHtmlTip(this.FThanksgivingDay2.DescListNew[14]);
         }
      }
      ...
      protected function ProcessorOnCutTipOut(param1:MouseEvent) : void
      {
         ...
         _loc6_ = this.FThanksgivingDay2.MsgTreasure[this.FChangeTabIndex];
      ...
      protected function ProcessorOnSeekTipOut(param1:MouseEvent) : void
      {
         ...
         if(this.FThanksgivingDay2.TreasureMapBoxList[_loc2_] == null)
         {
            return;
         }
         _loc4_ = this.FThanksgivingDay2.TreasureMapBoxList[_loc2_].Inventories;
         if(_loc4_ == null)
         {
            return;
         }
         ...
         _loc3_ = this.FThanksgivingDay2.TreasureMapBoxList[_loc2_].Inventories.GetInventoryByIndex(0);
      ...
      protected function ProcessorOnRewardTipOver(param1:MouseEvent) : void
      {
         ...
         _loc3_ = this.FThanksgivingDay2.MsgTreasure[this.FChangeTabIndex];
      ...
      private function ProcessorOnTipOver(param1:Event) : void
      {
         ...
         _loc3_ = this.FThanksgivingDay2.BuyTreasureMapBoxList[_loc2_].Inventories.GetInventoryByIndex(0);
         if(FOnItemOver != null)
         {
            FOnItemOver(this,_loc3_);
         }
      ...
      private function ProcessorOnMarkTipOut(param1:Event) : void
      {
         ...
         _loc3_ = this.FThanksgivingDay2.SeekTreasureMapBoxList[_loc5_];
      ...
      private function ProcessorOnGetTreasureReward(param1:Event) : void
      {
         ...
         _loc5_ = this.FThanksgivingDay2.MsgTreasure[this.FChangeTabIndex];
         ...
         if(this.FThanksgivingDay2.FreeTreasureMap > 0)
         {
      ...
      protected function ProcessorOnLoadLog(param1:MouseEvent = null) : void
      {
         if(FOnLoadLog != null)
         {
      ...
      {
         var _loc2_:String = null;
         _loc2_ = TUtilityString.Format(this.FThanksgivingDay2.DescListNew[11],this.FThanksgivingDay2.RefreshPrize);
         if(FOnBuyBox != null)
         {
            FOnBuyBox(ACTIVITY_2_ID,TProcessorMayActive.ACTIVITY_2_GOLD_REFRESH,this.FThanksgivingDay2.RefreshPrize,0,TBaseActivity.SWEET_TYPE_GOLD,_loc2_);
         }
      }
      ...
      protected function ProcessorOnGetSeekReward(param1:MouseEvent) : void
      {
         ...
         if(this.FThanksgivingDay2.SeekTreasureCount > 0 && Boolean(this.FThanksgivingDay2.TreasureMapBoxList[_loc2_]))
         {
            if(FOnGetBox != null)
            {
      ...
      private function ProcessorOnShowDesc(param1:MouseEvent) : void
      {
         if(FOnShowDesc != null)
         {
            FOnShowDesc();
      ...
      protected function ProcessorStart(param1:MouseEvent) : void
      {
         ...
         _loc7_ = this.FThanksgivingDay2.MsgTreasure[this.FChangeTabIndex];
         _loc4_ = TUtilityString.Format(this.FThanksgivingDay2.DescListNew[3],_loc7_.NeedScore,_loc5_[12 + this.FChangeTabIndex]);
         if(this.FThanksgivingDay2.TreasureMapCount[this.FChangeTabIndex] < _loc7_.NeedScore)
         {
            return;
         }
         if(FOnBuyBox != null)
      ...
      {
         var _loc2_:String = null;
         _loc2_ = this.FThanksgivingDay2.DescListNew[4];
         if(FOnBuyBox != null)
         {
      ...
      protected function ProcessorOnBuyBox(param1:MouseEvent) : void
      {
         ...
         var _loc3_:TBaseBox = null;
         _loc2_ = int(String(param1.currentTarget.parent.name).slice(11));
         _loc3_ = this.FThanksgivingDay2.BuyTreasureMapBoxList[_loc2_];
         if(FOnBuyBox != null)
         {
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FThanksgivingDay2.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FThanksgivingDay2.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FThanksgivingDay2.DescListNew[0];
         this.FTF_FreeTreasureMap.text = TUtilityString.Format(this.FThanksgivingDay2.DescListNew[1],this.FThanksgivingDay2.FreeTreasureMap);
      }
      
      private function UpdateRefreshTime() : void
      {
         var _loc1_:int = 0;
         _loc1_ = this.FThanksgivingDay2.RefreshBuyTime - STimingCore.GetServerTick();
         this.FTF_WorkCDTime.text = TGameUtil.fomatTime(this.FThanksgivingDay2.RefreshBuyTime - STimingCore.GetServerTick());
         if(_loc1_ > 0)
         {
            this.FBTN_FreeRefresh.visible = false;
      ...
      protected function UpdateBuyTreasure() : void
      {
         ...
         {
            _loc2_ = this.FThanksgivingDay2.BuyTreasureMapBoxList[_loc1_];
      ...
      {
         this.FThanksgivingDay2 = SLogicsCore.ThanksgivingDayDatas.GetActivityByIdentify(ACTIVITY_2_ID) as TThanksgivingDay2;
         this.UpdateWindow();
      }
      ...
      public function UpdateWindow() : void
      {
         ...
         _loc1_ = this.FThanksgivingDay2.SeekTreasureMapBoxList[this.FChangeTabIndex];
         if(this.FThanksgivingDay2.SeekTreasureStatue == TBaseActivity.STATUS_CANGET && this.FThanksgivingDay2.SeekTreasureCount > 0)
         {
            this.UpdateSeekTreasure();
            this.FMC_TreasureMark.visible = false;
         }
      ...
      private function UpdateTreasureMapCount() : void
      {
         ...
         while(_loc1_ < TAB_COUNT)
         {
            ...
            _loc2_.TF_MapCount.text = this.FThanksgivingDay2.TreasureMapCount[_loc1_];
      ...
      private function UpdateOpenTreasure() : void
      {
         ...
         _loc2_ = this.FThanksgivingDay2.MsgTreasure[this.FChangeTabIndex];
         ...
         if(this.FThanksgivingDay2.TreasureMapCount[this.FChangeTabIndex] > 0)
         {
            TGameUtil.setButtonMode(this.FBTN_Start,true);
         }
         else
      ...
      private function UpdateSeekTreasure() : void
      {
         ...
         {
            _loc3_ = this.FThanksgivingDay2.TreasureMapBoxList[_loc1_];
            if(_loc3_ != null && _loc3_.Inventories != null)
            {
         ...
         this.FTF_FreeSeekTreasure.text = TUtilityString.Format(this.FThanksgivingDay2.DescListNew[2],this.FThanksgivingDay2.SeekTreasureCount);
      ...
      private function UpdateSeekMark() : void
      {
         ...
         while(_loc1_ < TAB_COUNT)
         {
            _loc2_ = this.FThanksgivingDay2.SeekTreasureMapBoxList[_loc1_];
      ...
      public function UpdateFreeBox() : void
      {
         var _loc1_:MovieClip = null;
         _loc1_ = FMC_Scene["MC_FreeBox"];
         _loc1_.TF_Count.text = this.FThanksgivingDay2.FreeTimes.toString();
         if(this.FThanksgivingDay2.FreeTimes > 0)
         {
         ...
         switch(this.FCurType)
         {
            ...
            case MOVIE_TYPE_REFRESH:
               ...
               if(this.FRewardStatus == TBaseActivity.STATUS_CANGET)
               {
                  ...
                  this.FThanksgivingDay2.MsgTreasure[this.FMapIndex].TreasureStatus = this.FMapStatus;
               }
               this.FBTN_GiveUp.mouseEnabled = true;
               this.FBTN_Start.mouseEnabled = true;
               this.UpdateUI();
