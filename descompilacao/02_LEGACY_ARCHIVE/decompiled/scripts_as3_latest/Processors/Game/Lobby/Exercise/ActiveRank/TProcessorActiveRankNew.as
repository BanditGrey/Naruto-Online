package Processors.Game.Lobby.Exercise.ActiveRank
{
   ...
   public class TProcessorActiveRankNew extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorActiveRankNew(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_BaseActiveRank3") as MovieClip;
      ...
      {
         if(this.FActiveRankDataNew.CurMyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FActiveRankDataNew.CurMyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FActiveRankDataNew.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         while(_loc1_ < RANK_LEVEL)
         {
            if(_loc1_ < this.FActiveRankDataNew.RankGiftList.length)
            {
               _loc7_ = this.FActiveRankDataNew.RankGiftList[_loc1_];
      ...
      protected function UpdateSpecial() : void
      {
         ...
         while(_loc1_ < RANK_LEVEL)
         {
            if(_loc1_ < this.FActiveRankDataNew.RankSpecialList.length)
            {
               _loc3_ = this.FActiveRankDataNew.RankSpecialList[_loc1_];
               this.FUISpecialVect[_loc1_].UpdateUI(_loc3_);
               _loc5_ = this.FActiveRankDataNew.ScoreCommand[_loc1_].toString();
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FActiveRankDataNew.RankPlayerList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FActiveRankDataNew.RankPlayerList.length)
            {
               _loc8_ = this.FActiveRankDataNew.RankPlayerList[_loc2_];
               if(this.FCurPage == 0)
               {
