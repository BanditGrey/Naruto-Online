package Processors.Game.Lobby.Exercise.JanActive
{
   ...
   public class TUIJanActive1 extends TUIBaseWindow
   {
      ...
      protected var FJanActive1:TJanActive1;
      ...
      public function TUIJanActive1(param1:TUIComponent)
      {
         super(param1);
         this.FIsFirst = true;
         FIsFirstLoad = true;
      ...
      protected function UpdateServerBox() : void
      {
         ...
         _loc3_ = this.FJanActive1.Gift;
         _loc2_.TF_TotalCount.text = this.FJanActive1.ConsumeScore.toString();
         _loc2_.TF_Count.text = _loc3_.Count.toString();
         _loc2_.TF_Price.text = TUtilityString.Format(this.FJanActive1.DescListNew[2],this.FJanActive1.ConsumeScore % _loc3_.Price);
         if(_loc3_.Count > 0)
         {
      ...
      {
         this.FShowItem.UpdateUI(this.FJanActive1.ShowItems);
      }
      ...
      protected function UpdateIce() : void
      {
         ...
         {
            if(this.FJanActive1.IceList[_loc1_] == 0)
            {
            ...
            else
            {
               ...
               FMC_Scene.MC_Ice["MC_Ice" + _loc1_].TF_Num.text = this.FJanActive1.IceList[_loc1_];
            }
            _loc1_++;
         }
      }
      ...
      protected function UpdateTree() : void
      {
         ...
         while(_loc1_ < TREE_COUNT)
         {
            ...
            if(_loc1_ < this.FJanActive1.TreeList.length)
            {
               _loc2_.visible = true;
               _loc3_ = this.FJanActive1.TreeList[_loc1_];
         ...
         if(this.FJanActive1.ScoreB == 0)
         {
            TGameUtil.setButtonMode(FMC_Scene.BTN_Get,false);
            if(this.FJanActive1.FirstPlay == 0)
            {
         ...
         else
         {
            FMC_Scene.BTN_Auto.visible = false;
            FMC_Scene.BTN_Get.visible = true;
            if(this.FJanActive1.ScoreB >= this.FJanActive1.TreeList[0].Min)
            {
               TGameUtil.setButtonMode(FMC_Scene.BTN_Get,true);
            }
            else
      ...
      protected function UpdateText() : void
      {
         ...
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FJanActive1.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FJanActive1.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FJanActive1.DescListNew[1];
         FMC_Scene.TF_IceCount.text = this.FJanActive1.IceIndex - 1 + "/" + this.FJanActive1.MaxCount;
         FMC_Scene.TF_ScoreA.text = this.FJanActive1.ScoreA.toString();
         FMC_Scene.TF_ScoreB.text = this.FJanActive1.ScoreB.toString();
         FMC_Scene.TF_RankPoint.text = this.FJanActive1.RankPoint.toString();
         _loc1_ = Math.min(this.FJanActive1.IceIndex,this.FJanActive1.MaxCount) - 1;
         FMC_Scene.TF_Price.text = TUtilityString.Format(this.FJanActive1.DescListNew[3],this.FJanActive1.PriceList[_loc1_]);
      }
      ...
      override protected function ProcessorOnAcceptTaskUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null && _loc2_ < FActTaskData.TaskList.length && !FIsPlaying)
         {
            ...
            FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_GET_TASK,_loc3_.Identify);
         }
      }
      ...
      override protected function ProcessorOnFinishTaskUp(param1:MouseEvent) : void
      {
         ...
         {
            _loc3_ = FActTaskData.TaskList[_loc2_];
            FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_FINISH_TASK,_loc3_.Identify);
         }
      }
      
      protected function ProcessorOnGiftUp(param1:MouseEvent) : void
      {
         if(Boolean(FOnGetBox != null && !FIsPlaying) && Boolean(this.FJanActive1) && this.FJanActive1.Gift.Count > 0)
         {
            FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_GET_GIFT);
         }
      }
      ...
      protected function ProcessorOnIceUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnBuyBox != null && !FIsPlaying) && Boolean(this.FJanActive1) && this.FJanActive1.IceList[_loc2_] == 0)
         {
            if(this.FJanActive1.IceIndex - 1 < this.FJanActive1.MaxCount)
            {
               _loc5_ = this.FJanActive1.PriceList[this.FJanActive1.IceIndex - 1];
               if(this.FJanActive1.ScoreA >= _loc5_)
               {
                  FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_BREAK_ICE,_loc2_ + 1);
               }
               else
               {
                  _loc3_ = (_loc5_ - this.FJanActive1.ScoreA) * this.FJanActive1.ScorePrice;
                  _loc4_ = TUtilityString.Format(this.FJanActive1.DescListNew[4],_loc5_,_loc3_,_loc5_ - this.FJanActive1.ScoreA);
                  FOnBuyBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_BREAK_ICE,_loc3_,_loc2_ + 1,0,_loc4_);
               }
            }
            else
            {
               FOnShowFlowText(this.FJanActive1.DescListNew[8]);
            }
         }
      }
      ...
      protected function ProcessorOnAutoUp(param1:MouseEvent) : void
      {
         ...
         var _loc4_:int = 0;
         if(FOnBuyBox != null && !FIsPlaying && Boolean(this.FJanActive1))
         {
            _loc4_ = this.FJanActive1.AutoPrice;
            if(this.FJanActive1.ScoreA >= _loc4_)
            {
               FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_AUTO_GAME);
            }
            else
            {
               _loc2_ = (_loc4_ - this.FJanActive1.ScoreA) * this.FJanActive1.ScorePrice;
               _loc3_ = TUtilityString.Format(this.FJanActive1.DescListNew[5],_loc4_,_loc2_,_loc4_ - this.FJanActive1.ScoreA);
               FOnBuyBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_AUTO_GAME,_loc2_,0,0,_loc3_);
            }
         }
      }
      ...
      protected function ProcessorOnGetSoulUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null && !FIsPlaying && Boolean(this.FJanActive1))
         {
            FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_GET_SOUL);
         }
      }
      
      protected function ProcessorOnExchangeItem(param1:int) : void
      {
         if(FOnGetBox != null && Boolean(this.FJanActive1))
         {
            FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_EXCHANGE_ITEM,param1 + 1);
         }
      }
      ...
      protected function ProcessorOnGetReward(param1:int) : void
      {
         if(FOnGetBox != null && Boolean(this.FJanActive1))
         {
            FOnGetBox(ACTIVITY_1_ID,TProcessorJanActive.ACTIVITY_1_GET_REWARD,param1 + 1);
         }
      }
      ...
      protected function ProcessorOnGiftOver(param1:MouseEvent) : void
      {
         if(FOnGetBox != null && Boolean(this.FJanActive1))
         {
            FOnNewBoxOver(this.FJanActive1.Gift.Inventories);
         }
      }
      ...
      protected function ProcessorOnTip0Over(param1:MouseEvent) : void
      {
         ...
         {
            FOnShowHtmlTip(this.FJanActive1.DescListNew[9]);
         }
      }
      ...
      protected function ProcessorOnTip1Over(param1:MouseEvent) : void
      {
         if(FOnShowHtmlTip != null)
         {
            FOnShowHtmlTip(this.FJanActive1.DescListNew[10]);
         }
      }
      ...
      protected function ProcessorOnExchangeUp(param1:MouseEvent) : void
      {
         ...
         this.FProcessorNovActiveShop.UpdateUI(this.FJanActive1);
      }
      ...
      {
         this.FJanActive1 = SLogicsCore.JanActiveDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TJanActive1;
         UpdateTaskView();
      ...
      override public function PlayMovie(param1:int = 0, param2:Boolean = false) : void
      {
         ...
         else if(this.FMovieType == MOVIE_OF_AUTO)
         {
            ...
            {
               if(this.FJanActive1.IceList[_loc3_] != 0)
               {
                  _loc4_ = FMC_Scene.MC_Ice["MC_Ice" + _loc3_].MC_Movie;
                  _loc4_.visible = true;
                  FMC_Scene.MC_Ice["MC_Ice" + _loc3_].MC_Mask.visible = false;
                  FMC_Scene.MC_Ice["MC_Ice" + _loc3_].TF_Num.text = this.FJanActive1.IceList[_loc3_].toString();
                  FTotalFrame = _loc4_.totalFrames;
                  _loc4_.gotoAndPlay(1);
         ...
         else if(this.FMovieType == MOVIE_OF_OPEN)
         {
            ...
            while(_loc3_ < ICE_COUNT)
            {
               if(this.FJanActive1.IceList[_loc3_] == 0)
               {
                  _loc4_ = FMC_Scene.MC_Ice["MC_Ice" + _loc3_].MC_Movie;
                  _loc4_.visible = true;
                  FMC_Scene.MC_Ice["MC_Ice" + _loc3_].TF_Num.text = this.FJanActive1.AllIceList[_loc3_].toString();
                  FTotalFrame = _loc4_.totalFrames;
                  _loc4_.gotoAndPlay(1);
                  this.FOpenIndex = _loc3_;
               }
      ...
      override public function MovieEnd() : void
      {
         ...
         if(this.FMovieType == MOVIE_OF_PLAY_GAME)
         {
            ...
            FMC_Scene.MC_Ice["MC_Ice" + this.FOpenIndex].TF_Num.text = this.FJanActive1.IceList[this.FOpenIndex].toString();
         ...
         {
            this.FJanActive1.ScoreB = 0;
            this.FJanActive1.IceIndex = 1;
            _loc1_ = 0;
            while(_loc1_ < this.FJanActive1.IceList.length)
            {
               this.FJanActive1.IceList[_loc1_] = 0;
               _loc1_++;
            }
            FMC_Scene.MC_Movie3.visible = false;
            this.UpdateUI();
