package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   public class TProcessorWindowActivityInnerJade extends TProcessorWindowWonderfulActivity
   {
      ...
      protected static const KEY_Jade_Lv3:uint = CONST_COUNTER.KEY_Jade_Lv3;
      
      protected static const KEY_Jade_Lv4:uint = CONST_COUNTER.KEY_Jade_Lv4;
      
      protected static const KEY_Jade_Lv5:uint = CONST_COUNTER.KEY_Jade_Lv5;
      
      protected static const KEY_Jade_Lv6:uint = CONST_COUNTER.KEY_Jade_Lv6;
      ...
      public function TProcessorWindowActivityInnerJade(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function LogicsPerform_Signals() : void
      {
         ...
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         _loc1_ = SLogicsCore.SignalRetrieve(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_Jade_Ret);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function UpdateReward() : void
      {
         ...
         while(_loc10_ < ROW_COUNT)
         {
            ...
            _loc4_ = STRING_ACTIVITYINNER.STRING_JADE_LEVEL[_loc10_];
      ...
      {
         this.FCountKey.push(KEY_Jade_Lv3);
         this.FCountKey.push(KEY_Jade_Lv4);
         this.FCountKey.push(KEY_Jade_Lv5);
         this.FCountKey.push(KEY_Jade_Lv6);
         SLogicsCore.SignalPost(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_Jade_Req,0,0,this.FCountKey);
      }
