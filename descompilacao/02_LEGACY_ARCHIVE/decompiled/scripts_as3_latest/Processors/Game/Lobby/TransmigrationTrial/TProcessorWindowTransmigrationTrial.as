package Processors.Game.Lobby.TransmigrationTrial
{
   ...
   public class TProcessorWindowTransmigrationTrial extends TProcessorGame
   {
      ...
      protected var FWindowCampaign:TProcessorWindowTransmigrationTrialCampaign;
      
      protected var FWindowStage:TProcessorWindowTransmigrationTrialStage;
      ...
      public function TProcessorWindowTransmigrationTrial(param1:TUIComponent)
      {
         super(param1);
         this.FUIIndex = 0;
      }
      ...
      protected function OnShowChangeView(param1:Object) : void
      {
      ...
      {
         this.FWindowCampaign = new TProcessorWindowTransmigrationTrialCampaign(this);
         this.FWindowCampaign.SetScene(param1);
         this.FWindowCampaign.Visible = true;
         this.FWindowCampaign.GotoStage = this.OnGotoStage;
         this.FWindowCampaign.ShowChangeView = this.OnShowChangeView;
         this.FWindowStage = new TProcessorWindowTransmigrationTrialStage(this);
         ...
         this.FWindowStage.ShowChangeView = this.OnShowChangeView;
      }
      ...
      {
         this.FWindowCampaign.RoleReset();
      }
   }
}
