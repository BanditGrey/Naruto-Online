package Processors.Game.Lobby.Organization.FightPetCopy
{
   ...
   public class TProcessorFightPetCopy extends TProcessorLobbyPlate
   {
      ...
      protected var FLayerOver:TLayerOverCopy;
      ...
      protected var VecInspire:Vector.<uint>;
      ...
      protected var FPerformPacket_SC_Organization_Animal:Function;
      
      protected var FPerformPacket_SC_Organization_apply:Function;
      
      protected var FReturnMainScene:Function;
      ...
      protected var FPACKETID_SC_AnimalSeall_Open_Ret:Function;
      
      protected var FInspireCount:int = 0;
      ...
      public function TProcessorFightPetCopy(param1:TUIComponent, param2:TLobbyParameters)
      {
         var _loc3_:BitmapData = null;
         var _loc4_:Bitmap = null;
         super(param1,param2);
         this.FBackGround = new TLayerBackGround(this,CONST_MODULES.MODULE_FightPetCopy);
         ...
         this.FCanMove = new TLayerCanMove(this.FBackGround,CONST_MODULES.MODULE_FightPetCopy);
         ...
         this.FLayerOver = new TLayerOverCopy(this);
         ...
         this.FLayerOver.CloseBtnMe = this.CloseBtnMe;
         ...
         SetUIModuleID(CONST_MODULES.MODULE_FightPetCopy);
      }
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         _loc1_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_ConfigValue,CONST_CONFIGVALUE.KillAnimalBossTimeInspirePrice) as TConfigValue;
         this.VecInspire = _loc1_.Value as Vector.<uint>;
      }
      ...
      override protected function PacketRegisterRoutines() : void
      {
         ...
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_SealPanel_Ret,this.SC_Animal);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_Apply_Ret,this.SC_apply);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_BossFire_Ret,this.FightingMonsterRet);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_Inspire_Ret,this.InspireRet);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_Revive_Ret,this.OnIsDie);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_BossState_Ret,this.MonsterInfo);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_PeopleCount_Ret,this.PlayerCount);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_HurtTop_Ret,this.RankRet);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_BuyLife_Ret,this.ResurrectionRet);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_BossKill_Ret,this.GameOver);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_FightPet_RebornNotify,this.RebornNotify);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_Open_Ret7,this.Open_Ret);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_SC_AnimalSeall_RoleCoin_Ret,this.RoleCoin_Ret);
      }
      
      protected function Open_Ret(param1:TPacket) : void
      {
         this.FPACKETID_SC_AnimalSeall_Open_Ret(param1);
      }
      
      public function set PACKETID_SC_AnimalSeall_Open_Ret(param1:Function) : void
      {
         this.FPACKETID_SC_AnimalSeall_Open_Ret = param1;
      }
      ...
      private function GameOver(param1:TPacket) : void
      {
         ...
         if(!TBattleHandle.IsInBattle)
         {
            ...
            if(this.FIsWin)
            {
               ...
               this.FLayerOver.SetFMC_EndRewardVisible(true);
            }
            else
            {
      ...
      private function CloseBtnMe() : void
      {
         this.FReturnMainScene(null);
      }
      ...
      private function MonsterInfo(param1:TPacket) : void
      {
         ...
         this.FFightPetData.MonsterHP = param1.Data.readUnsignedInt();
         if(this.FMonster == null)
         {
            ...
            this.FFightPetData.MonsterName = _loc2_.Name;
      ...
      private function OnIsDie(param1:TPacket) : void
      {
         ...
         var _loc3_:uint = param1.Data.readUnsignedInt();
         if(SLogicsCore.Character.Identifier0 == _loc2_ && SLogicsCore.Character.Identifier1 == _loc3_)
         {
            _loc4_ = this.FConfigValue.GetDatebaseByIdentifier(CONST_CONFIGVALUE.ManDieCd) as TConfigValue;
            this.FTimeCoolDown.TimingTime = _loc4_.Value as uint;
      ...
      private function InspireRet(param1:TPacket) : void
      {
         ...
         ++this.FInspireCount;
         this.FFightPetData.InspireCount = this.FInspireCount;
      ...
      private function InspireEffectGenerateText() : void
      {
         ...
         EffectGenerateText(STRING_ANIMALSEAL.STRING_Inspire + _loc2_);
      }
      ...
      private function FightingMonsterRet(param1:TPacket) : void
      {
         ...
         this.FIsBack = false;
         this.OnSetStatusType(this,CONST_BATTLE.BattleType_OrganizationBoss,0,this.FIsHooked,this.FIsAutoGoldResurgence,this.FIsAutoSkipResurgence);
      ...
      private function CreateMainRole() : void
      {
         ...
         this.FMainRole.ModuleId = CONST_MODULES.MODULE_FightPetCopy;
         ...
         this.FPet.ModuleId = CONST_MODULES.MODULE_FightPetCopy;
      ...
      private function CreateMonster(param1:TFightPet) : void
      {
         ...
         this.FMonster.ModuleId = CONST_MODULES.MODULE_FightPetCopy;
         ...
         _loc4_ = TUtilityString.Format(STRING_ANIMALSEAL.FORMAT_MONSTER_MODLE_NAME,param1.MonsterName);
      ...
      private function enterFightReq() : void
      {
         ...
         _loc1_ = SNetworkCore.PacketAcquire(CONST_NETWORK.PACKETID_CS_AnimalSeall_BossFire_Req);
      ...
      private function OnResurrection() : void
      {
         var _loc1_:TPacket = null;
         var _loc2_:ByteArray = null;
         _loc1_ = SNetworkCore.PacketAcquire(CONST_NETWORK.PACKETID_CS_AnimalSeall_BuyLife_Req);
         SNetworkCore.Transceiver.PacketTransmit(_loc1_);
      }
      ...
      private function OnMoraleUp() : void
      {
         var _loc1_:TPacket = null;
         var _loc2_:ByteArray = null;
         _loc1_ = SNetworkCore.PacketAcquire(CONST_NETWORK.PACKETID_CS_AnimalSeall_Inspire_Req);
         SNetworkCore.Transceiver.PacketTransmit(_loc1_);
      }
      ...
      private function DataInit(param1:ByteArray) : void
      {
         ...
         this.FFightPetData.InspireCount = param1.readUnsignedInt();
         ...
         this.FFightPetData.RoleExpCoinState = param1.readUnsignedInt();
         this.FInspireCount = this.FFightPetData.InspireCount;
         ...
         _loc2_ = this.FConfigValue.GetDatebaseByIdentifier(CONST_CONFIGVALUE.KillAnimalMapId) as TConfigValue;
      ...
      override public function Mount(param1:ByteArray = null) : void
      {
         ...
         SLogicsCore.Character.RoleSencePosition = CONST_COMMON.SCENEPOSITION_FightAnimal;
         if(!FIsResourcesLoadCompleted)
         {
      ...
      protected function RoleCoin_Ret(param1:TPacket) : void
      {
         this.FFightPetData.RoleExpCoinState = param1.Data.readUnsignedInt();
         this.FLayerOver.ReflashRoleState(this.FFightPetData.RoleExpCoinState);
      }
      
      override public function Unmount() : void
      {
         this.FCheckTouchRoleVect.length = 0;
         this.FLayerOver.PcloseMe();
      }
      ...
      public function BattleResult(param1:Boolean) : void
      {
         this.FIsWin = param1;
      }
      ...
      public function BackTownBox() : void
      {
         if(this.FUIWindowInformation == null)
         {
            ...
            this.FUIWindowInformation.Text = STRING_ANIMALSEAL.STRING_BACKTOWN;
      ...
      protected function SC_Animal(param1:TPacket) : void
      {
         this.FPerformPacket_SC_Organization_Animal(param1);
      }
      
      protected function SC_apply(param1:TPacket) : void
      {
         this.FPerformPacket_SC_Organization_apply(param1);
      }
      
      public function set PerformPacket_SC_Organization_Animal(param1:Function) : void
      {
         this.FPerformPacket_SC_Organization_Animal = param1;
      }
      
      public function set PerformPacket_SC_Organization_apply(param1:Function) : void
      {
         this.FPerformPacket_SC_Organization_apply = param1;
      }
      
      public function set ReturnMainScene(param1:Function) : void
      {
         this.FReturnMainScene = param1;
      }
