package Processors.Game.Lobby.Slave
{
   ...
   import Processors.Game.Lobby.Slave.Component.TSlaveDiscipleStatus;
   ...
   public class TProcessorWindowSlave extends TProcessorLobbyWindow
   {
      ...
      protected var FBTN_AddCount:SimpleButton;
      ...
      protected var FMC_DiscipleStatusList:Vector.<TSlaveDiscipleStatus>;
      ...
      protected var FOnRank:Function;
      
      protected var FOnReward:Function;
      
      protected var FOnBuyCount:Function;
      
      protected var FOnHelpTipsOver:Function;
      
      protected var FOnHelpTipsOut:Function;
      
      public function TProcessorWindowSlave(param1:TUIComponent)
      {
         super(param1);
         this.FMC_DiscipleStatusList = new Vector.<TSlaveDiscipleStatus>(this.CAPACITY_DiscipleStatus);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         var _loc1_:int = 0;
         var _loc2_:uint = 0;
         var _loc3_:TSlaveDiscipleStatus = null;
         this.FMC_Mentorship = TUtilityReflection.CreateDisplayObjectInstance(CONST_SLAVE.RESOURCE_ClassName_MC_Slave) as Sprite;
         ...
         this.FBTN_RescueMembers = this.FMC_Mentorship[CONST_SLAVE.RESOURCE_Link_BTN_RescueMembers];
         this.FBTN_Close = this.FMC_Mentorship[CONST_SLAVE.RESOURCE_Link_BTN_Close];
         this.FBTN_Help = this.FMC_Mentorship[CONST_SLAVE.RESOURCE_Link_BTN_Help];
         this.FTF_Explanation = this.FMC_Mentorship[CONST_SLAVE.RESOURCE_Link_TF_Explanation];
         this.FBTN_AddCount = this.FMC_Freedom["btn_addCount"];
         _loc2_ = this.CAPACITY_DiscipleStatus;
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            _loc3_ = new TSlaveDiscipleStatus(this);
            _loc3_.Resource = this.FMC_Mentorship[CONST_SLAVE.RESOURCE_Link_MC_DiscipleStatuses + _loc1_];
            ...
            _loc3_.OnReward = this.ProcessorOnReward;
            _loc3_.Init();
            this.FMC_DiscipleStatusList[_loc1_] = _loc3_;
            _loc1_++;
         }
         this.FScrollBar = new TScrollBar(this.FMC_Mentorship["mc_list"],258);
         this.FMC_DiscipleStatus = this.FMC_Mentorship[CONST_SLAVE.RESOURCE_Link_MC_DiscipleStatus];
         this.FSlaveInfo = new TSlaveInfo(this);
         this.FSlaveInfo.Resource = this.FMC_DiscipleStatus[CONST_SLAVE.RESOURCE_Link_MC_Hero];
         this.FSlaveInfo.Init();
         this.FMC_InteractionCDTime = this.FMC_DiscipleStatus[CONST_SLAVE.RESOURCE_Link_MC_InteractionCDTime];
         this.FTF_InteractionCDTime = this.FMC_InteractionCDTime[CONST_SLAVE.RESOURCE_Link_TF_InteractionCDTime];
         this.FMC_WorkCDTime = this.FMC_DiscipleStatus["MC_WorkCDTime"];
         this.FTF_WorkCDTime = this.FMC_WorkCDTime["TF_WorkCDTime"];
         this.FBTN_Interaction = this.FMC_DiscipleStatus[CONST_SLAVE.RESOURCE_Link_BTN_Interaction];
         this.FBTN_Redeem = this.FMC_DiscipleStatus[CONST_SLAVE.RESOURCE_Link_BTN_Redeem];
         this.FBTN_SOS = this.FMC_DiscipleStatus[CONST_SLAVE.RESOURCE_Link_BTN_SOS];
         this.FBTN_Resist = this.FMC_DiscipleStatus[CONST_SLAVE.RESOURCE_Link_BTN_Resist];
         this.FBTN_Rank = this.FMC_Mentorship[CONST_SLAVE.RESOURCE_Link_BTN_Rank];
         ...
         this.FBTNList.push(this.FBTN_Rank);
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         this.FBTN_Rank.addEventListener(MouseEvent.CLICK,this.BTNRankOnClick,false,0,true);
         ...
         this.FBTN_AddCount.addEventListener(MouseEvent.CLICK,this.BTNAddCountOnClick,false,0,true);
      ...
      {
         this.FSlaveInfo.Update(this.FMentorship);
      ...
      protected function UpdateDiscipleStatus() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            ...
            if(_loc6_ > _loc1_)
            {
               ...
               _loc3_.Update(_loc4_,_loc5_ == CONST_SLAVE.IDENTITY_Master && _loc4_ != null);
            }
            else
            {
      ...
      protected function ShowStatusInfo(param1:Boolean) : void
      {
         var _loc2_:int = 0;
         var _loc3_:uint = 0;
         var _loc4_:TSlaveDiscipleStatus = null;
      ...
      protected function UpdateExplanation() : void
      {
         switch(this.FMentorship.Identity)
         {
            case CONST_SLAVE.IDENTITY_Freedom:
               this.FTF_Explanation.text = TUtilityString.GetText(CONST_SYSTEMLANGUAGE.STRING_Freedom);
               break;
            case CONST_SLAVE.IDENTITY_Master:
               this.FTF_Explanation.text = TUtilityString.GetText(CONST_SYSTEMLANGUAGE.STRING_Master);
               break;
            case CONST_SLAVE.IDENTITY_Disciple:
               this.FTF_Explanation.text = TUtilityString.GetText(CONST_SYSTEMLANGUAGE.STRING_Disciple);
         }
      }
      ...
      protected function BTNRescueMembersOnClick(param1:MouseEvent) : void
      {
         ...
         {
            this.FOnRescueMembers(this,CONST_SLAVE.TYPE_Rescue);
         }
      }
      ...
      {
         this.FConfigValue = this.FConfigValueBins.GetDatebaseByIdentifier(CONST_CONFIGVALUE.Slave_RansomCost) as TConfigValue;
         this.FCommandType = CONST_SLAVE.COMMAND_Redeem;
      ...
      protected function BTNSOSOnClick(param1:MouseEvent) : void
      {
         if(this.FOnRescueMembers != null)
         {
            this.FOnRescueMembers(this,CONST_SLAVE.TYPE_SOS);
         }
      }
      ...
      protected function BTNResistOnClick(param1:MouseEvent) : void
      {
         ...
         {
            this.FOnResist(this,CONST_SLAVE.COMMAND_Resist,0,this.FMentorship.MasterID0,this.FMentorship.MasterID1);
         }
      }
      
      protected function BTNRankOnClick(param1:MouseEvent) : void
      {
         if(this.FOnRank != null)
         {
            this.FOnRank();
         }
      }
      
      protected function BTNAddCountOnClick(param1:MouseEvent) : void
      {
         var _loc2_:int = 0;
         if(this.FMentorship == null)
         {
         ...
         this.FConfigValue = this.FConfigValueBins.GetDatebaseByIdentifier(CONST_CONFIGVALUE.Slave_ArrestCost) as TConfigValue;
         _loc2_ = Math.min(this.FMentorship.TodayBuyCount,this.FConfigValue.Value.length - 1);
         this.FUIWindowConfirmation.Visible = true;
         this.FUIWindowConfirmation.OnOK = this.WindowInformationOnConfirm;
         this.FUIWindowConfirmation.Text = TUtilityString.Format(new ConsumeFrame(CONST_SYSTEMLANGUAGE.STRING_Slave).DescribeString,this.FConfigValue.Value[_loc2_]);
      }
      ...
      protected function ProcessorOnInteraction(param1:Object, param2:TSlaveDisciple) : void
      {
         if(this.FOnInteraction != null)
         {
      ...
      protected function ProcessorOnDrawExp(param1:Object, param2:uint, param3:uint, param4:TSlaveDisciple) : void
      {
      ...
      protected function ProcessorOnReward(param1:TSlaveDisciple) : void
      {
         if(this.FOnReward != null)
         {
            this.FOnReward(param1);
         }
      }
      
      protected function WindowInformationOnConfirm(param1:Object) : void
      {
         if(this.FOnBuyCount != null)
         {
            this.FOnBuyCount();
         }
      }
      ...
      protected function ButtonHelpOnOver(param1:MouseEvent) : void
      {
         ...
         {
            _loc2_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_SystemLanguage,CONST_SYSTEMLANGUAGE.HELPTIPS_Slave) as TSystemLanguage;
      ...
      public function get OnRank() : Function
      {
         return this.FOnRank;
      }
      
      public function set OnRank(param1:Function) : void
      {
         this.FOnRank = param1;
      }
      
      public function get OnReward() : Function
      {
         return this.FOnReward;
      }
      
      public function set OnReward(param1:Function) : void
      {
         this.FOnReward = param1;
      }
      
      public function get OnBuyCount() : Function
      {
         return this.FOnBuyCount;
      }
      
      public function set OnBuyCount(param1:Function) : void
      {
         this.FOnBuyCount = param1;
      }
      ...
      public function UpdateUI(param1:TSlave) : void
      {
         if(!this.FInitialized)
         {
            return;
