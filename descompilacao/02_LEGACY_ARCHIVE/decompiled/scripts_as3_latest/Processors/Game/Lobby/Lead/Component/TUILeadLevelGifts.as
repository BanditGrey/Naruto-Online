package Processors.Game.Lobby.Lead.Component
{
   ...
   public class TUILeadLevelGifts extends TUIComponent
   {
      ...
      protected var FLevelGifts:TLeadLevelGiftsVO;
      ...
      public function TUILeadLevelGifts(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("box_LeadLevelGifts") as MovieClip;
      ...
      public function SetDate(param1:TLeadLevelGiftsVO) : void
      {
         ...
         if(this.FLevelGifts)
         {
            ...
            this.FMC_Scene["TF_Level"].text = this.FLevelGifts.LeadLevelGifts.Level;
      ...
      public function get LevelGifts() : TLeadLevelGiftsVO
      {
