package Processors.Game.Lobby.Smithy
{
   ...
   public class SmithyWindowMakeEquip extends TProcessorLobbyWindow
   {
      ...
      protected var FNeedMaterialPriceList:Vector.<uint>;
      ...
      public function SmithyWindowMakeEquip(param1:TUIComponent)
      {
         super(param1);
         ...
         this.FNeedMaterialPriceList = new Vector.<uint>();
      ...
      override protected function LogicsPerform() : void
      {
         ...
         if(this.FInitialization && Visible)
         {
            ...
            {
               if(this.FMakeEquipNetwork != null)
               {
                  this.FMakeEquipNetwork(this,this.FMC_EquipBoxSlot.Context);
               }
      ...
      protected function MakeEquipList(param1:uint = 0, param2:uint = 0, param3:Boolean = false) : void
      {
         ...
         while(_loc4_ < _loc5_)
         {
            ...
            if(_loc7_.IsEpic <= 0)
            {
               ...
               if(_loc7_.Identifier % 10 == _loc8_)
               {
                  ...
                  _loc18_.length = 0;
                  if(SLogicsCore.Character.GetMainHeroLogicLevel(_loc6_.Level) >= _loc7_.OpenLevel)
                  {
                     _loc15_ = 0;
                     _loc21_ = 0;
         ...
         if(_loc5_ < CONST_EQUIPMAKE.CAPACITY_MC_SingleEquip)
         {
            ...
            while(_loc24_ < _loc5_)
            {
               ...
               this.FEquipSlot.SetFMC_NewTipVisibel(false);
               this.FEquipSlotList.AddDisplay(this.FEquipSlot,this.FScrollBar);
               _loc24_++;
            }
         }
      ...
      protected function MakeComboBox(param1:Vector.<String>, param2:Vector.<DisplayObject>, param3:DisplayObject, param4:TComboBox, param5:String, param6:Function) : void
      {
         ...
         param4 = new TComboBox(this,this.FFatherUI[param5],param2,ComboBox_Height,param6);
      }
      ...
      protected function InitialRight() : void
      {
         ...
         TGameUtil.setButtonMode(this.FBtn_AdvMake,false);
      }
      ...
      protected function BtnAdvMakeHandler(param1:MouseEvent) : void
      {
         if(Boolean(param1.currentTarget) && !param1.currentTarget.buttonMode)
         {
            return;
      ...
      protected function GetNeedCost() : String
      {
         ...
         {
            _loc1_ = TUtilityString.Format(STRING_SMITHY.STRING_MakeEquip_SureFilledMakeCopyagine,this.FNeedCost - _loc4_,this.FNeedCost,this.FMakeEquipName ? this.FMakeEquipName : "");
         }
         else
         {
            _loc1_ = TUtilityString.Format(STRING_SMITHY.STRING_MakeEquip_SureFilledMakeCopy,SLogicsCore.KaguyaData.CurLevel,STRING_SMITHY.GetDiscountValue(_loc3_),_loc4_,this.FNeedCost - _loc4_,_loc4_,this.FMakeEquipName ? this.FMakeEquipName : "");
         }
         return _loc1_;
      }
      ...
      protected function SingleEquipOnClick(param1:Object, param2:Object) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            _loc21_ = 0;
            while(_loc21_ < _loc10_.Count)
            {
               _loc9_ = _loc10_.GetInventoryByIndex(_loc21_) as TAppliance;
            ...
            _loc19_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_Article,_loc8_.Materials[_loc4_]) as TArticle;
            this.FNeedMaterialPriceList[_loc4_] = _loc19_.GoldNumberA;
            _loc4_++;
         }
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            {
               this.FNeedCost += (this.FNeedMaterialNumList[_loc4_] - this.FOwnMaterialNumList[_loc4_]) * this.FNeedMaterialPriceList[_loc4_];
               _loc15_.textColor = CONST_COMMON.TEXT_White_Color;
            }
            _loc15_.visible = true;
            _loc4_++;
         }
         this.FMakeEquipName = _loc7_.Name;
      ...
      public function set MakeEquipNetwork(param1:Function) : void
      {
         this.FMakeEquipNetwork = param1;
      }
      ...
      public function Perform_UIDispatch(param1:MovieClip) : void
      {
         ...
         addChild(param1);
         this.FBtn_Help = param1[CONST_EQUIPMAKE.RESOURCE_Link_Btn_Help];
         this.FBtn_Close = param1[CONST_EQUIPMAKE.RESOURCE_Link_Btn_Close];
         this.FMaterialFilterButton = param1[CONST_EQUIPMAKE.RESOURCE_Link_MaterialFilterButton];
         if(this.FMaterialFilterButton != null)
         {
         ...
         this.FBtn_Make = param1[CONST_EQUIPMAKE.RESOURCE_Link_Btn_Make];
         TGameUtil.setButtonMode(this.FBtn_Make,false);
         this.FBtn_AdvMake = param1[CONST_EQUIPMAKE.RESOURCE_Link_Btn_AdvMake];
         TGameUtil.setButtonMode(this.FBtn_AdvMake,false);
         if(SLogicsCore.Character.VipData.BuyEquipMaterial)
         {
            this.FBtn_AdvMake.visible = true;
         }
         else
         {
            this.FBtn_AdvMake.visible = false;
         }
         this.FTF_ConsumeMoney = param1[CONST_EQUIPMAKE.RESOURCE_Link_TF_ConsumeMoney];
         this.FTF_ConsumeMoney.visible = false;
         this.FMC_EquipBox = param1[CONST_EQUIPMAKE.RESOURCE_Link_MC_EquipBox];
         ...
         this.FMC_EarList[0] = param1[CONST_EQUIPMAKE.RESOURCE_Link_MC_Ear + 0];
         this.FMC_EarList[1] = param1[CONST_EQUIPMAKE.RESOURCE_Link_MC_Ear + 1];
         this.FLeftGroup = param1[CONST_EQUIPMAKE.RESOURCES_MCName_LeftLabelGroup];
         _loc3_ = int(CAPACITY_MC_Tabs);
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            _loc4_ = this.FLeftGroup[CONST_EQUIPMAKE.RESOURCES_MCName_MC_Tab_ + _loc2_];
            _loc5_ = _loc4_[CONST_EQUIPMAKE.RESOURCES_MCName_MC_Tab_Icon];
         ...
         this.FUITab.Init();
         this.FMC_List = param1[CONST_EQUIPMAKE.RESOURCE_Link_Mc_List];
         ...
         _loc3_ = int(CONST_EQUIPMAKE.CAPACITY_MC_MaterialSlot);
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            _loc6_ = new TUISlot(this);
            _loc6_.Resource = param1[CONST_EQUIPMAKE.RESOURCE_Link_MaterialBox][CONST_EQUIPMAKE.RESOURCE_Link_Material_Slot + _loc2_] as Sprite;
            ...
            _loc6_.OnQuerySequenceContext = this.OnQuerySequenceContext;
            _loc6_.OnQuerySubscript = this.SlotsOnQuerySubscript;
            _loc6_.OnOverlay = this.SlotsOnMove;
            _loc6_.OnOut = this.SlotsOnOut;
            _loc6_.Init();
            this.FMaterialSlotList[_loc2_] = _loc6_;
            this.FMateriaNumTextFieldList[_loc2_] = param1[CONST_EQUIPMAKE.RESOURCE_Link_MaterialBox][CONST_EQUIPMAKE.RESOURCE_Link_Material_Slot + _loc2_][CONST_EQUIPMAKE.RESOURCE_Link_TF_NeedNum] as TextField;
            this.FMateriaNumTextFieldList[_loc2_].visible = false;
            _loc2_++;
         }
      }
      ...
      public function Perform_UILocation() : void
      {
         ...
         this.FBtn_AdvMake.addEventListener(MouseEvent.CLICK,this.BtnAdvMakeHandler,false,0,true);
      }
