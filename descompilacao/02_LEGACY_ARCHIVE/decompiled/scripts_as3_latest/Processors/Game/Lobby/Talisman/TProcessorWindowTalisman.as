package Processors.Game.Lobby.Talisman
{
   ...
   public class TProcessorWindowTalisman extends TProcessorLobbyWindow
   {
      ...
      protected var FTalismanEquip:TTalismanEquip;
      
      protected var FTalismanUpgrade:TTalismanUpgrade;
      
      protected var FTalismanTransition:TTalismanTransition;
      
      protected var FTalismanLevelUp:TTalismanLevelUp;
      
      protected var FTalismanResolve:TTalismanResolve;
      ...
      protected var FLevelUpBin:TBins;
      ...
      protected var FTransitionOnClick:Function;
      ...
      public function TProcessorWindowTalisman(param1:TUIComponent)
      {
         super(param1);
         ...
         this.FMC_UIList = [];
         this.FTalismanEquip = new TTalismanEquip(this);
         if(this.OnGoToKillHeros != null)
         {
            this.FTalismanEquip.OnGoToKillHeros = this.OnGoToKillHeros;
         }
         this.FMC_UIList.push(this.FTalismanEquip);
         this.FTalismanUpgrade = new TTalismanUpgrade(this);
         this.FTalismanUpgrade.GoToLostPanelFunction = this.GoToLostPanelClick;
         this.FMC_UIList.push(this.FTalismanUpgrade);
         this.FTalismanTransition = new TTalismanTransition(this);
         this.FMC_UIList.push(this.FTalismanTransition);
         this.FTalismanLevelUp = new TTalismanLevelUp(this);
         this.FMC_UIList.push(this.FTalismanLevelUp);
         this.FTalismanResolve = new TTalismanResolve(this);
         this.FMC_UIList.push(this.FTalismanResolve);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         _loc3_ = TUtilityReflection.CreateDisplayObjectInstance(CONST_TALISMAN.RESOURCE_ClassName_MC_Talisman) as MovieClip;
         addChild(_loc3_);
         this.FBtn_Close = _loc3_[CONST_TALISMAN.RESOURCE_Link_Btn_Close];
         this.FBtn_Help = _loc3_[CONST_TALISMAN.RESOURCE_Link_Btn_Help];
         this.FMC_Goto_EquipShenQi = _loc3_["MC_Goto_EquipShenQi"];
         ...
         _loc2_ = int(CONST_TALISMAN.CAPACITY_MC_Tabs);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            _loc4_ = _loc3_[CONST_TALISMAN.RESOURCE_Link_MC_Tabs + _loc1_];
         ...
         _loc2_ = int(CONST_TALISMAN.RESOURCE_Link_MC_Tab_Vector.length);
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            _loc4_ = _loc3_[CONST_TALISMAN.RESOURCE_Link_MC_Tab_Vector[_loc1_]];
            this.FMCTab.SetTabByIndex(_loc4_,_loc1_);
            _loc1_++;
         }
         this.FMCTab.OnSwitch = this.ItemTabOnSwitch;
         this.FMCTab.Init();
         this.FMCTab.SetTabEnabledByIndex(INDEX_MC_Tab_Resolve,false);
         this.FMCTab.OnOver = this.UITabOnOver;
         this.FMCTab.OnOut = this.UITabOnOut;
         this.FUpgradeBin = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_TreasureUpgrade);
         this.FLevelUpBin = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_TreasureLevelup);
         this.FTalismanEquip.SlotOnClick = this.FEquipOnOffOnClick;
         this.FTalismanEquip.OnInventoryOver = this.FUIComponentsHintOnOver;
         this.FTalismanEquip.OnInventoryOut = this.FUIComponentsHintOnOut;
         this.FTalismanEquip.OnEffectText = OnEffectText;
         this.FTalismanUpgrade.Bin = this.FUpgradeBin;
         this.FTalismanUpgrade.UpgradeOnclick = this.FUpgradeOnClick;
         this.FTalismanUpgrade.OnInventoryOver = this.FUIComponentsHintOnOver;
         this.FTalismanUpgrade.OnInventoryOut = this.FUIComponentsHintOnOut;
         this.FTalismanUpgrade.OnEffectText = OnEffectText;
         this.FTalismanUpgrade.OnTipsOver = this.FOnTipsOver;
         this.FTalismanUpgrade.OnTipsOut = this.FOnTipsOut;
         this.FTalismanTransition.TransitionOnClick = this.FTransitionOnClick;
         this.FTalismanTransition.OnInventoryOver = this.FUIComponentsHintOnOver;
         this.FTalismanTransition.OnInventoryOut = this.FUIComponentsHintOnOut;
         this.FTalismanTransition.OnEffectText = OnEffectText;
         this.FTalismanLevelUp.Bin = this.FLevelUpBin;
         this.FTalismanLevelUp.LevelUpOnClick = this.FLevelUpOnClick;
         this.FTalismanLevelUp.OnInventoryOver = this.FUIComponentsHintOnOver;
         this.FTalismanLevelUp.OnInventoryOut = this.FUIComponentsHintOnOut;
         this.FTalismanLevelUp.OnEffectText = OnEffectText;
         this.FTalismanResolve.OnInventoryOver = this.FUIComponentsHintOnOver;
         this.FTalismanResolve.OnInventoryOut = this.FUIComponentsHintOnOut;
         this.FTalismanResolve.OnEffectText = OnEffectText;
         _loc9_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_ConfigValue,CONST_CONFIGVALUE.TALISMAN_ResolveLevel) as TConfigValue;
         this.FResolveLevel = _loc9_.Value as uint;
      ...
      protected function UITabOnOver(param1:Object, param2:uint, param3:Boolean) : void
      {
         ...
         if(!param3 && param2 == INDEX_MC_Tab_Resolve)
         {
            ...
            this.FHint.Content = TUtilityString.Format(STRING_TALISMAN.STRING_ResolveLimit,this.FResolveLevel);
      ...
      protected function ItemTabOnSwitch(param1:Object) : void
      {
         ...
         this.FTalismanUpgrade.ResetCopy();
         this.UpdateUI(this.FItemIndex);
         this.FTalismanEquip.SetZearo();
         this.UpdateRole(this.FRoleIndex,this.FItemIndex);
      }
      ...
      override public function set Visible(param1:Boolean) : void
      {
         ...
         {
            this.FMCTab.GetTabByIndex(INDEX_MC_Tab_Resolve).gotoAndStop(TUITab.RENDERINGSTATE_UnSelect);
         }
      }
      ...
      protected function UpdateRoleTab() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            if(this.FItemIndex == INDEX_MC_Tab_Resolve)
            {
               if(_loc1_ == 0)
               {
                  this.FUITab.SetTabCaptionByIndex(STRING_COMMON.STRING_Backage,0,16775109);
               }
               else
               {
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         this.FMC_Goto_EquipShenQi.addEventListener(MouseEvent.CLICK,this.Goto_EquipShenQiClick);
         super.ResourcesPerform_UILocations();
      }
      
      protected function Goto_EquipShenQiClick(param1:MouseEvent) : void
      {
         if(this.FGoToLostPanelFunction != null)
         {
            this.FGoToLostPanelFunction();
      ...
      protected function ButtonHelpOnOver(param1:MouseEvent) : void
      {
         ...
         if(this.FOnHelpTipsOver != null)
         {
            _loc2_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_SystemLanguage,CONST_SYSTEMLANGUAGE.HELPTIPS_Treasure) as TSystemLanguage;
      ...
      {
         return this.FTransitionOnClick;
      }
      
      public function set TransitionOnClick(param1:Function) : void
      {
         this.FTransitionOnClick = param1;
      }
      ...
      {
         super.Load();
         this.FTalismanEquip.Load();
         this.FTalismanUpgrade.Load();
         this.FTalismanTransition.Load();
         this.FTalismanLevelUp.Load();
         this.FTalismanResolve.Load();
      }
      ...
      public function NiMeiA() : void
      {
         ...
         this.FPageIndexHeroList = this.FCharacter.PageIndex;
         this.FRoleIndex += this.FPageIndexHeroList * TAB_NUM;
         if(SLogicsCore.Character.MainHero.Level >= SLogicsCore.LostShenQiLogicData.ShenQiOpenLevel)
         {
            if(this.FMC_Goto_EquipShenQi)
            {
               this.FMC_Goto_EquipShenQi.visible = true;
            }
         }
         else if(this.FMC_Goto_EquipShenQi)
         {
            this.FMC_Goto_EquipShenQi.visible = false;
         }
         this.FTalismanEquip.NimeiA();
      }
      ...
      {
         this.FTalismanEquip.UpdateEquipSlots();
      }
      
      public function UpdateCharacterBaseAttribute() : void
      {
         this.FTalismanEquip.UpdateCharacterBaseAttributes();
      }
      
      public function UpdateUpgradeEquip() : void
      {
         this.FTalismanUpgrade.UpdateUpgradeEquip();
      }
