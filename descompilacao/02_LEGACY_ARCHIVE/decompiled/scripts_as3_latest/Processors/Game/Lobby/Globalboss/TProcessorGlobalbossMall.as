package Processors.Game.Lobby.Globalboss
{
   ...
   public class TProcessorGlobalbossMall extends TProcessorWindowTemplate
   {
      ...
      public function TProcessorGlobalbossMall(param1:TUIComponent)
      {
         super(param1);
         this.Init();
      }
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         FMainUI = TUtilityReflection.CreateDisplayObjectInstance("globalBossMall") as Sprite;
         UIDispatch();
