package Processors.Game.Lobby.Recruit.Component
{
   ...
   public class TUIRecruitLevelGifts extends TUIComponent
   {
      ...
      protected var FLevelGifts:TRecruitLevelGifts;
      ...
      public function TUIRecruitLevelGifts(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("box_recruitLevelGifts") as MovieClip;
      ...
      public function SetDate(param1:TRecruitLevelGifts) : void
      {
         ...
         if(this.FLevelGifts)
         {
            ...
            this.FMC_Scene["TF_Level"].text = this.FLevelGifts.DrawNinjaConfig.ActivationNum;
            _loc2_ = this.FLevelGifts.DrawNinjaConfig.AddAttributeVector[0];
            this.FMC_Scene["TF_Attribute"].text = this.AttributeFormat(_loc2_[0],_loc2_[1]);
      ...
      public function get LevelGifts() : TRecruitLevelGifts
      {
