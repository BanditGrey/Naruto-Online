package Resources.Strings
{
   ...
   public class STRING_QUEST
   {
      ...
      public static var FColorType:Array = ["","(Verde)","(Azul)","(Naranja)","(Amarillo)"];
      
      public static var FQuestTypeName:Vector.<String> = Vector.<String>(["","[Principal]","[Extensión]","[Desafío]","[Prueba]"]);
      
      public static const RewardName:Vector.<String> = Vector.<String>(["Plata","Oro","Cupón"]);
      
      public static var FQuestNameStateComplete_formatString:String = "<font color=\'#ff00\' SIZE=\'12\'><u><a href=\'event:%0\'>%1(Terminado)</a></u></font>\n";
      
      public static var FQuestNameStateUncompleteLoseLevel_formatString:String = "<font color=\'#ffffff\' SIZE=\'12\'>%0</font><font color=\'#ff0000\' SIZE=\'12\'>(Nvl.%1 recibir)</font>\n";
      
      public static var FQuestInforCanAcceptTask_formatString:String = "    <font color=\'#ffffff\' SIZE=\'12\'>Misión Publicada por:</font><font color=\'#99ff\' SIZE=\'12\'><u><a href=\'event:%0\'>%1</a></u></font>";
      
      protected static const STRING_CITY_NEWROLE:String = "(Aldea de Novato)";
      
      protected static const STRING_CITY_MUYE:String = "(Konoha)";
      ...
      public static function GetTaskInfor(param1:TQuest) : String
      {
         ...
         if(param1.TaskState == CONST_QUEST.STATE_ACCEPT)
         {
            ...
            {
               _loc3_ = STRING_CITY_NEWROLE;
            }
            else
            {
               _loc3_ = STRING_CITY_MUYE;
            }
