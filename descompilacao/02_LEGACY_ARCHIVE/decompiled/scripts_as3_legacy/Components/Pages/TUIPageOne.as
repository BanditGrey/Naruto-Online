package Components.Pages
{
   ...
   public class TUIPageOne extends TUIComponent
   {
      ...
      public function TUIPageOne(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FTotalPage = this.FTotalQuantity;
      }
      ...
      {
         if(this.FPageIndex + this.FPageSize < this.FTotalPage)
         {
            ++this.FPageIndex;
            this.UpdateLabelPage();
         }
         if(this.FPageIndex == this.FTotalPage - this.FPageSize)
         {
      ...
      public function set PageIndex(param1:int) : void
      {
         ...
         if(param1 >= this.FTotalPage - this.FPageSize)
         {
            if(this.FButtonNext.IsEnabled)
            {
               this.FButtonNext.SetButtonEnabled(false);
