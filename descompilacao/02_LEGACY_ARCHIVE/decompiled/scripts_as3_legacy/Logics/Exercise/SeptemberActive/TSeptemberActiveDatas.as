package Logics.Exercise.SeptemberActive
{
   ...
   public class TSeptemberActiveDatas
   {
      ...
      public function TSeptemberActiveDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TSeptemberActive1,TSeptemberActive2,TSeptemberActive3,TSeptemberActive4]);
         super();
      ...
      public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSeptemberActive1 = null;
         _loc3_ = this.FActivities[0] as TSeptemberActive1;
         _loc1_ = 0;
         while(_loc1_ < _loc3_.GiftList.length)
         {
            if(_loc3_.GiftList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
      ...
      public function ChangeStatus2() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSeptemberActive2 = null;
         _loc3_ = this.FActivities[1] as TSeptemberActive2;
         _loc1_ = 0;
         while(_loc1_ < _loc3_.FruitStatus.length)
         {
            if(_loc3_.FruitStatus[_loc1_] == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
         }
         if(_loc3_.WaterCount > 0)
         {
            return TBaseActivity.STATUS_CANGET;
         }
         return TBaseActivity.STATUS_CANNOTGET;
      ...
      public function ChangeStatus3() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSeptemberActive3 = null;
         var _loc4_:TActivityTaskData = null;
         _loc4_ = SLogicsCore.ActivityTaskData;
         _loc3_ = this.FActivities[2] as TSeptemberActive3;
         _loc1_ = 0;
         while(_loc1_ < _loc3_.ServerBoxList.length)
         {
            if(_loc3_.ServerBoxList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
      ...
      public function ChangeStatus4() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TSeptemberActive4 = null;
         _loc3_ = this.FActivities[3] as TSeptemberActive4;
         if(_loc3_.FreeCount > 0)
         {
            return TBaseActivity.STATUS_CANGET;
         }
         return TBaseActivity.STATUS_CANNOTGET;
