package Logics.Exercise.ThanksgivingDay
{
   ...
   public class TThanksgivingDayDatas
   {
      ...
      public function TThanksgivingDayDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TThanksgivingDay1,TThanksgivingDay2,TThanksgivingDay3,TThanksgivingDay4]);
         super();
      ...
      public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TThanksgivingDay1 = null;
         _loc3_ = this.FActivities[0] as TThanksgivingDay1;
      ...
      public function ChangeStatus3() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TThanksgivingDay3 = null;
         var _loc4_:TActivityTaskData = null;
         _loc4_ = SLogicsCore.ActivityTaskData;
         _loc3_ = this.FActivities[2] as TThanksgivingDay3;
         if(Boolean(_loc3_.BigBox) && _loc3_.BigBox.Status == TBaseActivity.STATUS_CANGET)
         {
            return TBaseActivity.STATUS_CANGET;
         }
