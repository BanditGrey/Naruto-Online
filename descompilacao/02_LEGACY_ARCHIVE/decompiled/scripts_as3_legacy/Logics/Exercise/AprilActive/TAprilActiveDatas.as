package Logics.Exercise.AprilActive
{
   ...
   public class TAprilActiveDatas extends TBaseActiveDatas
   {
      ...
      public function TAprilActiveDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TAprilActive1,TAprilActive2]);
      ...
      override public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TAprilActive1 = null;
         var _loc4_:TActivityTaskData = null;
         var _loc5_:TDessertHouseTask = null;
         var _loc6_:int = 0;
         _loc3_ = FActivities[0] as TAprilActive1;
         ...
         _loc1_ = 0;
         while(_loc1_ < _loc3_.DailyGift.length)
         {
            if(_loc3_.DailyGift[_loc1_].Count > 0)
            {
               return TBaseActivity.STATUS_CANGET;
            }
            _loc1_++;
      ...
      override public function ChangeStatus2() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TAprilActive2 = null;
         _loc3_ = FActivities[1] as TAprilActive2;
         return TBaseActivity.STATUS_CANNOTGET;
      }
   }
}
