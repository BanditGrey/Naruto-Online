package Logics.Exercise.HallowmasActive
{
   ...
   public class THallowmasActiveDatas
   {
      ...
      public function THallowmasActiveDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([THallowmasActive1,THallowmasActive2,THallowmasActive3,THallowmasActive4]);
         super();
      ...
      public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:THallowmasActive1 = null;
         _loc3_ = this.FActivities[0] as THallowmasActive1;
      ...
      public function ChangeStatus2() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:THallowmasActive2 = null;
         _loc3_ = this.FActivities[1] as THallowmasActive2;
         _loc1_ = 0;
      ...
      public function ChangeStatus3() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:THallowmasActive3 = null;
         var _loc4_:TActivityTaskData = null;
         _loc3_ = this.FActivities[2] as THallowmasActive3;
      ...
      public function ChangeStatus4() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:THallowmasActive4 = null;
         _loc3_ = this.FActivities[3] as THallowmasActive4;
