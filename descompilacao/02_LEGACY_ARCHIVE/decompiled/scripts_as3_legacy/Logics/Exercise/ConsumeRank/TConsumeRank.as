package Logics.Exercise.ConsumeRank
{
   ...
   public class TConsumeRank extends TBaseActivity
   {
      ...
      public var PerRank2:int;
      
      public var PerScore2:int;
      
      public var DiffScore2:int;
      
      public var CurReturn2:int;
      
      public var DiffGold2:int;
      
      public var NextReturn2:int;
      
      protected var FRankInfoList:Vector.<TConsumeRankInfo>;
      
      public var RankInfoList2:Vector.<TConsumeRankInfo>;
      
      protected var FRankRewardList:Vector.<TConsumeRankReward>;
      
      public var RankRewardList2:Vector.<TConsumeRankReward>;
      
      protected var FPerRewardList:Vector.<TPerReward>;
      
      public var GoldShowItems:TInventories;
      
      public var GoldEquipments:TInventories;
      
      public var GiftShowItems:TInventories;
      
      public var GiftEquipments:TInventories;
      
      protected var FChangeTabIndex:int;
      
      public function TConsumeRank()
      {
         super();
         this.FRankInfoList = new Vector.<TConsumeRankInfo>();
         this.FRankRewardList = new Vector.<TConsumeRankReward>();
         this.FPerRewardList = new Vector.<TPerReward>();
         this.RankInfoList2 = new Vector.<TConsumeRankInfo>();
         this.RankRewardList2 = new Vector.<TConsumeRankReward>();
         FNeedConfig = true;
      }
      ...
      public function get RankInfoList() : Vector.<TConsumeRankInfo>
      {
         return this.FRankInfoList;
      }
      
      public function set RankInfoList(param1:Vector.<TConsumeRankInfo>) : void
      {
         this.FRankInfoList = param1;
      }
      
      public function get RankRewardList() : Vector.<TConsumeRankReward>
      {
         return this.FRankRewardList;
      }
      
      public function set RankRewardList(param1:Vector.<TConsumeRankReward>) : void
      {
