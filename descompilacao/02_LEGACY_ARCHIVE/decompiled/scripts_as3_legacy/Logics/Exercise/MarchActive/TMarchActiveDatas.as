package Logics.Exercise.MarchActive
{
   ...
   public class TMarchActiveDatas extends TBaseActiveDatas
   {
      ...
      public function TMarchActiveDatas()
      {
         var _loc1_:int = 0;
         var _loc2_:Class = null;
         this.DATE_REFERENCE = Vector.<Class>([TMarchActive1,TMarchActive2]);
      ...
      override public function ChangeStatus1() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TMarchActive1 = null;
         var _loc4_:TActivityTaskData = null;
         var _loc5_:TDessertHouseTask = null;
         var _loc6_:int = 0;
         _loc3_ = FActivities[0] as TMarchActive1;
      ...
      override public function ChangeStatus2() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TMarchActive2 = null;
         _loc3_ = FActivities[1] as TMarchActive2;
         return TBaseActivity.STATUS_CANNOTGET;
      }
   }
}
