package Logics.DatebaseVO.VO
{
   ...
   public class TDrawNinjaConfig extends TDatebaseVO
   {
      
      protected var FActivationNum:int;
      ...
      public function TDrawNinjaConfig()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         param1.writeUnsignedInt(this.FActivationNum);
      ...
      {
         this.FActivationNum = param1.readUnsignedInt();
         this.FAddAttribute = TUtilityString.FetchUTF(param1);
         this.FAddAttributeVector = Json.decode(this.FAddAttribute);
      ...
      public function get ActivationNum() : int
      {
         return this.FActivationNum;
      }
