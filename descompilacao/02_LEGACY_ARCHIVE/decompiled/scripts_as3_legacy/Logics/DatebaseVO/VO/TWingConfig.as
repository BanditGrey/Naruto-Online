package Logics.DatebaseVO.VO
{
   ...
   public class TWingConfig extends TDatebaseVO
   {
      ...
      protected var FPointType:uint;
      
      public function TWingConfig()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         param1.writeUnsignedInt(this.FPointType);
      }
      ...
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         ...
         this.FPointType = param1.readUnsignedInt();
