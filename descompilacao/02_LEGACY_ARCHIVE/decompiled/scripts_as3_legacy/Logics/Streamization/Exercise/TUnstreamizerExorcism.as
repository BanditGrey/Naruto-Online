package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerExorcism extends TUnstreamizer
   {
      ...
      public function TUnstreamizerExorcism(param1:int)
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         _loc21_.ConsumeScore = param1.readUnsignedInt();
         ...
         while(_loc4_ < _loc7_)
         {
            ...
            while(_loc5_ < _loc8_)
            {
               _loc18_.ExchangeVect[_loc5_] = param1.readUnsignedInt();
               _loc5_++;
            }
            _loc21_.CannonList[_loc4_] = _loc18_;
            _loc4_++;
         }
         _loc21_.KillBox.length = 0;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            ...
            _loc21_.KillBox[_loc4_] = _loc18_;
            _loc4_++;
         }
