package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerWitchProving extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerWitchProving()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         _loc21_.ReturnGold = param1.readUnsignedInt();
         _loc21_.LotteryCount = param1.readUnsignedInt();
         _loc21_.Pet.Status = param1.readInt();
         _loc21_.Pet.Type = param1.readUnsignedInt();
         _loc21_.Pet.Price = param1.readUnsignedInt();
         _loc21_.Pet.Identify = param1.readUnsignedInt();
         _loc21_.PetReward.Status = param1.readInt();
         _loc15_.length = 0;
         _loc16_.length = 0;
         ...
         _loc21_.PetReward.Inventories = _loc11_;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            _loc21_.BarGift.ExchangeVect[_loc4_] = param1.readUnsignedInt();
            _loc21_.BarGift.MaxVect[_loc4_] = param1.readUnsignedInt();
            _loc4_++;
         }
         _loc21_.Fires.length = 0;
         _loc7_ = param1.readShort();
         _loc4_ = 0;
         while(_loc4_ < _loc7_)
         {
            _loc21_.Fires[_loc4_] = param1.readUnsignedInt();
            _loc4_++;
         }
         _loc15_.length = 0;
         _loc16_.length = 0;
