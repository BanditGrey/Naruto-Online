package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerNationalDay extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerNationalDay()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc17_:TNationalDay = null;
         _loc17_ = param2 as TNationalDay;
         ...
         _loc17_.Stones = param1.readUnsignedInt();
         _loc17_.FundID = param1.readUnsignedInt();
         _loc17_.GiftID = param1.readUnsignedInt();
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc17_.GiftVect[_loc4_] = _loc16_;
            _loc4_++;
         }
         _loc6_ = int(param1.readUnsignedShort());
         _loc4_ = 0;
         while(_loc4_ < _loc6_)
         {
            ...
            _loc16_.Inventories = _loc9_;
            _loc17_.FundVect[_loc4_] = _loc16_;
            _loc4_++;
         }
         _loc6_ = int(param1.readUnsignedShort());
         _loc4_ = 0;
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc16_.Status = param1.readUnsignedInt();
            _loc17_.StoneVect[_loc4_] = _loc16_;
            _loc4_++;
         }
      }
