package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerCrossServerSale extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerCrossServerSale()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc17_:TCrossServerSale = null;
         _loc17_ = param2 as TCrossServerSale;
         _loc15_ = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_Article);
         _loc17_.Identify = CONST_BASEACTIVITY.TYPE_NewActiveList_CrossServerSale;
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc16_.Inventory = _loc9_.GetInventoryByIndex(0);
