package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerChristmasDay extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerChristmasDay()
      {
         super();
         this.FUnstreamizerInventoryReference = new TUnstreamizerInventoryReference();
      }
      
      public function UnstreamizationPerformChristmasRank(param1:ByteArray, param2:Object, param3:Object) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         ...
         var _loc19_:int = 0;
         var _loc20_:TChristmasDay = null;
         ...
         _loc20_ = param2 as TChristmasDay;
      ...
      {
         var _loc4_:TChristmasDay = null;
         var _loc5_:int = 0;
         _loc4_ = param2 as TChristmasDay;
         _loc4_.DescList.length = 0;
         _loc5_ = 0;
         while(_loc5_ < 4)
         {
            _loc4_.DescList[_loc5_] = String(40036 + _loc5_);
            _loc5_++;
         }
         _loc4_.InitDescListNew();
         _loc4_.BeginTime = param1.readUnsignedInt();
         _loc4_.EndTime = param1.readUnsignedInt();
         _loc4_.Score = param1.readUnsignedInt();
         _loc4_.SocksNum = param1.readUnsignedInt();
         _loc4_.BoxNum = param1.readUnsignedInt();
         _loc4_.Consume = param1.readUnsignedInt();
         _loc4_.Recharge = param1.readUnsignedInt();
         _loc4_.UseSocks = param1.readUnsignedInt();
      }
   }
}
