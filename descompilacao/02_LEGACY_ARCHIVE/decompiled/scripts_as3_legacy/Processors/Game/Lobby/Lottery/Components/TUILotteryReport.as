package Processors.Game.Lobby.Lottery.Components
{
   ...
   public class TUILotteryReport extends TUIComponent
   {
      ...
      protected var FNewsList:Vector.<TUILotteryNews>;
      ...
      public function TUILotteryReport(param1:TUIComponent)
      {
         super(param1);
         this.FNewsList = new Vector.<TUILotteryNews>();
         this.FNewsDate = new Vector.<TLotteryNews>();
      }
      ...
      protected function UpdateNews() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:TUILotteryNews = null;
         this.FNewsDate = SLogicsCore.Lottery.LotteryNews;
         ...
         while(_loc1_ < _loc2_)
         {
            _loc3_ = SLogicsCore.PoolUILotteryNews.AcquireUITaskItem(this.Parent);
