package Processors.Game.Lobby.Exercise.AugustActive.Compoents
{
   ...
   public class TUIAugustActive1 extends TUIBaseWindow
   {
      ...
      protected var FAugustActive1:TAugustActive1;
      ...
      public function TUIAugustActive1(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateBox() : void
      {
         ...
         _loc5_ = this.FAugustActive1.BoxList[this.FAugustActive1.BoxList.length - 1];
         _loc1_ = 0;
         while(_loc1_ < BOX_COUNT)
         {
            _loc3_ = this.FBoxList[_loc1_];
            if(_loc1_ < this.FAugustActive1.BoxList.length)
            {
               _loc4_ = this.FAugustActive1.BoxList[_loc1_];
               _loc3_.MC_Count.TF_Count.text = "*" + (_loc4_.Price + (this.FAugustActive1.Round - 1) * _loc5_.Price);
         ...
         _loc4_ = this.FAugustActive1.BigBox;
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FAugustActive1.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FAugustActive1.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FAugustActive1.DescListNew[1].toString();
         FMC_Scene.TF_FreeCount.text = this.FAugustActive1.FreeCount.toString();
         FMC_Scene.TF_Count.text = this.FAugustActive1.MyPower;
         FMC_Scene.TF_Score.text = this.FAugustActive1.RankPoint.toString();
      ...
      protected function ProcessorOnTargetUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FAugustActive1) && this.FAugustActive1.DescList.length > 4)
         {
            if(this.FAugustActive1.FreeCount > 0 || this.FAugustActive1.MyPower > 0)
            {
               FOnGetBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_PLAY_DART);
            }
            else
            {
               _loc2_ = TUtilityString.Format(this.FAugustActive1.DescListNew[4],this.FAugustActive1.PowerPrice);
               FOnBuyBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_PLAY_DART,this.FAugustActive1.PowerPrice,0,0,_loc2_);
            }
         }
      }
      ...
      protected function ProcessorOnTargetTenUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FAugustActive1) && this.FAugustActive1.DescList.length > 4)
         {
            _loc2_ = PLAY_COUNT - this.FAugustActive1.FreeCount - this.FAugustActive1.MyPower;
            if(_loc2_ > 0)
            {
               _loc3_ = TUtilityString.Format(this.FAugustActive1.DescListNew[4],this.FAugustActive1.PowerPrice * _loc2_);
               FOnBuyBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_PLAY_DART_TEN,this.FAugustActive1.PowerPrice * _loc2_,0,0,_loc3_);
            }
            else
            {
               FOnGetBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_PLAY_DART_TEN);
            }
         }
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FAugustActive1) && _loc2_ < this.FAugustActive1.BoxList.length)
         {
            if(this.FAugustActive1.BoxList[_loc2_].Status == TBaseActivity.STATUS_CANGET)
            {
               FOnGetBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_GET_BOX,_loc2_ + 1);
            }
         }
      }
      ...
      protected function ProcessorOnBigBoxUp(param1:MouseEvent) : void
      {
         if(FOnGetBox != null)
         {
            if(this.FAugustActive1.BigBox.Status == TBaseActivity.STATUS_CANGET)
            {
               FOnGetBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_GET_BIG_BOX);
            }
         }
      }
      ...
      protected function ProcessorOnGetTaskUp(param1:MouseEvent) : void
      {
         ...
         {
            _loc3_ = this.FActivityTaskData.TaskList[_loc2_];
            FOnGetBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_GET_TASK,_loc3_.Identify);
         }
      }
      ...
      protected function ProcessorOnFinishUp(param1:MouseEvent) : void
      {
         ...
         {
            _loc3_ = this.FActivityTaskData.TaskList[_loc2_];
            FOnGetBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_FINISH_TASK,_loc3_.Identify);
         }
      }
      ...
      protected function ProcessorOnTaskRewardUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null && _loc3_ < this.FActivityTaskData.BoxList.length && this.FActivityTaskData.BoxList[_loc3_].Status == TBaseActivity.STATUS_CANGET)
         {
            ...
            FOnGetBox(ACTIVITY_1_ID,TProcessorAugustActive.ACTIVITY_1_GET_TASK_BOX,_loc3_ + 1);
         }
      }
      ...
      protected function ProcessorOnPetDescUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnShowRecruit != null) && Boolean(this.FAugustActive1) && Boolean(this.FAugustActive1.Pet))
         {
            _loc2_ = this.FAugustActive1.Pet;
      ...
      protected function ProcessorOnRewardOver(param1:MouseEvent) : void
      {
         ...
         _loc2_ = int(String(param1.currentTarget.parent.name).slice(7));
         if(FOnNewBoxOver != null && _loc2_ < this.FActivityTaskData.TaskList.length && this.FAugustActive1.DescList.length > 7)
         {
            _loc4_ = this.FActivityTaskData.TaskList[_loc2_];
            _loc6_ = Math.min(_loc4_.Step,TASK_STEP - 1);
            _loc5_ = _loc4_.TaskAward[_loc6_];
            _loc7_ = this.FAugustActive1.DescListNew[7];
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         var _loc2_:int = 0;
         _loc2_ = int(String(param1.currentTarget.name).slice(6));
         if(Boolean(FOnItemOver != null) && Boolean(this.FAugustActive1) && _loc2_ < this.FAugustActive1.BoxList.length)
         {
            FOnItemOver(this,this.FAugustActive1.BoxList[_loc2_].Inventories.GetInventoryByIndex(0));
         }
      }
      ...
      override protected function ProcessorOnBoxOut(param1:MouseEvent) : void
      {
         var _loc2_:int = 0;
         _loc2_ = int(String(param1.currentTarget.name).slice(6));
         if(Boolean(FOnItemOut != null) && Boolean(this.FAugustActive1) && _loc2_ < this.FAugustActive1.BoxList.length)
         {
            FOnItemOut(this,this.FAugustActive1.BoxList[_loc2_].Inventories.GetInventoryByIndex(0));
         }
      }
      
      protected function ProcessorOnBigBoxOver(param1:MouseEvent) : void
      {
         if(Boolean(FOnItemOver != null) && Boolean(this.FAugustActive1) && Boolean(this.FAugustActive1.BigBox))
         {
            FOnItemOver(this,this.FAugustActive1.BigBox.Inventories.GetInventoryByIndex(0));
         }
      }
      
      protected function ProcessorOnBigBoxOut(param1:MouseEvent) : void
      {
         if(Boolean(FOnItemOut != null) && Boolean(this.FAugustActive1) && Boolean(this.FAugustActive1.BigBox))
         {
            FOnItemOut(this,this.FAugustActive1.BigBox.Inventories.GetInventoryByIndex(0));
         }
      }
      
      protected function ProcessorOnTargetOver(param1:MouseEvent) : void
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FAugustActive1) && this.FAugustActive1.DescList.length > 3)
         {
            FOnShowHtmlTip(this.FAugustActive1.DescListNew[3]);
         }
      }
      
      protected function ProcessorOnTargetTenOver(param1:MouseEvent) : void
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FAugustActive1) && this.FAugustActive1.DescList.length > 8)
         {
            FOnShowHtmlTip(this.FAugustActive1.DescListNew[8]);
         }
      }
      
      protected function ProcessorOnPetOver(param1:MouseEvent) : void
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FAugustActive1) && this.FAugustActive1.DescList.length > 5)
         {
            FOnShowHtmlTip(this.FAugustActive1.DescListNew[5]);
         }
      }
      
      protected function ProcessorOnItemTipOver(param1:MouseEvent) : void
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FAugustActive1) && this.FAugustActive1.DescList.length > 6)
         {
            FOnShowHtmlTip(this.FAugustActive1.DescListNew[6]);
         }
      }
      ...
      {
         this.FAugustActive1 = SLogicsCore.AugustActiveDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TAugustActive1;
