package Processors.Game.Lobby.Exercise.HallowmasActive
{
   ...
   public class TUIHallowmasActive1 extends TUIBaseWindow
   {
      ...
      protected var FHallowmasActive1:THallowmasActive1;
      ...
      public function TUIHallowmasActive1(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateRoad() : void
      {
         ...
         this.FUIPage.TotalQuantity = THallowmasActive1.MAX_COUNT;
         this.FUIPage.Update();
         if(this.FHallowmasActive1.CurIndex == -1 && this.FCurPage == 0)
         {
            FMC_Scene.MC_Head.visible = true;
            FMC_Scene.MC_HeadEnd.visible = false;
            FMC_Scene.MC_Road.MC_LastBox.MC_Got.visible = false;
         }
         else if(this.FHallowmasActive1.CurIndex == THallowmasActive1.MAX_COUNT - 1 && this.FCurPage == 1)
         {
         ...
         if(this.FHallowmasActive1.CurIndex == THallowmasActive1.MAX_COUNT - 1)
         {
         ...
         while(_loc1_ < ROAD_COUNT)
         {
            ...
            _loc4_ = this.FHallowmasActive1.BoxList[_loc3_];
            ...
            if(_loc3_ == this.FHallowmasActive1.CurIndex)
            {
      ...
      {
         if(this.FHallowmasActive1.SignStatus == TBaseActivity.STATUS_CANGET)
         {
            TGameUtil.setButtonMode(FMC_Scene.BTN_Sign,true);
         ...
         if(this.FHallowmasActive1.SurpriseStatus == TBaseActivity.STATUS_GETED)
         {
      ...
      protected function UpdateText() : void
      {
         ...
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FHallowmasActive1.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FHallowmasActive1.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FHallowmasActive1.DescListNew[1];
         _loc1_ = this.FHallowmasActive1.GetNextBoxIndex();
         if(_loc1_ != -1)
         {
            _loc2_ = this.FHallowmasActive1.BoxList[_loc1_].Inventories;
            this.FNextBox.UpdateUI(_loc2_);
            FMC_Scene.TF_NextBox.text = TUtilityString.Format(this.FHallowmasActive1.DescListNew[2],_loc1_ - this.FHallowmasActive1.CurIndex);
         }
         FMC_Scene.TF_LastBox.text = TUtilityString.Format(this.FHallowmasActive1.DescListNew[2],this.FHallowmasActive1.BoxList.length - 1 - this.FHallowmasActive1.CurIndex);
         FMC_Scene.TF_SurpriseDesc.text = this.FHallowmasActive1.DescListNew[3];
      }
      
      protected function ProcessorOnSignUp(param1:MouseEvent) : void
      {
         if(FOnGetBox != null && this.FHallowmasActive1.SignStatus == TBaseActivity.STATUS_CANGET && !FIsPlaying)
         {
            FOnGetBox(ACTIVITY_1_ID,TProcessorHallowmasActive.ACTIVITY_1_SIGN);
         }
      }
      ...
      protected function ProcessorOnLasdBoxOver(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         if(Boolean(FOnItemOver != null) && Boolean(this.FHallowmasActive1) && this.FHallowmasActive1.BoxList.length > 0)
         {
            _loc3_ = this.FHallowmasActive1.BoxList.length - 1;
            _loc2_ = this.FHallowmasActive1.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      protected function ProcessorOnLasdBoxOut(param1:MouseEvent) : void
      {
         var _loc2_:TInventory = null;
         var _loc3_:int = 0;
         if(Boolean(FOnItemOut != null) && Boolean(this.FHallowmasActive1) && this.FHallowmasActive1.BoxList.length > 0)
         {
            _loc3_ = this.FHallowmasActive1.BoxList.length - 1;
            _loc2_ = this.FHallowmasActive1.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FHallowmasActive1) && this.FHallowmasActive1.DescList.length >= 5)
         {
            FOnShowHtmlTip(this.FHallowmasActive1.DescListNew[4]);
         }
      }
      ...
      override public function LogicsPerform() : void
      {
         ...
         {
            if(this.FHallowmasActive1)
            {
               FMC_Scene.TF_Time.text = TGameUtil.fomatTime(this.FHallowmasActive1.EndTime - STimingCore.GetServerTick());
               _loc1_ = 0;
               while(_loc1_ < ROAD_COUNT)
               {
      ...
      {
         this.FHallowmasActive1 = SLogicsCore.HallowmasActiveDatas.GetActivityByIdentify(ACTIVITY_1_ID) as THallowmasActive1;
         this.UpdatePage();
         this.UpdateWindow();
      }
      ...
      {
         if(this.FHallowmasActive1.CurIndex >= ROAD_COUNT)
         {
      ...
      override public function MovieEnd() : void
      {
         ...
         if(this.FMovieType == MOVIE_ROTATION_DISK)
         {
            this.FMoveIndex = this.FHallowmasActive1.CurIndex;
            this.FEndIndex = Math.min(THallowmasActive1.MAX_COUNT - 1,this.FHallowmasActive1.CurIndex + this.FStep);
         ...
         {
            FIsPlaying = false;
            this.FHallowmasActive1.CurIndex = this.FEndIndex;
            if(Boolean(this.FHallowmasActive1.BoxList[this.FEndIndex]) && Boolean(this.FHallowmasActive1.BoxList[this.FEndIndex].Type > 0) && FOnShowFlowText != null)
            {
               _loc2_ = this.FHallowmasActive1.BoxList[this.FEndIndex].Inventories.GetInventoryByIndex(0);
