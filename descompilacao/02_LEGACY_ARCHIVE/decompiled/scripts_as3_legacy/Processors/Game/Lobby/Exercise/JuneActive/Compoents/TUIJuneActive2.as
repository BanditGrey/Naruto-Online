package Processors.Game.Lobby.Exercise.JuneActive.Compoents
{
   ...
   public class TUIJuneActive2 extends TUIBaseWindow
   {
      ...
      protected var FJuneActive2:TJuneActive2;
      
      public function TUIJuneActive2(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateBox() : void
      {
         ...
         var _loc5_:int = 0;
         _loc5_ = this.FJuneActive2.GetCurLevel();
         _loc3_ = FMC_Scene.MC_Box;
         if(_loc5_ < this.FJuneActive2.BoxList.length)
         {
            _loc3_.MC_Got.visible = false;
            _loc4_ = this.FJuneActive2.BoxList[_loc5_];
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FJuneActive2.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FJuneActive2.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FJuneActive2.ActivityDesc3;
         FMC_Scene.TF_Count.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_AMOUNT,this.FJuneActive2.Count);
         FMC_Scene.TF_Money.text = TUtilityString.Format(this.FJuneActive2.ActivityDesc2,this.FJuneActive2.TotalMoney);
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null)
         {
            _loc2_ = this.FJuneActive2.GetCurLevel();
            FOnGetBox(ACTIVITY_2_ID,TProcessorJuneActive.ACTIVITY_2_GET_BOX,_loc2_ + 1);
         }
      }
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         if(Boolean(FOnBoxOver != null) && Boolean(this.FJuneActive2) && this.FJuneActive2.BoxList.length > 0)
         {
            _loc3_ = this.FJuneActive2.GetCurLevel();
            if(_loc3_ < this.FJuneActive2.BoxList.length)
            {
               _loc2_ = this.FJuneActive2.BoxList[_loc3_].Inventories;
               FOnBoxOver(_loc2_);
            }
         }
      }
      ...
      {
         if(!this.FJuneActive2 || this.FJuneActive2.Count <= 0)
         {
            return;
         }
         if(FOnGetBox != null)
         {
            FOnGetBox(ACTIVITY_2_ID,TProcessorJuneActive.ACTIVITY_2_GET_FISH);
         }
      }
      ...
      protected function ProcessorOnGetFishOver(param1:MouseEvent) : void
      {
         ...
         FMC_Scene.MC_Net.x = param1.localX + 300;
         FMC_Scene.MC_Net.y = param1.localY + 60;
         if(Boolean(this.FJuneActive2) && this.FJuneActive2.Count > 0)
         {
      ...
      protected function ProcessorOnFishOver(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnSpecialOver != null) && Boolean(this.FJuneActive2) && this.FJuneActive2.FishList.length > 0)
         {
            FOnSpecialOver(0,this.FJuneActive2.FishList[_loc2_]);
         }
      }
      ...
      {
         this.FJuneActive2 = SLogicsCore.JuneActiveDatas.GetActivityByIdentify(ACTIVITY_2_ID) as TJuneActive2;
         this.UpdateBox();
         this.UpdateBtn();
         this.UpdateText();
      }
