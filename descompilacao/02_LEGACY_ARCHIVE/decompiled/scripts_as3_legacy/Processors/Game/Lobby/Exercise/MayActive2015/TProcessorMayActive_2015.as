package Processors.Game.Lobby.Exercise.MayActive2015
{
   ...
   import Logics.Streamization.Exercise.TUnstreamizerMayActive2015;
   ...
   public class TProcessorMayActive_2015 extends TProcessorBaseActivity
   {
      ...
      public static const ACTIVITY_1_GET_SCORE:int = 4;
      ...
      public static const ACTIVITY_2_EXCHANGE_HERO:int = 5;
      ...
      protected var ACTIVITY_REFERENCE:Vector.<Class> = Vector.<Class>([TUIMayActive1_2015,TUIMayActive2_2015]);
      ...
      protected var FMayActiveDatas_2015:TMayActiveDatas_2015;
      
      protected var FActivityTaskData:TActivityTaskData;
      
      protected var FUnstreamizerMayActive2015:TUnstreamizerMayActive2015;
      ...
      public function TProcessorMayActive_2015(param1:TUIComponent, param2:TLobbyParameters, param3:uint)
      {
         super(param1,param2,param3);
         FActivityID = param3;
         this.FMayActiveDatas_2015 = SLogicsCore.MayActiveDatas2015;
         this.FActivityTaskData = SLogicsCore.ActivityTaskData;
         this.FUnstreamizerMayActive2015 = new TUnstreamizerMayActive2015(param3);
      ...
      override protected function UpdateUI() : void
      {
         ...
         while(_loc1_ < this.TAB_COUNT)
         {
            ...
            _loc3_ = this.FMayActiveDatas_2015.GetActivityByIndex(_loc1_);
            ...
            if(this.FMayActiveDatas_2015.Activities[_loc1_].NeedShine == TBaseActivity.STATUS_CANGET)
            {
      ...
      protected function ProcessorOnChangePage(param1:MouseEvent) : void
      {
         ...
         _loc3_ = this.FMayActiveDatas_2015.GetActivityByIndex(_loc2_);
      ...
      {
         FProcessorWindowDesc.BaseActivity = this.FMayActiveDatas_2015.GetActivityByIndex(this.FChangeTabIndex);
      ...
      protected function ProcessorOnShowWindow(param1:int) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:TMayActive1_2015 = null;
         var _loc5_:TMayActive2_2015 = null;
         this.FWindowType = param1;
         switch(param1)
         {
            case WINDOW_EQUIPMENT_DESC:
               _loc4_ = this.FMayActiveDatas_2015.GetActivityByIdentify(ACTIVITY_1_ID) as TMayActive1_2015;
      ...
      override public function ProcessorOnLoadInfoRet(param1:TPacket = null) : void
      {
         ...
         this.FUnstreamizerMayActive2015.Unstreamize(_loc2_,this.FMayActiveDatas_2015,null);
      ...
      override public function ProcessorActivityThirdLoadLogRet(param1:TPacket = null) : void
      {
         ...
         _loc5_ = this.FMayActiveDatas_2015.GetActivityByIdentify(_loc4_) as TBaseActivity;
      ...
      override public function ProcessorChangeGold(param1:TPacket = null) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:TMayActive1_2015 = null;
         var _loc10_:TMayActive2_2015 = null;
         _loc2_ = param1.Data;
         _loc2_.readShort();
         ...
         {
            case ACTIVITY_1_ID:
               _loc9_ = this.FMayActiveDatas_2015.GetActivityByIdentify(_loc6_) as TMayActive1_2015;
               if(_loc9_)
               {
               ...
               break;
            case ACTIVITY_2_ID:
               _loc10_ = this.FMayActiveDatas_2015.GetActivityByIdentify(_loc6_) as TMayActive2_2015;
               if(_loc10_)
               {
      ...
      override public function ProcessorAllRet(param1:TPacket = null) : void
      {
         ...
         var _loc24_:TMayActive1_2015 = null;
         var _loc25_:TMayActive2_2015 = null;
         var _loc26_:int = 0;
         var _loc27_:int = 0;
         var _loc28_:int = 0;
         var _loc29_:int = 0;
         ...
         {
            case ACTIVITY_1_ID:
               _loc24_ = this.FMayActiveDatas_2015.GetActivityByIdentify(ACTIVITY_1_ID) as TMayActive1_2015;
               if(_loc10_ == ACTIVITY_1_GET_TASK)
               {
                  ...
                  this.FMayActiveDatas_2015.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FMayActiveDatas_2015.CheckStatus());
                  this.UpdateUI();
               }
               ...
               {
                  _loc24_.IsFirstPlay = 1;
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc24_.CardList[_loc5_] = _loc2_.readUnsignedInt();
                  _loc5_ = 0;
                  while(_loc5_ < _loc24_.MatchIndex.length)
                  {
                     _loc24_.MatchIndex[_loc5_] = _loc2_.readUnsignedInt();
                     _loc5_++;
                  }
                  _loc24_.CurValue = _loc2_.readUnsignedInt();
                  _loc24_.ScoreA = _loc2_.readUnsignedInt();
                  _loc24_.Gift.Count = _loc2_.readUnsignedInt();
                  _loc24_.ConsumeScore += _loc24_.Price;
                  _loc24_.Price = _loc2_.readUnsignedInt();
                  ++_loc24_.OpenCard;
                  this.FUIWindowVect[0].PlayMovie(TUIMayActive1_2015.MOVIE_OF_OPEN_CARD);
                  _loc24_.ChangeStatus();
                  this.FMayActiveDatas_2015.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FMayActiveDatas_2015.CheckStatus());
               }
               ...
               {
                  _loc5_ = 0;
                  while(_loc5_ < _loc24_.MaxCard)
                  {
                     _loc6_ = _loc2_.readUnsignedInt() - 1;
                     _loc24_.CardList[_loc6_] = _loc2_.readUnsignedInt();
                     _loc5_++;
                  }
                  _loc5_ = 0;
                  while(_loc5_ < _loc24_.MatchIndex.length)
                  ...
                  _loc24_.ScoreA = _loc2_.readUnsignedInt();
                  _loc24_.Gift.Count = _loc2_.readUnsignedInt();
                  _loc24_.OpenCard = _loc24_.MaxCard;
                  _loc24_.ConsumeScore += _loc24_.AutoPrice;
                  this.FUIWindowVect[0].PlayMovie(TUIMayActive1_2015.MOVIE_OF_AUTO_GAME);
                  _loc24_.ChangeStatus();
                  this.FMayActiveDatas_2015.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FMayActiveDatas_2015.CheckStatus());
               }
               else if(_loc10_ == ACTIVITY_1_GET_SCORE)
               {
                  if(_loc24_.IsDouble == -1)
                  {
                     _loc4_ = TUtilityString.Format(_loc24_.DescListNew[6],_loc24_.CurValue);
                     _loc24_.RankPoint += _loc24_.CurValue;
                     _loc24_.ShopExchangePoint += _loc24_.CurValue;
                  }
                  else
                  {
                     _loc4_ = TUtilityString.Format(_loc24_.DescListNew[6],_loc24_.CurValue * 2);
                     _loc24_.RankPoint += _loc24_.CurValue * 2;
                     _loc24_.ShopExchangePoint += _loc24_.CurValue * 2;
                  }
                  ProcessorEffectText(_loc4_);
                  _loc24_.ResetCard();
                  _loc24_.LuckyIndex = _loc2_.readUnsignedInt();
                  _loc24_.Price = _loc2_.readUnsignedInt();
                  this.FUIWindowVect[0].PlayMovie(TUIMayActive1_2015.MOVIE_OF_FLOW);
                  _loc24_.ChangeStatus();
                  this.FMayActiveDatas_2015.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FMayActiveDatas_2015.CheckStatus());
               }
               ...
               break;
            case ACTIVITY_2_ID:
               _loc25_ = this.FMayActiveDatas_2015.GetActivityByIdentify(ACTIVITY_2_ID) as TMayActive2_2015;
               if(_loc10_ == ACTIVITY_2_PLAY_GAME)
               {
                  ...
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc14_ = _loc25_.BallList[_loc5_];
                  _loc4_ = TUtilityString.Format(_loc25_.DescListNew[8],_loc14_);
                  this.FUIWindowVect[1].FlowStr = _loc4_;
                  _loc25_.GameValue = _loc2_.readInt();
                  _loc25_.RewardIndex = _loc2_.readUnsignedInt();
                  _loc25_.ChangeStatus();
                  this.FUIWindowVect[1].SetMovieParam(_loc5_);
                  this.FUIWindowVect[1].PlayMovie(TUIMayActive2_2015.MOVIE_OF_PLAY_GAME);
                  this.FMayActiveDatas_2015.ChangeSingleActivityStatus(ACTIVITY_2_ID);
                  ProcessorCheckEffect(FActivityID,this.FMayActiveDatas_2015.CheckStatus());
               }
               else if(_loc10_ == ACTIVITY_2_AUTO_GAME)
               {
                  _loc14_ = 0;
                  _loc5_ = 0;
                  while(_loc5_ < _loc25_.AutoLog.length)
                  {
                     _loc25_.AutoLog[_loc5_] = new Object();
                     _loc25_.AutoLog[_loc5_].Reward = _loc2_.readInt();
                     _loc25_.AutoLog[_loc5_].Score = _loc2_.readInt();
                     _loc14_ += _loc25_.AutoLog[_loc5_].Reward;
                     _loc5_++;
                  }
                  if(_loc14_ > 0)
                  {
                  ...
                  _loc25_.ChangeStatus();
                  this.FUIWindowVect[1].SetMovieParam(_loc14_);
                  this.FUIWindowVect[1].PlayMovie(TUIMayActive2_2015.MOVIE_OF_AUTO_GAME);
                  this.FMayActiveDatas_2015.ChangeSingleActivityStatus(ACTIVITY_2_ID);
                  ProcessorCheckEffect(FActivityID,this.FMayActiveDatas_2015.CheckStatus());
               }
               else if(_loc10_ == ACTIVITY_2_GET_SCORE)
               {
                  _loc14_ = int(_loc2_.readUnsignedInt());
                  if(_loc14_ > 0)
                  {
                     _loc4_ = TUtilityString.Format(_loc25_.DescListNew[9],_loc14_);
                     ProcessorEffectText(_loc4_);
                  }
                  _loc25_.MyScore += _loc14_;
                  _loc25_.Reset();
                  _loc25_.ChangeStatus();
                  this.FUIWindowVect[1].PlayMovie(TUIMayActive2_2015.MOVIE_OF_FLOW);
                  this.FMayActiveDatas_2015.ChangeSingleActivityStatus(ACTIVITY_2_ID);
                  ProcessorCheckEffect(FActivityID,this.FMayActiveDatas_2015.CheckStatus());
               }
      ...
      public function TestInit0() : ByteArray
      {
         ...
         TUtilityString.FlushUTF(_loc3_,"每使用%0/5个XX可领取");
         TUtilityString.FlushUTF(_loc3_,"当前消耗%0个XX，是否花费%1金币补齐不足的%2个XX？");
         TUtilityString.FlushUTF(_loc3_,"XXTIPS");
         TUtilityString.FlushUTF(_loc3_,"收集物TIPS");
         TUtilityString.FlushUTF(_loc3_,"你获得了%0个收集物");
         TUtilityString.FlushUTF(_loc3_,"每轮占卜最多可翻%0/%1张牌");
         TUtilityString.FlushUTF(_loc3_,"星座1额外+50");
         TUtilityString.FlushUTF(_loc3_,"星座2额外+500");
         TUtilityString.FlushUTF(_loc3_,"星座3额外+5000");
         TUtilityString.FlushUTF(_loc3_,"星座4额外+50000");
         TUtilityString.FlushUTF(_loc3_,"本轮占卜次数已满,请领取奖励");
         TUtilityString.FlushUTF(_loc3_,"一键占卜消耗X个塔罗牌");
      ...
      public function TestInit1() : ByteArray
      {
         ...
         TUtilityString.FlushUTF(_loc3_,"活动详情长");
         TUtilityString.FlushUTF(_loc3_,"活动详情短");
         TUtilityString.FlushUTF(_loc3_,"充值%0金币可领");
         TUtilityString.FlushUTF(_loc3_,"当前充值%0金币");
         TUtilityString.FlushUTF(_loc3_,"自动游戏花费%0金币？");
         TUtilityString.FlushUTF(_loc3_,"一键TIP");
         TUtilityString.FlushUTF(_loc3_,"开始游戏TIP");
         TUtilityString.FlushUTF(_loc3_,"忍者TIP");
         TUtilityString.FlushUTF(_loc3_,"你获得了%0个XXX");
         TUtilityString.FlushUTF(_loc3_,"获得了%0个收集物");
         _loc3_.writeUnsignedInt(1);
         _loc3_.writeUnsignedInt(1);
         _loc3_.writeUnsignedInt(1);
         _loc3_.writeUnsignedInt(1);
