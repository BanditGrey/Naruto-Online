package Processors.Game.Lobby.Exercise.CommonRecharge.Compoents
{
   ...
   public class TUICommonReward extends TUIComponent
   {
      ...
      protected var FRewardList:Vector.<TPerReward>;
      ...
      public function TUICommonReward(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function Initialization() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance(CONST_COMMONRECHARGE.RESOURCE_ClassName_CommonReward) as MovieClip;
      ...
      protected function UpdateContent() : void
      {
         ...
         {
            this.FMC_Scene.TF_Text.text = TUtilityString.Format(STRING_COMMONRECHARGE.FORMAT_SINGLE_TEXT,this.FCommonRecharge.SingleInventories[this.FIndex].MinValue,this.FCommonRecharge.SingleInventories[this.FIndex].MaxValue);
         }
         else
         {
            this.FMC_Scene.TF_Text.text = TUtilityString.Format(STRING_COMMONRECHARGE.FORMAT_ACCUMULATE_TEXT,this.FCommonRecharge.AccumulateInventories[this.FIndex].Score);
         }
      }
      ...
      protected function UpdateItem() : void
      {
         ...
         _loc3_ = this.FRewardList[this.FIndex].Inventories;
         _loc1_ = 0;
         while(_loc1_ < this.BOX_COUNT)
         {
      ...
      public function get RewardList() : Vector.<TPerReward>
      {
         return this.FRewardList;
      }
      
      public function set RewardList(param1:Vector.<TPerReward>) : void
      {
