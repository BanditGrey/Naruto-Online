package Processors.Game.Lobby.Exercise.ThanksgivingDay
{
   ...
   public class TProcessorThanksgivingDayRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorThanksgivingDayRank(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_BaseActiveRank1") as MovieClip;
      ...
      {
         if(this.FThanksgivingDay3.CurMyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FThanksgivingDay3.CurMyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FThanksgivingDay3.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FThanksgivingDay3.RankRewardList.length)
            {
               _loc4_ = this.FThanksgivingDay3.RankRewardList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FThanksgivingDay3.RankList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FThanksgivingDay3.RankList.length)
            {
               _loc8_ = this.FThanksgivingDay3.RankList[_loc2_];
               if(this.FCurPage == 0)
               {
