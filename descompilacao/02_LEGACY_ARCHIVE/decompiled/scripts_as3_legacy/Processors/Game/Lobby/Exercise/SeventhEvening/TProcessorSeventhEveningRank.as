package Processors.Game.Lobby.Exercise.SeventhEvening
{
   ...
   public class TProcessorSeventhEveningRank extends TProcessorLobbyWindow
   {
      
      protected static const SIZE_Window_Width:uint = 680;
      
      protected static const SIZE_Window_Height:uint = 480;
      ...
      public function TProcessorSeventhEveningRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(1728053248);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_SeventhEveningRank") as MovieClip;
      ...
      {
         if(this.FSeventhEvening.CurMyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FSeventhEvening.CurMyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FSeventhEvening.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FSeventhEvening.RankGiftList.length)
            {
               _loc4_ = this.FSeventhEvening.RankGiftList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FSeventhEvening.RankPlayerList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FSeventhEvening.RankPlayerList.length)
            {
               _loc8_ = this.FSeventhEvening.RankPlayerList[_loc2_];
               if(this.FCurPage == 0)
               {
