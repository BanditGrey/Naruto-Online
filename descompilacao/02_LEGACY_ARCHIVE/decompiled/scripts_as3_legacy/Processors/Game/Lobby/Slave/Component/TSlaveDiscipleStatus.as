package Processors.Game.Lobby.Slave.Component
{
   ...
   public class TSlaveDiscipleStatus extends TProcessorGame
   {
      ...
      public function TSlaveDiscipleStatus(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UIDispatch() : void
      {
         ...
         this.FSlaveInfo.Resource = this.FResource[CONST_SLAVE.RESOURCE_Link_MC_Hero];
         this.FSlaveInfo.ImageOnClick = this.ProcessorOnWatchHeroInfo;
         this.FSlaveInfo.Init();
         this.FMC_InteractionCDTime = this.FResource[CONST_SLAVE.RESOURCE_Link_MC_InteractionCDTime];
         this.FTF_InteractionCDTime = this.FMC_InteractionCDTime[CONST_SLAVE.RESOURCE_Link_TF_InteractionCDTime];
         this.FBTN_Interaction = this.FResource[CONST_SLAVE.RESOURCE_Link_BTN_Interaction];
         this.FBTN_GetDisciple = this.FResource[CONST_SLAVE.RESOURCE_Link_BTN_GetDisciple];
         this.FMC_Operation = this.FResource[CONST_SLAVE.RESOURCE_Link_MC_Operation];
         this.FMC_WorkExp = this.FMC_Operation[CONST_SLAVE.RESOURCE_Link_MC_WorkExp];
         this.FTF_WorkTime = this.FMC_WorkExp[CONST_SLAVE.RESOURCE_Link_TF_WorkTime];
         this.FTF_GetEXP = this.FMC_WorkExp[CONST_SLAVE.RESOURCE_Link_TF_GetEXP];
         this.FBTN_Draw = this.FMC_Operation[CONST_SLAVE.RESOURCE_Link_BTN_Draw];
         this.FBTN_Squeeze = this.FMC_Operation[CONST_SLAVE.RESOURCE_Link_BTN_Squeeze];
         this.FBTN_DrawAll = this.FMC_Operation[CONST_SLAVE.RESOURCE_Link_BTN_DrawAll];
         this.FBTN_Release = this.FMC_Operation[CONST_SLAVE.RESOURCE_Link_BTN_Release];
         this.FBTN_Award = this.FMC_Operation[CONST_SLAVE.RESOURCE_Link_BTN_Award];
         ...
         this.FBTNList.push(this.FBTN_Award);
      ...
      protected function UILocation() : void
      {
         ...
         this.FBTN_Award.addEventListener(MouseEvent.CLICK,this.BTNAwardOnClick,false,0,true);
      }
      
      protected function ShowUI(param1:Boolean) : void
      {
         this.FSlaveInfo.Resource.visible = param1;
      ...
      protected function UpdateUI(param1:Boolean) : void
      {
         ...
         this.FSlaveInfo.Update(this.FDisciple);
      ...
      protected function BTNDrawOnClick(param1:MouseEvent) : void
      {
         ...
         {
            this.FOnDrawExp(this,CONST_SLAVE.COMMAND_Draw,0,this.FDisciple);
         }
      }
      ...
      protected function BTNSqueezeOnClick(param1:MouseEvent) : void
      {
         ...
         this.FCommandType = CONST_SLAVE.COMMAND_Squeeze;
      ...
      protected function BTNDrawAllOnClick(param1:MouseEvent) : void
      {
         ...
         _loc5_ = _loc2_.Cost;
         this.FCommandType = CONST_SLAVE.COMMAND_DrawAll;
         this.FUIWindowConfirmation.Visible = true;
      ...
      protected function BTNReleaseOnClick(param1:MouseEvent) : void
      {
         ...
         this.FCommandType = CONST_SLAVE.COMMAND_Release;
         this.FUIWindowConfirmation.Visible = true;
         this.FUIWindowConfirmation.Text = STRING_Mentorship.STRING_Release;
      }
      
      protected function BTNAwardOnClick(param1:MouseEvent) : void
      {
         if(this.FOnReward != null)
         {
            this.FOnReward(this.FDisciple);
         }
      }
      ...
      protected function ProcessorOnWatchHeroInfo(param1:Object, param2:Object) : void
      {
         ...
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         if(param2 is TSlaveDisciple)
         {
            _loc3_ = param2 as TSlaveDisciple;
      ...
      public function Update(param1:TSlaveDisciple, param2:Boolean = false) : void
      {
