package Processors.Game.Lobby.CrossServerWar.Window
{
   ...
   public class TProcessorWindowChallengeRankings extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorWindowChallengeRankings(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         _loc1_ = TUtilityReflection.CreateDisplayObjectInstance(CONST_CROSSSERVERWAR.RESOURCE_ClassName_MC_ChallengeRankings) as Sprite;
         addChild(_loc1_);
         ...
         this.FTF_SelfRank = _loc1_[CONST_CROSSSERVERWAR.RESOURCE_Link_TF_SelfRank];
         _loc4_ = _loc1_[CONST_CROSSSERVERWAR.RESOURCE_Link_MC_Page][CONST_CROSSSERVERWAR.RESOURCE_Link_MC_PageLeft];
         this.FUIPage.ButtonPrevious.Substrate = _loc4_;
         _loc4_ = _loc1_[CONST_CROSSSERVERWAR.RESOURCE_Link_MC_Page][CONST_CROSSSERVERWAR.RESOURCE_Link_MC_PageRight];
         this.FUIPage.ButtonNext.Substrate = _loc4_;
         _loc5_ = _loc1_[CONST_CROSSSERVERWAR.RESOURCE_Link_MC_Page][CONST_CROSSSERVERWAR.RESOURCE_Link_TF_Page];
         ...
         while(_loc2_ < _loc3_)
         {
            ...
            _loc6_ = _loc1_[CONST_CROSSSERVERWAR.RESOURCE_Link_MC_Hero + _loc2_] as MovieClip;
      ...
      protected function UpdateUIRankings() : void
      {
         ...
         this.FTF_SelfRank.text = this.FSingleRank.toString();
         ...
         while(_loc1_ < _loc2_)
         {
            if(this.FPageIndex * _loc2_ + _loc1_ >= this.FIntegralRankings.Count)
            {
               return;
            }
            _loc3_ = this.FIntegralRankings.GetIntegralRankingByIndex(this.FPageIndex * _loc2_ + _loc1_);
            _loc4_ = this.FUIScoreRankings[_loc1_];
      ...
      {
         this.FPageIndex = 0;
         this.FUIPage.TotalQuantity = this.FIntegralRankings.Count;
