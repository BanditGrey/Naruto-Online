package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   public class TProcessorWindowActivityInnerEquipment extends TProcessorWindowWonderfulActivity
   {
      
      protected static const CAPACITY_SLOTS:uint = 6;
      
      protected static const ROW_COUNT:uint = 2;
      ...
      protected static const KEY_Equipment_Lv30:uint = CONST_COUNTER.KEY_Equipment_Lv30;
      
      protected static const KEY_Equipment_Lv50:uint = CONST_COUNTER.KEY_Equipment_Lv50;
      ...
      public function TProcessorWindowActivityInnerEquipment(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function LogicsPerform_Signals() : void
      {
         ...
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         _loc1_ = SLogicsCore.SignalRetrieve(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_Equipment_Ret);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function UpdateReward() : void
      {
         ...
         var _loc1_:String = STRING_ACTIVITYINNER.STRING_EQUIPMENT_COUNT;
         var _loc2_:String = STRING_ACTIVITYINNER.STRING_EQUIPMENT_STATUS;
         var _loc10_:int = 0;
         while(_loc10_ < ROW_COUNT)
         {
            ...
            _loc4_ = STRING_ACTIVITYINNER.STRING_EQUIPMENT_LEVEL[_loc10_];
      ...
      {
         this.FCountKey.push(KEY_Equipment_Lv30);
         this.FCountKey.push(KEY_Equipment_Lv50);
         SLogicsCore.SignalPost(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_Equipment_Req,0,0,this.FCountKey);
      }
