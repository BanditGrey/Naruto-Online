package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   public class TProcessorWindowActivityInnerKillHeros extends TProcessorWindowWonderfulActivity
   {
      ...
      public function TProcessorWindowActivityInnerKillHeros(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FMC_Reward.SetText(STRING_ACTIVITYINNER.STRING_PASS,STRING_ACTIVITYINNER.STRING_PASSNAME2,TUtilityString.Format(STRING_ACTIVITYINNER.FORMAT_REMAINCOUNT,param1));
         if(param1 == 0)
         {
