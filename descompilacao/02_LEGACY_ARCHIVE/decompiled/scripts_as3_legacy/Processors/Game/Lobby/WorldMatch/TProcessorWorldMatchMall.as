package Processors.Game.Lobby.WorldMatch
{
   ...
   import Processors.Game.Windows.Information.TUIWindowWorldMatchBuyGoods;
   ...
   public class TProcessorWorldMatchMall extends TProcessorWindowTemplate
   {
      ...
      protected var FUIWindowBuyGoods:TUIWindowWorldMatchBuyGoods;
      ...
      public function TProcessorWorldMatchMall(param1:TUIComponent)
      {
         super(param1);
         this.Init();
      }
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         FMainUI = TUtilityReflection.CreateDisplayObjectInstance("worldMatchMall") as Sprite;
         UIDispatch();
         ...
         this.FUIWindowBuyGoods = new TUIWindowWorldMatchBuyGoods(this,CONST_MODULES.MODULE_WorldMatch);
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         this.FUnstreamizerWorldMatch.UnstreamizeInventorySamplesByDatabase(null,this.FInventorySamples,null);
         _loc2_ = SResourcesCore.ResourceBin.GetDatebase(CONST_DATEBASEVO.RESOURCEID_ConfigValue,CONST_CONFIGVALUE.WorldMatchMall) as TConfigValue;
      ...
      protected function SlotsOnQuerySequenceContext(param1:Object, param2:Object, param3:TQueryAnimationSequence, param4:uint = 0) : void
      {
         ...
         {
            _loc6_.LoadSecondary(_loc5_.IDTexture,CONST_MODULES.MODULE_WorldMatch);
         }
      }
