package Processors.Game.Lobby.Global
{
   ...
   import Foundation.Crypto.Utils.TUtilInt;
   ...
   import Processors.Game.Windows.Information.TUIWindowGlobalbattleBuyGoods;
   ...
   public class TProcessorGlobalBattleMall extends TProcessorWindowTemplate
   {
      ...
      protected var FUIWindowBuyGoods:TUIWindowGlobalbattleBuyGoods;
      ...
      public function TProcessorGlobalBattleMall(param1:TUIComponent)
      {
         super(param1);
         this.Init();
      }
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         FMainUI = TUtilityReflection.CreateDisplayObjectInstance("MC_GlobalBattleMall") as Sprite;
         UIDispatch();
         ...
         this.FUIWindowBuyGoods = new TUIWindowGlobalbattleBuyGoods(this,CONST_MODULES.MODULE_Kingwar);
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         this.FUnstreamizerGlobalBattle.UnstreamizeInventorySamplesByDatabase(null,this.FInventorySamples,null);
      ...
      protected function FilterTabMallItem() : void
      {
         ...
         var _loc4_:String = TUtilInt.toHex(45456215,true);
         var _loc5_:int = 1 ^ 3;
      }
