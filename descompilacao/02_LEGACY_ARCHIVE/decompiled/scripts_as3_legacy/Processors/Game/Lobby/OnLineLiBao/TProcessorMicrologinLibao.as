package Processors.Game.Lobby.OnLineLiBao
{
   ...
   public class TProcessorMicrologinLibao extends TProcessorLobbyWindows
   {
      ...
      public function TProcessorMicrologinLibao(param1:TUIComponent, param2:TLobbyParameters)
      {
         super(param1,param2);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(1308622849);
      ...
      {
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_S2C_OnLineMicroLogin_Info,this.PACKETID_S2C_OnLineLiBao_InforMation);
         FPacketRoutines.Register(CONST_NETWORK.PACKETID_S2C_OnLineMicroLogin_Get_Award,this.PACKETID_S2C_OnLineLiBao_Get_Award);
      ...
      public function PACKETID_S2C_OnLineLiBao_InforMation(param1:TPacket) : void
      {
         ...
         SLogicsCore.ZhenAoYiLogicData.OnMiLineGiftCurTime = this.FCurOnLinedTime;
         if(!_loc7_)
         {
            this.FLimitTime = 0;
         ...
         SLogicsCore.ZhenAoYiLogicData.OnMiLineGiftTime = this.FLimitTime;
         if(!this.FIsInilization)
         {
            return;
         }
         ...
         _loc4_ = 0;
         while(_loc4_ < _loc7_.RewardweiVector.length)
         {
            _loc8_ = _loc7_.RewardweiVector[_loc4_];
      ...
      protected function GetReward_Req() : void
      {
         ...
         _loc1_ = SNetworkCore.PacketAcquire(CONST_NETWORK.PACKETID_C2S_OnLineMicroLogin_Get_Award);
