package Processors.Game.TopTeamBattle
{
   ...
   public class TTopTeamWindow extends TUIComponent
   {
      
      protected static const MAX_PLAYER_COUNT:uint = 3;
      
      protected static const MAX_ENEMY_COUNT:uint = 3;
      ...
      protected var FPlayerPlateName:String;
      
      protected var FPlayerServerName:String;
      
      protected var FEnemyPlateName:String;
      
      protected var FEnemyServerName:String;
      
      protected var FOnSkipBattle:Function;
      
      public function TTopTeamWindow(param1:TUIComponent)
      {
         super(param1);
         ...
         this.FPlayerNames = new Vector.<String>(MAX_PLAYER_COUNT);
         this.FEnemyNames = new Vector.<String>(MAX_ENEMY_COUNT);
         this.FPlayerLevel = new Vector.<uint>(MAX_PLAYER_COUNT);
         this.FEnemyLevel = new Vector.<uint>(MAX_ENEMY_COUNT);
      ...
      protected function InitWindow() : void
      {
         ...
         this.SetPlateServer(this.FPlayerPlateName,this.FPlayerServerName,this.FEnemyPlateName,this.FEnemyServerName);
         this.SetPlayerName(this.FPlayerNames,this.FEnemyNames,this.FPlayerLevel,this.FEnemyLevel);
      }
      ...
      public function SetPlateServer(param1:String, param2:String, param3:String, param4:String) : void
      {
         this.FPlayerPlateName = param1;
         this.FPlayerServerName = param2;
         this.FEnemyPlateName = param3;
         this.FEnemyServerName = param4;
         if(this.FScene != null)
         {
            this.FScene.MC_PlayerInfo.TF_Plate.text = param1;
            this.FScene.MC_PlayerInfo.TF_ServerName.text = param2;
            this.FScene.MC_EnemyInfo.TF_Plate.text = param3;
            this.FScene.MC_EnemyInfo.TF_ServerName.text = param4;
         }
      }
      ...
      public function SetPlayerName(param1:Vector.<String>, param2:Vector.<String>, param3:Vector.<uint>, param4:Vector.<uint>) : void
      {
         var _loc5_:uint = 0;
         var _loc6_:uint = 0;
         this.FPlayerNames = param1;
         this.FEnemyNames = param2;
         this.FPlayerLevel = param3;
         this.FEnemyLevel = param4;
         if(this.FScene != null)
         {
            _loc6_ = MAX_PLAYER_COUNT;
            _loc5_ = 0;
            while(_loc5_ < _loc6_)
            {
               if(this.FPlayerNames[_loc5_] != null)
               {
                  this.FScene["MC_Player" + _loc5_].MC_Head.TF_Level.text = SLogicsCore.Character.MainHero.GetLevelStrByLevel(this.FPlayerLevel[_loc5_]);
                  this.FScene["MC_Player" + _loc5_].MC_Head.TF_Name.text = this.FPlayerNames[_loc5_];
               }
               _loc5_++;
            }
            _loc6_ = MAX_ENEMY_COUNT;
            _loc5_ = 0;
            while(_loc5_ < _loc6_)
            {
               if(this.FEnemyNames[_loc5_] != null)
               {
                  this.FScene["MC_Enemy" + _loc5_].MC_Head.TF_Level.text = SLogicsCore.Character.MainHero.GetLevelStrByLevel(this.FEnemyLevel[_loc5_]);
                  this.FScene["MC_Enemy" + _loc5_].MC_Head.TF_Name.text = this.FEnemyNames[_loc5_];
               }
               _loc5_++;
            }
         }
      ...
      public function UpdataPlayerHead() : void
      {
         ...
         while(_loc1_ < MAX_PLAYER_COUNT)
         {
            ...
            if(_loc2_ != 0)
            {
               ...
               TGameUtil.ShowImageByID(TGameUtil.Type_HeadIcon,this.FPlayerHeadBitmap[_loc1_],CONST_MODULES.MODULE_TopTeam,_loc2_);
            }
            else
            {
         ...
         while(_loc1_ < MAX_ENEMY_COUNT)
         {
            ...
            if(_loc2_ != 0)
            {
               ...
               TGameUtil.ShowImageByID(TGameUtil.Type_HeadIcon,this.FEnemyHeadBitmap[_loc1_],CONST_MODULES.MODULE_TopTeam,_loc2_);
            }
            else
            {
         ...
         TGameUtil.ShowImageByID(TGameUtil.Type_BackgroundIcon,this.FBackGroundBitmap,CONST_MODULES.MODULE_TopTeam,this.FBackGroundId);
      }
