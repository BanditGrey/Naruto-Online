package Processors.Game.Windows.Information
{
   ...
   public class TUIWindowGlobalbattleBuyGoods extends TUIWindow
   {
      ...
      public function TUIWindowGlobalbattleBuyGoods(param1:TUIComponent, param2:uint)
      {
         super(param1);
      ...
      protected function UpdatePrice() : void
      {
         ...
         this.FTF_Desc.text = TUtilityString.Format(new ConsumeFrame(CONST_SYSTEMLANGUAGE.STRING_GlobalBattle).DescribeString,this.FInventorySample.Integration * this.FGoodsNum);
      }
      ...
      {
         var _loc2_:uint = 0;
         this.FGoodsNum = this.FInventorySample.Amount;
         this.UpdatePrice();
      }
