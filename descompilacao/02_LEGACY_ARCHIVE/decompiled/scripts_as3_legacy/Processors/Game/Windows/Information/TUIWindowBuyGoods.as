package Processors.Game.Windows.Information
{
   ...
   public class TUIWindowBuyGoods extends TUIWindow
   {
      ...
      public function TUIWindowBuyGoods(param1:TUIComponent, param2:uint)
      {
         super(param1);
      ...
      protected function UpdatePrice() : void
      {
         ...
         this.FTF_Desc.text = TUtilityString.Format(STRING_COMMON.FORMAT_CHARGEITEM,this.FInventorySample.Integration * this.FGoodsNum);
      }
      ...
      protected function TextFieldOnChange(param1:Event) : void
      {
         ...
         _loc3_ = uint(SLogicsCore.TopTeamData.NinjaPoint);
