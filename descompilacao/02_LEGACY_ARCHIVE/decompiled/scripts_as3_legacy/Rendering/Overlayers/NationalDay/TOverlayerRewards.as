package Rendering.Overlayers.NationalDay
{
   ...
   public class TOverlayerRewards extends TOverlayer
   {
      ...
      public function TOverlayerRewards(param1:TUIComponent)
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
      ...
      protected function EvaluationPerform_Explain2() : void
      {
         ...
         this.FContextExplain2 = "";
         this.FContextExplain2 = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_NATIONAL_DAY_ITEM_NAME,_loc4_.Max);
