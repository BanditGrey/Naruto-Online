package Rendering.Overlayers.FeteBlood
{
   ...
   public class TNumenCellTip extends TOverlayer
   {
      ...
      public function TNumenCellTip(param1:TUIComponent)
      {
         var _loc2_:int = 0;
         super(param1);
      ...
      protected function pRi() : void
      {
         ...
         this.TPPri.Text = TUtilityString.Format(STRING_FETEBLOODMAINMANAGE.STRING_Function_Pric,this.FCur.Price);
