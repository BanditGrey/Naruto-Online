package Rendering.Texts
{
   ...
   public class TPainterHtmlTextEffectCopy extends TPainterHtmlText
   {
      ...
      public function TPainterHtmlTextEffectCopy(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function FontSynchronize() : void
      {
         ...
         FTextField.multiline = FMultilineable;
      }
