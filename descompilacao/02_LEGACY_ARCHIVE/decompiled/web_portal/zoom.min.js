(function(e) {
    ...
    function a() {
        ...
        if (t.length == 0) t = e(".galleryList li:last-child");
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parent("li").next();
        if (t.length == 0) t = e(".galleryList li:first-child");
    ...
    o = e(window).height(); (function() {
        ...
        if (e(".galleryList li a").length == 1) e(".galleryList li a")[0].addClass("zoom");
        e(".zoom, .galleryList li a").on("click", u)
    })(); (function() {
