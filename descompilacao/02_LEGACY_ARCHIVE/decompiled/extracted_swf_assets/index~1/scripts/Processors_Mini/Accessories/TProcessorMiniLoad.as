package Processors_Mini.Accessories
{
   ...
   public class TProcessorMiniLoad extends Sprite
   {
      ...
      public static const STRING_LoadingTips:Vector.<String> = Vector.<String>(["Tips:The higher the VIP level, the better the benefits!","Tips:Summoned Beast will give you extra stats during Arena and events!","Tips:Ninjutsu and Taijutsu will deal physical dmg to enermy, Genjutsu deal Strategy dmg.","Tips:Play Arena and receive Arena Chest will bring you Reputation!","Tips:Strong Equips and S Wpn shows how successful in game!","Tips:Correct Jade will massively increase your Combat Power!","Tips:Formation is the key to success!","Tips:Switching skills while meeting fierce enemies can give you unexpected result!","Tips:The higher the ninja rank, the more teammates you can take to battle!","Tips:Realms will drop S.Weapons!"]);
      ...
      protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FTF_ProgressSmall.text = "Initialize the game, please wait ...";
      ...
      {
         this.FTF_ProgressSmall.text = "The game failed to initialize!";
         this.XMLRemoveEventListeners();
      }
