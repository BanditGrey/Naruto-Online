package Processors.Accessories
{
   ...
   public class TProcessorLoading extends TProcessor
   {
      ...
      protected function LogicsPerform_ProgressPercentage() : void
      {
         ...
         if(this.FMax > 0 && (_loc1_ == 0 || (_loc1_ <= 1 && this.FMax > 2)))
         {
            if(ExternalInterface.available)
            {
               ExternalInterface.call("flash_log","LoadingComplete triggered: PC=" + _loc1_ + " FMax=" + this.FMax);
            }
            this.FMax = 0;
            this.FCurrent = 0;
         ...
         if(_loc1_ > 0)
         {
            ...
            if(ExternalInterface.available)
            {
               ExternalInterface.call("flash_log","Progress: PC=" + _loc1_ + " Max=" + this.FMax + " Cur=" + this.FCurrent);
            }
         }
