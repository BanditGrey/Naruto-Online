package Processors.Game.Login
{
   ...
   public class TProcessorLogin extends TProcessorGame
   {
      ...
      protected function FetchParameters() : void
      {
         ...
         if(TUtilityString.Empty(_loc1_) || _loc1_ == "172.24.8.8")
         {
            _loc1_ = "127.0.0.1";
         }
         if(_loc2_ == 0 || _loc2_ == 30001)
         {
            _loc2_ = 8080;
         }
         if(TUtilityString.Empty(this.FLoginToken))
         {
            this.FLoginToken = "token_daniel_test";
         }
         if(TUtilityString.Empty(this.FOperatorUserID))
         {
            this.FOperatorUserID = "daniel";
         }
         if(this.FAgentID == 0)
         {
            this.FAgentID = 75;
      ...
      protected function LoginAutostart() : void
      {
         ...
         {
            ExternalInterface.call("flash_log","LoginAutostart: Host=" + this.FServerHost + ":" + this.FServerPort + " User=" + this.FOperatorUserID + " Token=" + this.FLoginToken);
         }
         this.LoginStart();
      }
      ...
      protected function ResourcesPerform_Wait() : void
      {
         if(ExternalInterface.available)
         {
            ExternalInterface.call("flash_log","ResourcesPerform_Wait: IsNewUser=" + SParametersCore.IsNewUser + " BinLoading=" + SResourcesCore.ResourceBin.Loading + " CommonLoading=" + SResourcesCore.TexturesSwfCommon.Loading + " GlobalPrimary=" + SResourcesCore.LoadingPrimary);
         }
      ...
      protected function ResourcesPerform_Dispatch() : void
      {
         if(ExternalInterface.available)
         {
            ExternalInterface.call("flash_log","ResourcesPerform_Dispatch: Calling LoginAutostart");
         }
      ...
      protected function LoginPerform_StatusServerConnect() : void
      {
         if(ExternalInterface.available)
         {
            ExternalInterface.call("flash_log","Connecting to StatusServer: " + this.FServerHost + ":" + this.FServerPort);
         }
      ...
      protected function LoginPerform_GateServerConnect() : void
      {
         if(ExternalInterface.available)
         {
            ExternalInterface.call("flash_log","Connecting to GateServer: " + this.FServerHost + ":" + this.FServerPort);
         }
      ...
      protected function PacketPerform_SC_StatusServerTransmitTokenRet(param1:TPacket) : void
      {
         ...
         if(ExternalInterface.available)
         {
            ExternalInterface.call("flash_log","StatusServerTransmitTokenRet: Dispatch to GateServer " + this.FServerHost + ":" + this.FServerPort);
         }
      }
