package Processors.Game.Lobby.Exercise.Dice
{
   ...
   public class TProcessorWindowDiceLog extends TProcessorLobbyWindow
   {
      ...
      protected static const SIZE_Window_Height:uint = 243;
      ...
      public function TProcessorWindowDiceLog(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance(CONST_DICE.RESOURCE_ClassName_GetLog) as MovieClip;
      ...
      protected function ResourcesPerform_UIDispatchLogList() : void
      {
         ...
         {
            _loc3_ = this.FMC_Scene[CONST_DICE.RESOURCE_Link_TF_Log + _loc1_];
      ...
      protected function UpdateLog() : void
      {
         ...
         var _loc3_:TextField = null;
         var _loc4_:int = 0;
         _loc4_ = int(this.FDice.DiceLogList.length);
         this.FUIPage.TotalQuantity = _loc4_;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < LOG_COUNT)
         {
            ...
            {
               _loc3_.visible = true;
               _loc3_.htmlText = this.MakeHtmlTextInfo(_loc4_ - _loc2_ - 1);
            }
            else
            {
      ...
      protected function MakeHtmlTextInfo(param1:int) : String
      {
         ...
         var _loc3_:TDiceLog = null;
         var _loc4_:TInventory = null;
         _loc3_ = this.FDice.DiceLogList[param1];
         _loc4_ = _loc3_.Inventories.GetInventoryByIndex(0);
         _loc2_ = STRING_DICE.FORMAT_News_When;
         _loc2_ = _loc2_.split("%when%").join(TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(_loc3_.GetTime) * 1000)));
         _loc2_ += STRING_DICE.FORMAT_News_Item[_loc4_.Quality];
         return _loc2_.split("%what%").join(_loc4_.Name + " x 1");
      }
