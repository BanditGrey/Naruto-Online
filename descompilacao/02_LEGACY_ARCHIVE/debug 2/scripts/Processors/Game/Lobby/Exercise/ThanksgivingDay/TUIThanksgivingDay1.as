package Processors.Game.Lobby.Exercise.ThanksgivingDay
{
   ...
   public class TUIThanksgivingDay1 extends TUIBaseWindow
   {
      ...
      protected var FThanksgivingDay1:TThanksgivingDay1;
      
      protected var FSIGNList:Vector.<TUIBaseBox>;
      
      protected var FRewardList:Vector.<TUIBaseBox>;
      
      public function TUIThanksgivingDay1(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateSign() : void
      {
         ...
         while(_loc1_ < SIGN_COUNT)
         {
            ...
            _loc3_ = this.FThanksgivingDay1.BoxList[_loc1_];
            ...
            {
               if(_loc3_.Identify != this.FThanksgivingDay1.CurIndex)
               {
                  _loc4_.SetMCIsVisible("MC_Effect",false);
                  _loc4_.SetMCIsVisible("MC_Fire",false);
               }
            ...
            if(_loc3_.Level > 0)
            {
               _loc4_.SetBuff(true,TUtilityString.Format(this.FThanksgivingDay1.DescListNew[9],_loc3_.Level));
            }
            else
            {
               _loc4_.SetBuff(false);
            }
            if(_loc1_ < this.FThanksgivingDay1.CurIndex)
            {
         ...
         while(_loc1_ < REWARD_COUNT)
         {
            ...
            _loc4_.SetVisible(true);
            _loc3_ = this.FThanksgivingDay1.RewardBoxList[_loc1_];
            _loc4_.UpdateUI(_loc3_.Inventories);
            _loc1_++;
         }
      }
      ...
      protected function UpdateBtn() : void
      {
         ...
         _loc2_ = this.FSIGNList[this.FThanksgivingDay1.CurIndex];
         _loc2_.SetMCIsVisible("MC_Fire",true);
         _loc1_ = this.FThanksgivingDay1.BoxList[this.FThanksgivingDay1.CurIndex];
         if(_loc1_.Status == TBaseActivity.STATUS_CANNOTGET)
         {
            this.FSIGNList[this.FThanksgivingDay1.CurIndex].SetMCIsVisible("MC_Effect",true);
         }
         else
         {
            this.FSIGNList[this.FThanksgivingDay1.CurIndex].SetMCIsVisible("MC_Effect",false);
         }
         if(this.FThanksgivingDay1.CanReturn == TBaseActivity.STATUS_CANNOTGET)
         {
      ...
      protected function UpdateText() : void
      {
         ...
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FThanksgivingDay1.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FThanksgivingDay1.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FThanksgivingDay1.DescListNew[0];
         FMC_Scene.TF_Desc1.text = TUtilityString.Format(this.FThanksgivingDay1.DescListNew[1],this.FThanksgivingDay1.GetSignedNum());
         FMC_Scene.TF_Desc2.text = TUtilityString.Format(this.FThanksgivingDay1.DescListNew[2],this.FThanksgivingDay1.NeedMoney,this.FThanksgivingDay1.GetMoney,this.FThanksgivingDay1.ContinueDays,this.FThanksgivingDay1.SendMailHour);
         FMC_Scene.TF_Desc3.text = TUtilityString.Format(this.FThanksgivingDay1.DescListNew[3]);
         FMC_Scene.TF_Desc4.text = TUtilityString.Format(this.FThanksgivingDay1.DescListNew[4],this.FThanksgivingDay1.GetMoney);
      }
      ...
      protected function ProcessorOnSignUp(param1:MouseEvent) : void
      {
         ...
         var _loc5_:TInventory = null;
         _loc2_ = this.FThanksgivingDay1.GetResidueBaseBox();
         if(_loc2_ == null)
         {
            if(FOnBuyBox != null)
            {
               FOnShowFlowText(this.FThanksgivingDay1.DescListNew[8]);
            }
         }
         else if(FOnBuyBox != null)
         {
            _loc5_ = _loc2_.Inventories.GetInventoryByIndex(0);
            _loc4_ = TUtilityString.Format(this.FThanksgivingDay1.DescListNew[7],_loc2_.ReturnMoney,_loc5_.Name,this.FThanksgivingDay1.GetResidue());
      ...
      protected function SlotsOnClick(param1:Object, param2:Object) : void
      {
         ...
         _loc4_ = this.FThanksgivingDay1.BoxList[this.FThanksgivingDay1.CurIndex];
         _loc3_ = _loc5_.RewardIndex;
         if(FOnGetBox != null && _loc4_.Status == TBaseActivity.STATUS_CANNOTGET && _loc3_ == this.FThanksgivingDay1.CurIndex)
         {
      ...
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FThanksgivingDay1) && this.FThanksgivingDay1.DescList.length >= 4)
         {
            FOnShowHtmlTip(this.FThanksgivingDay1.DescListNew[3]);
         }
      }
      ...
      {
         this.FThanksgivingDay1 = SLogicsCore.ThanksgivingDayDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TThanksgivingDay1;
         this.UpdateWindow();
      }
