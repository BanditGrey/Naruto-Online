package Processors.Game.Lobby.Exercise.HallowmasActive
{
   ...
   public class TUIHallowmasActive4 extends TUIBaseWindow
   {
      ...
      protected var FHallowmasActive4:THallowmasActive4;
      ...
      public function TUIHallowmasActive4(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function Resources_UIDispatch(param1:MovieClip) : void
      {
         ...
         if(!FMC_Scene || !FMC_Scene.MC_Point0)
         {
            return;
         }
         _loc2_ = 0;
      ...
      protected function UpdatePoint() : void
      {
         ...
         var _loc3_:int = 0;
         if(this.FHallowmasActive4.GameStatus == TBaseActivity.STATUS_CANNOTGET)
         {
         ...
         else
         {
            ...
            TGameUtil.setButtonMode(FMC_Scene.BTN_Auto,this.FHallowmasActive4.CheckStatus());
            _loc1_ = 0;
            while(_loc1_ < POINT_COUNT)
            {
               _loc2_ = FMC_Scene["MC_Point" + _loc1_];
               if(_loc1_ < this.FHallowmasActive4.PointList.length)
               {
                  _loc2_.visible = true;
                  _loc3_ = this.FHallowmasActive4.PointList[_loc1_];
                  if(_loc3_ == THallowmasActive4.TYPE_NONE)
                  {
                     _loc2_.gotoAndStop(1);
                  ...
                  else
                  {
                     ...
                     _loc2_.TF_Count.text = "*" + this.FHallowmasActive4.PointList[_loc1_];
                  }
               }
               else
               {
      ...
      protected function UpdateBox() : void
      {
         ...
         while(_loc3_ < GIFT_COUNT)
         {
            ...
            _loc2_ = this.FHallowmasActive4.Gift[_loc3_];
         ...
         this.FUIPage.TotalQuantity = this.FHallowmasActive4.RechargeList.length;
         this.FUIPage.Update();
         _loc3_ = 0;
         while(_loc3_ < RECHARGE_BOX_COUNT)
         {
            ...
            if(_loc4_ < this.FHallowmasActive4.RechargeList.length)
            {
               _loc1_.visible = true;
               _loc2_ = this.FHallowmasActive4.RechargeList[_loc4_];
               _loc1_.TF_Count.text = "*" + _loc2_.Inventories.GetInventoryByIndex(0).Quantity;
               _loc1_.TF_Price.text = TUtilityString.Format(this.FHallowmasActive4.DescListNew[5],_loc2_.Price);
      ...
      protected function UpdateHero() : void
      {
         ...
         _loc2_ = this.FHallowmasActive4.Hero;
         ...
         else if(this.FHallowmasActive4.ScoreB >= _loc2_.Price)
         {
      ...
      protected function UpdateExchange() : void
      {
         ...
         this.FUIPage1.TotalQuantity = this.FHallowmasActive4.ExchangeItems.length;
         this.FUIPage1.Update();
         _loc1_ = 0;
         while(_loc1_ < EXCHANGE_BOX_COUNT)
         {
            _loc3_ = _loc1_ + this.FCurPage1 * EXCHANGE_BOX_COUNT;
            if(_loc3_ < this.FHallowmasActive4.ExchangeItems.length)
            {
               this.FExchangeList[_loc1_].SetVisible(true);
               _loc5_ = this.FHallowmasActive4.ExchangeItems[_loc3_];
               ...
               if(this.FHallowmasActive4.ScoreB < _loc5_.Price)
               {
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FHallowmasActive4.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FHallowmasActive4.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Desc.text = this.FHallowmasActive4.DescListNew[1];
         FMC_Scene.TF_ScoreA.text = this.FHallowmasActive4.ScoreA.toString();
         FMC_Scene.TF_ScoreB.text = this.FHallowmasActive4.ScoreB.toString();
         FMC_Scene.TF_Desc1.text = this.FHallowmasActive4.DescListNew[2];
         FMC_Scene.TF_RechargeGold.text = TUtilityString.Format(this.FHallowmasActive4.DescListNew[8],this.FHallowmasActive4.RechargeGold);
      }
      ...
      protected function ProcessorOnStartUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null && !FIsPlaying && Boolean(this.FHallowmasActive4))
         {
            if(this.FHallowmasActive4.ScoreA > 0)
            {
               FOnGetBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_PLAY_GAME);
            }
            else
            {
               _loc2_ = TUtilityString.Format(this.FHallowmasActive4.DescListNew[3],this.FHallowmasActive4.ScorePrice);
               FOnBuyBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_PLAY_GAME,this.FHallowmasActive4.ScorePrice,0,0,_loc2_);
            }
         }
      }
      ...
      protected function ProcessorOnPointUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnBuyBox != null && !FIsPlaying) && Boolean(this.FHallowmasActive4) && this.FHallowmasActive4.PointList[_loc2_] == THallowmasActive4.TYPE_NONE)
         {
            FOnBuyBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_FIND_TEASURE,this.FHallowmasActive4.Price,_loc2_ + 1);
         }
      }
      ...
      protected function ProcessorOnAutoUp(param1:MouseEvent) : void
      {
         ...
         if(FOnBuyBox != null && !FIsPlaying && Boolean(this.FHallowmasActive4))
         {
            FOnBuyBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_AUTO_PLAY,this.FHallowmasActive4.AutoPrice);
         }
      }
      ...
      protected function ProcessorOnRechargeBoxUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null && !FIsPlaying) && Boolean(this.FHallowmasActive4) && this.FHallowmasActive4.RechargeList[_loc3_].Status == TBaseActivity.STATUS_CANGET)
         {
            FOnGetBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_GET_RECHARGE_BOX,_loc3_ + 1);
         }
      }
      ...
      protected function ProcessorOnGiftUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null && !FIsPlaying && this.FHallowmasActive4) && Boolean(_loc2_ < this.FHallowmasActive4.Gift.length) && this.FHallowmasActive4.Gift[_loc2_].Count > 0)
         {
            FOnGetBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_GET_GIFT,_loc2_ + 1);
         }
      }
      ...
      protected function ProcessorOnExchangeHeroUp(param1:MouseEvent) : void
      {
         ...
         if(!FIsPlaying && FOnGetBox != null && Boolean(this.FHallowmasActive4))
         {
            _loc2_ = this.FHallowmasActive4.Hero;
            if(_loc2_.Status != TBaseActivity.STATUS_GETED && this.FHallowmasActive4.ScoreB >= _loc2_.Price)
            {
               FOnGetBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_EXCHANGE_HERO);
            }
         }
      }
      ...
      protected function ProcessorOnExchangeUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(!FIsPlaying && FOnGetBox != null && this.FHallowmasActive4 && _loc3_ < this.FHallowmasActive4.ExchangeItems.length) && Boolean(this.FHallowmasActive4.ExchangeItems[_loc3_].LimitCount > 0) && this.FHallowmasActive4.ScoreB >= this.FHallowmasActive4.ExchangeItems[_loc3_].Price)
         {
            FOnGetBox(ACTIVITY_4_ID,TProcessorHallowmasActive.ACTIVITY_4_EXCHANGE_ITEM,_loc3_ + 1);
         }
      }
      ...
      protected function ProcessorOnPointOver(param1:MouseEvent) : void
      {
         var _loc2_:int = 0;
         _loc2_ = int(String(param1.currentTarget.name).slice(8));
         if(Boolean(this.FHallowmasActive4) && Boolean(_loc2_ < this.FHallowmasActive4.PointList.length) && this.FHallowmasActive4.PointList[_loc2_] == THallowmasActive4.TYPE_NONE)
         {
      ...
      protected function ProcessorOnRechargeBoxOver(param1:MouseEvent) : void
      {
         ...
         _loc2_ = int(String(param1.currentTarget.name).slice(6));
         _loc3_ = _loc2_ + this.FCurPage * RECHARGE_BOX_COUNT;
         if(FOnGetBox != null && Boolean(this.FHallowmasActive4))
         {
            FOnNewBoxOver(this.FHallowmasActive4.RechargeList[_loc3_].Inventories);
         }
      }
      ...
      protected function ProcessorOnGiftOver(param1:MouseEvent) : void
      {
         var _loc2_:int = 0;
         _loc2_ = int(String(param1.currentTarget.parent.name).slice(7));
         if(Boolean(FOnNewBoxOver != null && !FIsPlaying) && Boolean(this.FHallowmasActive4) && _loc2_ < this.FHallowmasActive4.Gift.length)
         {
            FOnNewBoxOver(this.FHallowmasActive4.Gift[_loc2_].Inventories);
         }
      }
      
      protected function ProcessorOnTip0Over(param1:MouseEvent) : void
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FHallowmasActive4) && this.FHallowmasActive4.DescList.length > 9)
         {
            FOnShowHtmlTip(this.FHallowmasActive4.DescListNew[9]);
         }
      }
      
      protected function ProcessorOnTip1Over(param1:MouseEvent) : void
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FHallowmasActive4) && this.FHallowmasActive4.DescList.length > 10)
         {
            FOnShowHtmlTip(this.FHallowmasActive4.DescListNew[10]);
         }
      }
      
      protected function ProcessorOnAutoOver(param1:MouseEvent) : void
      {
         if(Boolean(FOnShowHtmlTip != null) && Boolean(this.FHallowmasActive4) && this.FHallowmasActive4.DescList.length > 11)
         {
            FOnShowHtmlTip(this.FHallowmasActive4.DescListNew[11]);
         }
      }
      ...
      {
         var _loc2_:TBaseBox = null;
         if(Boolean(FOnShowRecruit != null) && Boolean(this.FHallowmasActive4) && Boolean(this.FHallowmasActive4.Hero))
         {
            _loc2_ = this.FHallowmasActive4.Hero;
      ...
      {
         if(FOnShowHtmlTip != null && Boolean(this.FHallowmasActive4))
         {
            FOnShowHtmlTip(this.FHallowmasActive4.DescListNew[4]);
         }
      }
      ...
      {
         this.FHallowmasActive4 = SLogicsCore.HallowmasActiveDatas.GetActivityByIdentify(ACTIVITY_4_ID) as THallowmasActive4;
         this.UpdatePoint();
         this.UpdateBox();
         this.UpdateHero();
         this.UpdateExchange();
      ...
      override public function MovieEnd() : void
      {
         ...
         if(this.FMovieType == MOVIE_OF_PLAY_GAME)
         {
            if(this.FHallowmasActive4.PointList[this.FOpenIndex] == THallowmasActive4.TYPE_BOMB)
            {
               this.PlayMovie(MOVIE_OF_BOMB);
            }
            else if(this.FHallowmasActive4.GameStatus == TBaseActivity.STATUS_CANNOTGET)
            {
               FMC_Scene["MC_Point" + this.FOpenIndex].gotoAndStop(3);
               FMC_Scene["MC_Point" + this.FOpenIndex].TF_Count.text = "*" + this.FHallowmasActive4.PointList[_loc1_];
               _loc1_ = 0;
               while(_loc1_ < this.FHallowmasActive4.PointList.length)
               {
                  this.FHallowmasActive4.PointList[_loc1_] = THallowmasActive4.TYPE_NONE;
                  _loc1_++;
               }
         ...
         else if(this.FMovieType == MOVIE_OF_AUTO)
         {
            ...
            while(_loc1_ < this.FHallowmasActive4.PointList.length)
            {
               ...
               if(this.FHallowmasActive4.PointList[_loc1_] == THallowmasActive4.TYPE_BOMB)
               {
               ...
               else
               {
                  ...
                  FMC_Scene["MC_Point" + _loc1_].TF_Count.text = "*" + this.FHallowmasActive4.PointList[_loc1_];
               }
               _loc1_++;
            }
            this.PlayMovie(MOVIE_OF_SUCCESS);
