package Processors.Game.Lobby.Exercise.WitchProving
{
   ...
   public class TprocessorWitchProvingShop extends TProcessorLobbyWindow
   {
      ...
      public function TprocessorWitchProvingShop(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550137175);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_WitchProvingShop") as MovieClip;
