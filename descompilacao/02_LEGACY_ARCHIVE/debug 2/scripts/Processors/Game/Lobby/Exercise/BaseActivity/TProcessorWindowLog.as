package Processors.Game.Lobby.Exercise.BaseActivity
{
   ...
   public class TProcessorWindowLog extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorWindowLog(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_BaseActiveLog") as Sprite;
      ...
      protected function UpdateLog() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:TextField = null;
         this.FUIPage.TotalQuantity = this.FBaseActivity.LogList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < LOG_COUNT)
         {
            ...
            if(_loc2_ < this.FBaseActivity.LogList.length)
            {
               _loc3_.visible = true;
               _loc3_.htmlText = this.MakeHtmlTextInfo(this.FBaseActivity.LogList.length - _loc2_ - 1);
            }
            else
            {
      ...
      protected function MakeHtmlTextInfo(param1:int) : String
      {
         ...
         _loc4_ = this.FBaseActivity.LogList[param1];
