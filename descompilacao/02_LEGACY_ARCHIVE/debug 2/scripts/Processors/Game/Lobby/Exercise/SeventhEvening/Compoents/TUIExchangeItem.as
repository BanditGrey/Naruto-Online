package Processors.Game.Lobby.Exercise.SeventhEvening.Compoents
{
   ...
   public class TUIExchangeItem extends TUIComponent
   {
      ...
      protected function UIDispatch() : void
      {
         ...
         this.FBtn_Exchange = this.FMC_Item["BTN_Exchange"];
         this.FMC_Slot.Resource = this.FMC_Item["MC_Slot"];
         ...
         this.FMC_Slot.Init();
         this.FTF_Price = this.FMC_Item["TF_Price"];
      }
      ...
      {
         var _loc1_:TExchangeItem = null;
         _loc1_ = this.FSeventhEvening.ExchangeItemList[this.FIndex];
         if(!_loc1_)
         {
            return;
         }
         if(this.FSeventhEvening.Magpie >= _loc1_.CostPoint)
         {
            if(_loc1_.BuyCount < _loc1_.LimitCount)
            {
         ...
         this.FTF_Price.text = _loc1_.CostPoint.toString();
      }
      
      protected function UpdateSlotInfo() : void
      {
         this.FMC_Slot.Context = this.FInventory;
      }
      ...
      protected function ExchangeOnClick(param1:MouseEvent) : void
      {
         ...
         {
            this.FOnExchange(this.FIndex);
         }
      }
      
      protected function ExchangeOnOver(param1:MouseEvent) : void
      {
         var _loc2_:TExchangeItem = null;
         _loc2_ = this.FSeventhEvening.ExchangeItemList[this.FIndex];
         if(!_loc2_)
         {
            return;
         }
         this.FHintBoxTip.Caption = TUtilityString.Format(STRING_SEVENTHEVENING.FORMAT_EXCHANGE_TIMES,_loc2_.LimitCount - _loc2_.BuyCount,_loc2_.LimitCount);
      ...
      public function SetItemInfo(param1:TInventory) : void
      {
         this.FInventory = param1;
         this.UpdateItemInfo();
         this.UpdateSlotInfo();
