package Processors.Game.Lobby.Exercise.BaseActivity
{
   ...
   public class TProcessorWindowRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorWindowRank(param1:TUIComponent, param2:String = "MC_MayActiveRank")
      {
         super(param1);
         this.FResourceName = param2;
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance(this.FResourceName) as MovieClip;
      ...
      {
         if(this.FBaseActivity.CurMyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FBaseActivity.CurMyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FBaseActivity.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FBaseActivity.RankGiftList.length)
            {
               _loc4_ = this.FBaseActivity.RankGiftList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FBaseActivity.RankPlayerList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FBaseActivity.RankPlayerList.length)
            {
               _loc8_ = this.FBaseActivity.RankPlayerList[_loc2_];
               if(this.FCurPage == 0)
               {
