package Processors.Game.Lobby.Exercise.DecActive
{
   ...
   public class TProcessorDecActiveLotteryLog extends TProcessorLobbyWindow
   {
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_DecActive2Log") as MovieClip;
      ...
      protected function UpdatePage() : void
      {
         ...
         this.FUIPage0.TotalQuantity = this.FDecActive2.LotteryLogs.length;
         ...
         while(_loc1_ < PAGE_COUNT)
         {
            ...
            if(_loc4_ < this.FDecActive2.LotteryLogs.length)
            {
               _loc5_.visible = true;
               _loc6_ = this.FDecActive2.LotteryLogs[_loc4_];
               ...
               {
                  _loc7_ = this.FDecActive2.DescListNew[11];
               }
      ...
      protected function ProcessorOnClose(param1:MouseEvent) : void
      {
         ...
         {
            this.FOnCloseUp(TProcessorDecActive.WINDOW_LOTTERY_LOG);
         }
      }
