package Processors.Game.Lobby.Exercise.JuneActive
{
   ...
   public class TProcessorJuneActiveRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorJuneActiveRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550136854);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_JuneActiveRank") as MovieClip;
      ...
      {
         if(this.FJuneActive3.MyRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FJuneActive3.MyRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FJuneActive3.RankPoint.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FJuneActive3.RankRewardList.length)
            {
               _loc4_ = this.FJuneActive3.RankRewardList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FJuneActive3.RankList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FJuneActive3.RankList.length)
            {
               _loc8_ = this.FJuneActive3.RankList[_loc2_];
               if(this.FCurPage == 0)
               {
