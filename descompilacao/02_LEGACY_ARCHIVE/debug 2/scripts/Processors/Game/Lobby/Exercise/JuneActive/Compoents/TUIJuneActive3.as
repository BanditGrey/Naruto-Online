package Processors.Game.Lobby.Exercise.JuneActive.Compoents
{
   ...
   public class TUIJuneActive3 extends TUIBaseWindow
   {
      ...
      protected var FJuneActive3:TJuneActive3;
      
      protected var FTextFormat:TextFormat;
      
      public function TUIJuneActive3(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateBox() : void
      {
         ...
         while(_loc1_ < BOX_COUNT)
         {
            ...
            if(_loc1_ < this.FJuneActive3.BoxList.length)
            {
               _loc4_ = this.FJuneActive3.BoxList[_loc1_];
               _loc5_ = this.FJuneActive3.BoxList[this.FJuneActive3.BoxList.length - 1];
               _loc3_.MC_Count.TF_Count.text = "*" + (_loc4_.Price + (this.FJuneActive3.Round - 1) * _loc5_.Price);
      ...
      protected function UpdateHero() : void
      {
         ...
         while(_loc1_ < HERO_COUNT)
         {
            ...
            if(_loc1_ < this.FJuneActive3.HeroList.length)
            {
               _loc4_ = this.FJuneActive3.HeroList[_loc1_];
      ...
      {
         var _loc1_:int = 0;
         if(Boolean(this.FJuneActive3) && Boolean(this.FJuneActive3.HeroList.length > 0) && Boolean(this.FHeroList[0]))
         {
            _loc1_ = 0;
            while(_loc1_ < HERO_COUNT)
            {
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FJuneActive3.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FJuneActive3.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Times.text = TUtilityString.Format(STRING_BASEACTIVITY.FORMAT_AMOUNT,this.FJuneActive3.Count);
         FMC_Scene.TF_Count.text = "*" + this.FJuneActive3.RankPoint;
         FMC_Scene.TF_Desc.text = this.FJuneActive3.ActivityName;
      }
      ...
      protected function ProcessorOnClickTaiko(param1:MouseEvent) : void
      {
         ...
         if(FOnBuyBox != null && Boolean(this.FJuneActive3))
         {
            if(this.FJuneActive3.Count > 0)
            {
               FOnBuyBox(ACTIVITY_3_ID,TProcessorJuneActive.ACTIVITY_3_BUY_BOX,this.FJuneActive3.Cost,0,TBaseActivity.SWEET_TYPE_FREE);
            }
            else
            {
               FOnBuyBox(ACTIVITY_3_ID,TProcessorJuneActive.ACTIVITY_3_BUY_BOX,this.FJuneActive3.Cost,0,TBaseActivity.SWEET_TYPE_GOLD);
            }
         }
      }
      ...
      protected function ProcessorOnTaikoOver(param1:MouseEvent) : void
      {
         ...
         {
            FOnShowHtmlTip(this.FJuneActive3.ActivityDesc2);
         }
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FJuneActive3) && _loc2_ < this.FJuneActive3.BoxList.length)
         {
            if(this.FJuneActive3.BoxList[_loc2_].Status == TBaseActivity.STATUS_CANGET)
            {
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnItemOver != null) && Boolean(this.FJuneActive3) && _loc3_ < this.FJuneActive3.BoxList.length)
         {
            _loc2_ = this.FJuneActive3.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      override protected function ProcessorOnBoxOut(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = int(String(param1.currentTarget.name).slice(6));
         if(Boolean(FOnItemOut != null) && Boolean(this.FJuneActive3) && _loc3_ < this.FJuneActive3.BoxList.length)
         {
            _loc2_ = this.FJuneActive3.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      protected function ProcessorOnGetHeroUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnGetBox != null) && Boolean(this.FJuneActive3) && _loc2_ < this.FJuneActive3.HeroList.length)
         {
            if(this.FJuneActive3.HeroList[_loc2_].Status == TBaseActivity.STATUS_CANGET)
            {
      ...
      protected function ProcessorOnHeroUp(param1:MouseEvent) : void
      {
         ...
         if(Boolean(FOnShowRecruit != null) && Boolean(this.FJuneActive3) && _loc3_ < this.FJuneActive3.HeroList.length)
         {
            _loc2_ = uint(this.FJuneActive3.HeroList[_loc3_].Identify);
            FOnShowRecruit(_loc2_,this.FJuneActive3.HeroList[_loc3_].Type);
         }
      }
      ...
      protected function ProcessorOnHeroOver(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = int(String(param1.currentTarget.parent.name).slice(7));
         if(Boolean(FOnShowHeroTip != null) && Boolean(this.FJuneActive3) && _loc3_ < this.FJuneActive3.HeroList.length)
         {
            this.FHeroList[_loc3_].MC_Hero.filters = [TGameUtil.highLightFilters];
            _loc2_ = this.FJuneActive3.HeroList[_loc3_];
      ...
      {
         this.FJuneActive3 = SLogicsCore.JuneActiveDatas.GetActivityByIdentify(ACTIVITY_3_ID) as TJuneActive3;
         this.UpdateBox();
         this.UpdateHero();
         this.UpdateText();
      }
