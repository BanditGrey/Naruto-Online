package Processors.Game.Lobby.Exercise.Christmas.Compoents
{
   ...
   public class TUIChristmasRank extends TUIChristmasBase
   {
      ...
      protected static const ACTIVITY_4_ID:int = TProcessorChristmas.ACTIVITY_4_ID;
      
      protected var FBoxList:Vector.<MovieClip>;
      
      protected var FHeroList:Vector.<MovieClip>;
      
      protected var FChristmasRank:TChristmasRank;
      
      public function TUIChristmasRank(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateBox() : void
      {
         ...
         while(_loc1_ < BOX_COUNT)
         {
            ...
            if(this.FChristmasRank.BoxList[_loc1_])
            {
               _loc3_.TF_Count.text = "*" + this.FChristmasRank.BoxList[_loc1_].Price;
               _loc3_.MC_BoxPic.MC_Icon.gotoAndStop(_loc1_ + 1);
               if(this.FChristmasRank.BoxList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
               {
                  _loc3_.MC_CanGet.visible = true;
                  _loc3_.MC_BoxPic.gotoAndPlay(1);
               }
               else if(this.FChristmasRank.BoxList[_loc1_].Status == TBaseActivity.STATUS_CANNOTGET)
               {
      ...
      protected function UpdateHero() : void
      {
         ...
         while(_loc1_ < HERO_COUNT)
         {
            ...
            if(this.FChristmasRank.HeroList[_loc1_].Status == TBaseActivity.STATUS_CANGET)
            {
               _loc3_.MC_Got.visible = false;
               _loc3_.Btn_Get.visible = true;
            }
            else if(this.FChristmasRank.HeroList[_loc1_].Status == TBaseActivity.STATUS_CANNOTGET)
            {
               _loc3_.MC_Got.visible = false;
      ...
      {
         FMC_Scene.TF_Date.text = TUtilityString.Format(STRING_BASEACTIVITY.FormatString_ActivityTimeStartToEnd,TUtilityDate.FormatDateChineseNew(new Date(STimingCore.GetClientShowTime(this.FChristmasRank.BeginTime) * 1000)),TUtilityDate.FormatDateChineseNew(new Date((STimingCore.GetClientShowTime(this.FChristmasRank.EndTime) - 1) * 1000)));
         FMC_Scene.TF_Count.text = "*" + this.FChristmasRank.Score.toString();
      }
      ...
      override protected function ProcessorOnGetBoxUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null)
         {
            ...
            if(this.FChristmasRank.BoxList[_loc2_].Status == TBaseActivity.STATUS_CANGET)
            {
               FOnGetBox(ACTIVITY_4_ID,TProcessorChristmas.CHRISTMAS_RANK_GET_BOX,_loc2_ + 1);
            }
         }
      }
      ...
      override protected function ProcessorOnBoxOver(param1:MouseEvent) : void
      {
         ...
         if(FOnItemOver != null && Boolean(this.FChristmasRank.BoxList[_loc3_]))
         {
            _loc2_ = this.FChristmasRank.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      override protected function ProcessorOnBoxOut(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = int(String(param1.currentTarget.name).slice(6));
         if(FOnItemOut != null && this.FChristmasRank.BoxList[_loc3_].Inventories.Count > 0)
         {
            _loc2_ = this.FChristmasRank.BoxList[_loc3_].Inventories.GetInventoryByIndex(0);
      ...
      protected function ProcessorOnGetHeroUp(param1:MouseEvent) : void
      {
         ...
         if(FOnGetBox != null)
         {
            ...
            if(this.FChristmasRank.HeroList[_loc2_].Status == TBaseActivity.STATUS_CANGET)
            {
               FOnGetBox(ACTIVITY_4_ID,TProcessorChristmas.CHRISTMAS_RANK_GET_HERO);
            }
         }
      }
      ...
      protected function ProcessorOnHeroUp(param1:MouseEvent) : void
      {
         ...
         if(FOnShowRecruit != null)
         {
            ...
            _loc2_ = uint(this.FChristmasRank.HeroList[_loc3_].Identify);
      ...
      protected function ProcessorOnHeroOver(param1:MouseEvent) : void
      {
         ...
         {
            _loc3_ = int(String(param1.currentTarget.parent.name).slice(7));
            if(this.FChristmasRank.HeroList[_loc3_])
            {
               this.FHeroList[_loc3_].MC_Hero.filters = [TGameUtil.highLightFilters];
               _loc2_ = this.FChristmasRank.HeroList[_loc3_];
      ...
      {
         this.FChristmasRank = SLogicsCore.ChristmasDatas.GetActivityByIdentify(ACTIVITY_4_ID) as TChristmasRank;
         this.UpdateBox();
         this.UpdateHero();
         this.UpdateText();
      }
