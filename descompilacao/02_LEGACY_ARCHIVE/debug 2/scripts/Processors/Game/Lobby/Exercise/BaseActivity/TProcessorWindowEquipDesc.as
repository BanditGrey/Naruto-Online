package Processors.Game.Lobby.Exercise.BaseActivity
{
   ...
   public class TProcessorWindowEquipDesc extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorWindowEquipDesc(param1:TUIComponent)
      {
         super(param1);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_BaseActiveEquipDesc") as MovieClip;
