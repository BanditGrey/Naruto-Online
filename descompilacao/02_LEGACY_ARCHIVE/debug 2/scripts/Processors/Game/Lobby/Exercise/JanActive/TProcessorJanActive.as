package Processors.Game.Lobby.Exercise.JanActive
{
   ...
   import Logics.Exercise.JanActive.TJanActive1;
   ...
   import Logics.Streamization.Exercise.TUnstreamizerJanActive;
   ...
   public class TProcessorJanActive extends TProcessorBaseActivity
   {
      ...
      public static const ACTIVITY_1_BREAK_ICE:int = 1;
      
      public static const ACTIVITY_1_AUTO_GAME:int = 2;
      
      public static const ACTIVITY_1_EXCHANGE_ITEM:int = 3;
      
      public static const ACTIVITY_1_GET_REWARD:int = 4;
      
      public static const ACTIVITY_1_GET_SOUL:int = 5;
      
      public static const ACTIVITY_1_GET_TASK:int = 6;
      
      public static const ACTIVITY_1_FINISH_TASK:int = 7;
      
      public static const ACTIVITY_1_GET_GIFT:int = 8;
      
      public static const ACTIVITY_2_FIND_TEASURE:int = 1;
      
      public static const ACTIVITY_2_GET_RECHARGE_BOX:int = 2;
      
      public static const ACTIVITY_2_EXCHANGE_ITEM:int = 3;
      
      public static const ACTIVITY_2_GET_GIFT:int = 4;
      
      public static const ACTIVITY_2_AUTO_PLAY:int = 5;
      
      public static const ACTIVITY_2_PLAY_GAME:int = 6;
      ...
      protected var ACTIVITY_REFERENCE:Vector.<Class> = Vector.<Class>([TUIJanActive1,TUIJanActive2]);
      ...
      protected var FUnstreamizerJanActive:TUnstreamizerJanActive;
      ...
      public function TProcessorJanActive(param1:TUIComponent, param2:TLobbyParameters, param3:uint)
      {
         super(param1,param2,param3);
         FActivityID = param3;
         this.FJanActiveDatas = SLogicsCore.JanActiveDatas;
         this.FActivityTaskData = SLogicsCore.ActivityTaskData;
         this.FUnstreamizerJanActive = new TUnstreamizerJanActive(param3);
      ...
      override protected function UpdateUI() : void
      {
         ...
         while(_loc1_ < this.TAB_COUNT)
         {
            ...
            _loc3_ = this.FJanActiveDatas.GetActivityByIndex(_loc1_);
            ...
            if(this.FJanActiveDatas.Activities[_loc1_].NeedShine == TBaseActivity.STATUS_CANGET)
            {
      ...
      protected function ProcessorOnChangePage(param1:MouseEvent) : void
      {
         ...
         _loc3_ = this.FJanActiveDatas.GetActivityByIndex(_loc2_);
      ...
      {
         FProcessorWindowDesc.BaseActivity = this.FJanActiveDatas.GetActivityByIndex(this.FChangeTabIndex);
      ...
      {
         ProcessorOnLoadActiveRank(this.FChangeTabIndex + 1,param1);
      }
      ...
      protected function ProcessorOnShowWindow(param1:int) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:TJanActive1 = null;
         var _loc5_:TJanActive2 = null;
         this.FWindowType = param1;
         switch(param1)
         {
            case WINDOW_EQUIPMENT_DESC:
               _loc4_ = this.FJanActiveDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TJanActive1;
      ...
      override public function ProcessorOnLoadInfoRet(param1:TPacket = null) : void
      {
         ...
         this.FUnstreamizerJanActive.Unstreamize(_loc2_,this.FJanActiveDatas,null);
      ...
      override public function ProcessorActivityThirdLoadLogRet(param1:TPacket = null) : void
      {
         ...
         _loc5_ = this.FJanActiveDatas.GetActivityByIdentify(_loc4_) as TBaseActivity;
      ...
      override public function ProcessorChangeGold(param1:TPacket = null) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:TJanActive1 = null;
         var _loc10_:TJanActive2 = null;
         _loc2_ = param1.Data;
         _loc2_.readShort();
         ...
         {
            case ACTIVITY_1_ID:
               _loc9_ = this.FJanActiveDatas.GetActivityByIdentify(_loc6_) as TJanActive1;
               if(_loc9_)
               {
                  if(this.FIsOpen)
                  {
               ...
               break;
            case ACTIVITY_2_ID:
               _loc10_ = this.FJanActiveDatas.GetActivityByIdentify(_loc6_) as TJanActive2;
               if(_loc10_)
               {
      ...
      override public function ProcessorAllRet(param1:TPacket = null) : void
      {
         ...
         var _loc24_:TJanActive1 = null;
         var _loc25_:TJanActive2 = null;
         var _loc26_:int = 0;
         var _loc27_:int = 0;
         var _loc28_:int = 0;
         var _loc29_:int = 0;
         ...
         {
            case ACTIVITY_1_ID:
               _loc24_ = this.FJanActiveDatas.GetActivityByIdentify(ACTIVITY_1_ID) as TJanActive1;
               if(_loc10_ == ACTIVITY_1_GET_TASK)
               {
                  ...
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FJanActiveDatas.CheckStatus());
                  this.UpdateUI();
               }
               ...
               else if(_loc10_ == ACTIVITY_1_BREAK_ICE)
               {
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc14_ = int(_loc2_.readUnsignedInt());
                  _loc24_.IceList[_loc5_] = _loc14_;
                  _loc24_.ScoreA = _loc2_.readUnsignedInt();
                  _loc24_.ScoreB = _loc2_.readUnsignedInt();
                  ++_loc24_.IceIndex;
                  _loc6_ = 0;
                  while(_loc6_ < _loc24_.TreeList.length)
                  {
                     _loc24_.TreeList[_loc6_].Status = _loc2_.readInt();
                     _loc6_++;
                  }
                  _loc24_.ConsumeScore += _loc2_.readUnsignedInt();
                  _loc24_.Gift.Count = _loc2_.readUnsignedInt();
                  this.FUIWindowVect[0].FlowStr = TUtilityString.Format(_loc24_.DescListNew[6],_loc14_);
                  _loc24_.FirstPlay = 1;
                  this.FUIWindowVect[0].SetMovieParam(_loc5_);
                  this.FUIWindowVect[0].PlayMovie(TUIJanActive1.MOVIE_OF_PLAY_GAME);
                  _loc24_.ChangeStatus();
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FJanActiveDatas.CheckStatus());
               }
               ...
               {
                  _loc18_ = _loc24_.MaxCount;
                  _loc14_ = 0;
                  _loc6_ = 0;
                  while(_loc6_ < _loc18_)
                  {
                     _loc5_ = _loc2_.readUnsignedInt() - 1;
                     _loc24_.IceList[_loc5_] = _loc2_.readUnsignedInt();
                     _loc6_++;
                  }
                  _loc24_.ScoreA = _loc2_.readUnsignedInt();
                  _loc14_ = int(_loc2_.readUnsignedInt());
                  _loc24_.ScoreB += _loc14_;
                  _loc24_.IceIndex = _loc24_.MaxCount + 1;
                  _loc6_ = 0;
                  while(_loc6_ < _loc24_.TreeList.length)
                  {
                     _loc24_.TreeList[_loc6_].Status = _loc2_.readUnsignedInt();
                     _loc6_++;
                  }
                  _loc24_.ConsumeScore += _loc2_.readUnsignedInt();
                  _loc24_.Gift.Count = _loc2_.readUnsignedInt();
                  this.FUIWindowVect[0].FlowStr = TUtilityString.Format(_loc24_.DescListNew[6],_loc14_);
                  this.FUIWindowVect[0].PlayMovie(TUIJanActive1.MOVIE_OF_AUTO);
                  _loc24_.ChangeStatus();
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FJanActiveDatas.CheckStatus());
               }
               else if(_loc10_ == ACTIVITY_1_GET_SOUL)
               {
                  ...
                  _loc24_.RankPoint += _loc14_;
                  _loc24_.ShopExchangePoint += _loc14_;
                  _loc24_.AllIceList.length = 0;
                  _loc6_ = 0;
                  while(_loc6_ < 16)
                  {
                     _loc24_.AllIceList[_loc6_] = _loc2_.readUnsignedInt();
                     _loc6_++;
                  }
                  _loc4_ = TUtilityString.Format(_loc24_.DescListNew[7],_loc14_);
                  ProcessorEffectText(_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc24_.TreeList.length)
                  {
                     _loc24_.TreeList[_loc6_].Status = TBaseActivity.STATUS_CANNOTGET;
                     _loc6_++;
                  }
                  this.FUIWindowVect[0].PlayMovie(TUIJanActive1.MOVIE_OF_FLOW_1);
                  _loc24_.ChangeStatus();
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_1_ID);
                  ProcessorCheckEffect(FActivityID,this.FJanActiveDatas.CheckStatus());
               }
               ...
               else if(_loc10_ == ACTIVITY_1_GET_REWARD)
               {
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc24_.ShopRewardItems[_loc5_].Status = TBaseActivity.STATUS_GETED;
               ...
               break;
            case ACTIVITY_2_ID:
               _loc25_ = this.FJanActiveDatas.GetActivityByIdentify(ACTIVITY_2_ID) as TJanActive2;
               if(_loc10_ == ACTIVITY_2_PLAY_GAME)
               {
                  ...
                  _loc25_.GameStatus = TBaseActivity.STATUS_CANGET;
                  _loc25_.ChangeStatus();
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_2_ID);
                  ProcessorCheckEffect(FActivityID,this.FJanActiveDatas.CheckStatus());
                  this.UpdateUI();
               }
               else if(_loc10_ == ACTIVITY_2_FIND_TEASURE)
               {
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc25_.PointList[_loc5_] = _loc2_.readInt();
                  _loc25_.GameStatus = _loc2_.readInt();
                  _loc14_ = int(_loc2_.readUnsignedInt());
                  _loc25_.ScoreB += _loc14_;
                  _loc6_ = 0;
                  while(_loc6_ < _loc25_.Gift.length)
                  {
                     _loc25_.Gift[_loc6_].Count = _loc2_.readUnsignedInt();
                     _loc6_++;
                  }
                  if(_loc25_.PointList[_loc5_] == TJanActive2.TYPE_BOMB)
                  {
                     _loc4_ = _loc25_.DescListNew[7];
                  }
                  else
                  {
                     _loc4_ = TUtilityString.Format(_loc25_.DescListNew[6],_loc14_);
                  }
                  ProcessorEffectText(_loc4_);
                  _loc25_.ChangeStatus();
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_2_ID);
                  ...
                  this.FUIWindowVect[1].PlayMovie(TUIJanActive2.MOVIE_OF_PLAY_GAME);
               }
               else if(_loc10_ == ACTIVITY_2_GET_RECHARGE_BOX)
               {
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc25_.ScoreB = _loc2_.readUnsignedInt();
                  _loc25_.RechargeList[_loc5_].Status = TBaseActivity.STATUS_GETED;
                  _loc4_ = STRING_BASEACTIVITY.FORMAT_GET_SUCCESSED;
                  _loc6_ = 0;
                  while(_loc6_ < _loc25_.RechargeList[_loc5_].Inventories.Count)
                  {
                     _loc9_ = _loc25_.RechargeList[_loc5_].Inventories.GetInventoryByIndex(_loc6_);
                     _loc4_ += _loc9_.Name + "*" + _loc9_.Quantity + "\n";
                     _loc6_++;
                  }
                  _loc25_.ChangeStatus();
               ...
               else if(_loc10_ == ACTIVITY_2_EXCHANGE_HERO)
               {
                  ...
                  _loc25_.ScoreB -= _loc25_.Hero.Price;
                  _loc4_ = STRING_BASEACTIVITY.FORMAT_EXCHANGE;
                  ProcessorEffectText(_loc4_);
                  _loc25_.ChangeStatus();
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_2_ID);
               ...
               else if(_loc10_ == ACTIVITY_2_EXCHANGE_ITEM)
               {
                  ...
                  _loc25_.ScoreB -= _loc25_.ExchangeItems[_loc5_].Price;
                  _loc4_ = STRING_BASEACTIVITY.FORMAT_EXCHANGE;
                  ProcessorEffectText(_loc4_);
                  _loc25_.ChangeStatus();
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_2_ID);
               ...
               {
                  _loc5_ = _loc2_.readUnsignedInt() - 1;
                  _loc25_.Gift[_loc5_].Count = _loc2_.readUnsignedInt();
                  _loc4_ = STRING_BASEACTIVITY.FORMAT_GET_SUCCESSED;
                  _loc6_ = 0;
                  while(_loc6_ < _loc25_.Gift[_loc5_].Inventories.Count)
                  {
                     _loc9_ = _loc25_.Gift[_loc5_].Inventories.GetInventoryByIndex(_loc6_);
                     _loc4_ += _loc9_.Name + "*" + _loc9_.Quantity + "\n";
                     _loc6_++;
                  }
                  _loc25_.ScoreB = _loc2_.readUnsignedInt();
               ...
               else if(_loc10_ == ACTIVITY_2_AUTO_PLAY)
               {
                  _loc14_ = int(_loc2_.readUnsignedInt());
                  _loc25_.ScoreB += _loc14_;
                  _loc6_ = 0;
                  while(_loc6_ < _loc25_.PointList.length)
                  {
                     _loc25_.PointList[_loc6_] = _loc2_.readInt();
                     _loc6_++;
                  }
                  _loc25_.GameStatus = TBaseActivity.STATUS_CANNOTGET;
                  _loc6_ = 0;
                  while(_loc6_ < _loc25_.Gift.length)
                  {
                     _loc25_.Gift[_loc6_].Count = _loc2_.readUnsignedInt();
                  ...
                  this.FJanActiveDatas.ChangeSingleActivityStatus(ACTIVITY_2_ID);
                  ProcessorCheckEffect(FActivityID,this.FJanActiveDatas.CheckStatus());
                  this.FUIWindowVect[1].FlowStr = TUtilityString.Format(_loc25_.DescListNew[6],_loc14_);
                  this.FUIWindowVect[1].PlayMovie(TUIJanActive2.MOVIE_OF_AUTO);
               }
         }
      }
      ...
      public function TestInit0() : ByteArray
      {
         ...
         TUtilityString.FlushUTF(_loc3_,"砸碎当前冰块需要%0个冰铲");
         TUtilityString.FlushUTF(_loc3_,"当前冰块消耗%0个冰铲，是否花费%1金币补齐不足的%2个冰铲？");
         TUtilityString.FlushUTF(_loc3_,"自动游戏消耗%0个冰铲，是否花费%1金币补齐不足的%2个冰铲？");
         TUtilityString.FlushUTF(_loc3_,"你挖到了%0个冰元素");
         TUtilityString.FlushUTF(_loc3_,"你收获了%0个冰魄");
         TUtilityString.FlushUTF(_loc3_,"已达到本轮游戏打破冰块上限");
         _loc3_.writeUnsignedInt(1);
         _loc3_.writeUnsignedInt(1);
         _loc3_.writeUnsignedInt(0);
         _loc3_.writeUnsignedInt(0);
      ...
      public function TestInit1() : ByteArray
      {
         ...
         TUtilityString.FlushUTF(_loc3_,"活动详情长");
         TUtilityString.FlushUTF(_loc3_,"活动详情短");
         TUtilityString.FlushUTF(_loc3_,"每个藏宝图内都有X个炸弹!");
         TUtilityString.FlushUTF(_loc3_,"是否花费%0金币购买并使用藏宝图?");
         TUtilityString.FlushUTF(_loc3_,"忍者TIPS");
         TUtilityString.FlushUTF(_loc3_,"达到%0可领");
         TUtilityString.FlushUTF(_loc3_,"你挖到了%0个收集物");
         TUtilityString.FlushUTF(_loc3_,"你挖到了炸弹");
