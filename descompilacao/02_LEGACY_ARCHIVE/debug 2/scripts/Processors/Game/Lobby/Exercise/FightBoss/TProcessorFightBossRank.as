package Processors.Game.Lobby.Exercise.FightBoss
{
   ...
   public class TProcessorFightBossRank extends TProcessorLobbyWindow
   {
      ...
      public function TProcessorFightBossRank(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         SResourcesCore.TexturesSwfLobby.LoadPrimary(2550136837);
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("MC_FightBossRank") as MovieClip;
      ...
      {
         if(this.FFightBoss.CurRank <= 0)
         {
            this.FMC_Scene["TF_CurRank"].text = STRING_BASEACTIVITY.FORMAT_NEVER_IN_RANK;
         }
         else
         {
            this.FMC_Scene["TF_CurRank"].text = this.FFightBoss.CurRank.toString();
         }
         this.FMC_Scene["TF_Count"].text = this.FFightBoss.Score.toString();
      }
      ...
      protected function UpdateBox() : void
      {
         ...
         {
            if(_loc1_ < this.FFightBoss.RankRewardList.length)
            {
               _loc4_ = this.FFightBoss.RankRewardList[_loc1_];
      ...
      protected function UpdateRank() : void
      {
         ...
         this.FUIPage.TotalQuantity = this.FFightBoss.RankList.length;
         this.FUIPage.Update();
         _loc1_ = 0;
         while(_loc1_ < RANK_COUNT)
         {
            ...
            if(_loc2_ < this.FFightBoss.RankList.length)
            {
               _loc8_ = this.FFightBoss.RankList[_loc2_];
               if(this.FCurPage == 0)
               {
