package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   import Processors.Game.Lobby.ActivityInner.Components.*;
   ...
   public class TProcessorWindowActivityInnerPetRank extends TProcessorWindowWonderfulActivity
   {
      ...
      public function TProcessorWindowActivityInnerPetRank(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function ConstructRewardUI() : void
      {
         ...
         {
            _loc3_ = new TActivityReward(this,2);
            ...
            _loc4_ = TUtilityString.Format(STRING_ACTIVITYINNER.FormatString_ArenaRank,_loc1_ + 1 + "");
            _loc3_.SetRankText(_loc4_);
            _loc1_++;
         }
      ...
      protected function FlushAutoRecevieData() : void
      {
         ...
         _loc9_ = this.FInforArray.length / 4;
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            ...
            if(_loc1_ < _loc9_)
            {
               _loc12_ = uint(this.FInforArray[_loc1_ * 4 + 2]);
               _loc13_ = (_loc12_ - 18100000) / 100;
               _loc14_ = (_loc12_ - 18100000) % 100 - 1;
               if(_loc14_ >= 0)
               {
                  _loc6_ = this.FInforArray[_loc1_ * 4 + 1];
                  _loc15_ = STRING_ACTIVITYINNER.FormatString_PetLevel;
                  _loc15_ = _loc15_.split("%biglevel%").join(_loc13_ + 1);
                  _loc10_ = _loc15_ = _loc15_.split("%level%").join(_loc14_);
                  _loc11_ = STRING_COMMON.ITEMNAME_Exp + ":" + this.FInforArray[_loc1_ * 4 + 3];
               }
               else
               {
                  _loc6_ = STRING_ACTIVITYINNER.STREING_NoRank;
      ...
      protected function UpdateBtn() : void
      {
         ...
         _loc5_ = (SLogicsCore.Character.Pet.PetID - 18100000) / 100;
         _loc6_ = (SLogicsCore.Character.Pet.PetID - 18100000) % 100 - 1;
         _loc7_ = STRING_ACTIVITYINNER.FormatString_PetLevel;
         _loc7_ = _loc7_.split("%biglevel%").join(_loc5_ + 1);
         _loc7_ = _loc7_.split("%level%").join(_loc6_);
         _loc3_ = TUtilityString.Format(STRING_ACTIVITYINNER.FormatString_MyPetLevel,_loc7_);
         this.FTF_MyPower.text = _loc3_;
         _loc1_ = uint(this.FActivityDataManualReceive.ConditionValue[0]);
         _loc2_ = uint(this.FActivityDataManualReceive.ConditionValue[1]);
         _loc4_ = STRING_ACTIVITYINNER.FormatString_PetLevel;
         _loc4_ = _loc4_.split("%biglevel%").join(_loc1_ + 1);
         _loc4_ = _loc4_.split("%level%").join(_loc2_);
         _loc3_ = TUtilityString.Format(STRING_ACTIVITYINNER.FormatString_GoalPetLevel,_loc4_);
         this.FTF_GoalPower.text = _loc3_;
         ...
         else if(_loc5_ > this.FActivityDataManualReceive.ConditionValue[0] || _loc5_ == this.FActivityDataManualReceive.ConditionValue[0] && _loc6_ >= this.FActivityDataManualReceive.ConditionValue[1])
         {
      ...
      protected function RequestAllPetRank() : void
      {
         var _loc1_:TPacket = null;
         _loc1_ = SNetworkCore.PacketAcquire(CONST_NETWORK.PACKETID_CS_FightingShow_AllSinglePetRankReq);
         SNetworkCore.Transceiver.PacketTransmit(_loc1_);
         this.FTickStore = STimingCore.TickCount;
      }
      
      protected function RequestPetRank() : void
      {
         var _loc1_:TPacket = null;
         _loc1_ = SNetworkCore.PacketAcquire(CONST_NETWORK.PACKETID_CS_FightingShow_SinglePetRankReq);
         SNetworkCore.Transceiver.PacketTransmit(_loc1_);
      }
      ...
      public function SetSingleRank(param1:TPacket) : void
      {
         var _loc2_:uint = 0;
      ...
      public function SetAllRank(param1:TPacket) : void
      {
      ...
      public function TestData() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            this.FInforArray.push("Index_" + _loc2_);
            _loc5_ = 18100101 + _loc2_;
            this.FInforArray.push(_loc5_);
            _loc6_ = 9000000 + 100 * _loc2_;
            this.FInforArray.push(_loc6_);
            _loc2_++;
         }
         this.FlushAutoRecevieData();
