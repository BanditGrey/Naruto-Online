package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   public class TProcessorWindowActivityInnerCamp extends TProcessorWindowWonderfulActivity
   {
      ...
      public function TProcessorWindowActivityInnerCamp(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function SlotsOnQuerySubscript(param1:Object, param2:Object, param3:TQueryString) : void
      {
         ...
         if(param2 is TInventory)
         {
            ...
            if(_loc4_.Quantity >= 10000)
            {
               param3.Value = (_loc4_.Quantity / 10000).toString();
            }
            else
            {
      ...
      {
         this.FMC_Reward.SetText(STRING_ACTIVITYINNER.STRING_PASS,STRING_ACTIVITYINNER.STRING_PASSNAME1,TUtilityString.Format(STRING_ACTIVITYINNER.FORMAT_REMAINCOUNT,param1));
         if(param1 == 0)
         {
      ...
      {
         ReceiveAward(this.FActivityAtoms.GetActivityAtomByIndex(0).Identifier);
      }
