package Processors.Game.Lobby.ActivityInner.Window
{
   ...
   public class TProcessorWindowActivityInnerJadeHF extends TProcessorWindowWonderfulActivity
   {
      ...
      protected static const MIN_SCROLL_HEIGHT:Number = 360;
      ...
      protected static const KEY_Jade_Lv12_Lift:uint = CONST_COUNTER.KEY_Jade_Lv12_Lift;
      
      protected static const KEY_Jade_Lv12_Power:uint = CONST_COUNTER.KEY_Jade_Lv12_Power;
      
      protected static const KEY_Jade_Lv12_Agile:uint = CONST_COUNTER.KEY_Jade_Lv12_Agile;
      
      protected static const KEY_Jade_Lv12_Intelligence:uint = CONST_COUNTER.KEY_Jade_Lv12_Intelligence;
      ...
      public function TProcessorWindowActivityInnerJadeHF(param1:TUIComponent)
      {
         super(param1);
         this.FRewardList = new Vector.<TActivityReward>();
         this.FCurNCount = new Vector.<int>(ROW_COUNT);
         this.FRewardList = new Vector.<TActivityReward>();
      ...
      protected function LogicsPerform_Signals() : void
      {
         ...
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         _loc1_ = SLogicsCore.SignalRetrieve(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_JadeHF_Ret);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         switch(_loc2_)
         {
            case KEY_Jade_Lv12_Lift:
               this.FCurNCount[0] = _loc3_;
               break;
            case KEY_Jade_Lv12_Power:
               this.FCurNCount[1] = _loc3_;
               break;
            case KEY_Jade_Lv12_Agile:
               this.FCurNCount[2] = _loc3_;
               break;
            case KEY_Jade_Lv12_Intelligence:
               this.FCurNCount[3] = _loc3_;
         }
         this.UpdateUI();
      }
      ...
      protected function UpdateReward() : void
      {
         ...
         var _loc1_:String = STRING_ACTIVITYINNER.STRING_JADE_COUNT;
         var _loc2_:String = STRING_ACTIVITYINNER.STRING_JADE_STATUS;
         var _loc10_:int = 0;
         while(_loc10_ < ROW_COUNT)
         {
            ...
            _loc4_ = STRING_ACTIVITYINNER.STRING_JADE_LEVEL_HF[_loc10_];
            _loc5_ = TUtilityString.Format(_loc2_,this.FCurNCount[_loc10_],this.FActivityAtoms.GetActivityAtomByIndex(_loc10_).ConditionValue[0]);
      ...
      {
         this.FCountKey.push(KEY_Jade_Lv12_Lift);
         this.FCountKey.push(KEY_Jade_Lv12_Power);
         this.FCountKey.push(KEY_Jade_Lv12_Agile);
         this.FCountKey.push(KEY_Jade_Lv12_Intelligence);
         SLogicsCore.SignalPost(CONST_SIGNAL.SIGNALDESTINATION_ACTIVE_JadeHF_Req,0,0,this.FCountKey);
      }
