package Processors.Game.Lobby.SummonBattle
{
   ...
   import Processors.Game.Windows.Information.TUIWindowSummonBuyGoods;
   ...
   public class TProcessorSummonBattleMall extends TProcessorWindowTemplate
   {
      ...
      protected var FUIWindowBuyGoods:TUIWindowSummonBuyGoods;
      ...
      protected var FUnstreamizerSummonBattle:TUnstreamizerSummonBattle;
      
      public var FPointId:int;
      ...
      public function TProcessorSummonBattleMall(param1:TUIComponent)
      {
         super(param1);
         this.Init();
      }
      ...
      protected function Init() : void
      {
         ...
         this.FUnstreamizerSummonBattle = new TUnstreamizerSummonBattle();
      }
      ...
      override protected function ResourcesPerform_UIDispatch() : void
      {
         ...
         FMainUI = TUtilityReflection.CreateDisplayObjectInstance("sumonBattleMall") as Sprite;
         UIDispatch();
         ...
         this.FUIWindowBuyGoods = new TUIWindowSummonBuyGoods(this,CONST_MODULES.MODULE_SummonBattle);
      ...
      override protected function ResourcesPerform_UILocations() : void
      {
         ...
         this.FUnstreamizerSummonBattle.UnstreamizeInventorySamplesByDatabase(null,this.FInventorySamples,null);
      }
      ...
      {
         this.FTF_NinjaPoint.text = this.FPointId.toString();
         this.FUIWindowBuyGoods.PointId = this.FPointId;
      }
      ...
      protected function SlotsOnQuerySequenceContext(param1:Object, param2:Object, param3:TQueryAnimationSequence, param4:uint = 0) : void
      {
         ...
         {
            _loc6_.LoadSecondary(_loc5_.IDTexture,CONST_MODULES.MODULE_SummonBattle);
         }
      }
