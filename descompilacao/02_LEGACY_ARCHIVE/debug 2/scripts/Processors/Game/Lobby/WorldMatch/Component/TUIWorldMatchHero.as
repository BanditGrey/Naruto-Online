package Processors.Game.Lobby.WorldMatch.Component
{
   ...
   public class TUIWorldMatchHero extends TProcessorGame
   {
      ...
      public function TUIWorldMatchHero(param1:TUIComponent, param2:int)
      {
         super(param1);
      ...
      protected function UIDispatch() : void
      {
         ...
         this.FMC_Role.scaleX = this.FIndex & 1 ? -1 : 1;
      ...
      protected function UpdateUI() : void
      {
         ...
         if(this.FContext is TWorldMatchPlayerInfo)
         {
            _loc1_ = this.FContext as TWorldMatchPlayerInfo;
            this.FTF_Name.text = _loc1_.PlayerName;
            this.FTF_Ranking.text = TUtilityString.Format(STRING_PALACE.FORMAT_Ranking,_loc1_.TargetRank.toString());
            this.FUIHero.Context = _loc1_.HeroId;
            if(_loc1_.Identifier0 == SLogicsCore.Character.Identifier0 && _loc1_.Identifier1 == SLogicsCore.Character.Identifier1)
            {
      ...
      protected function HeroOnQuerySequenceContext(param1:Object, param2:Object, param3:TQueryAnimationSequence, param4:uint = 0) : void
      {
         ...
         {
            _loc6_.LoadSecondary(_loc10_.Model,CONST_MODULES.MODULE_WorldMatch);
            this.FUIHero.X = 0;
            this.FUIHero.Y = 0;
         }
      }
      ...
      protected function MCLookOnClick(param1:MouseEvent) : void
      {
         ...
         _loc2_ = new TCoordinate();
         _loc2_.X = this.Resource.x;
         _loc2_.Y = this.Resource.y;
         if(this.FLookHeroInfoOnClick != null)
         {
            this.FLookHeroInfoOnClick(this,this.FContext,_loc2_);
         }
      }
      
      protected function MCRoleOnClick(param1:MouseEvent) : void
      {
         var _loc2_:TWorldMatchPlayerInfo = null;
         if(this.FContext == null)
         {
            return;
         }
         _loc2_ = this.FContext as TWorldMatchPlayerInfo;
         if(_loc2_.Identifier0 == SLogicsCore.Character.Identifier0 && _loc2_.Identifier1 == SLogicsCore.Character.Identifier1)
         {
            return;
         }
