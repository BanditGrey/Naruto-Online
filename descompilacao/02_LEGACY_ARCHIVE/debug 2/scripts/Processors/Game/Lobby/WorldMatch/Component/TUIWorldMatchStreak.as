package Processors.Game.Lobby.WorldMatch.Component
{
   ...
   public class TUIWorldMatchStreak extends TUIComponent
   {
      ...
      protected var FWorldMatchStreak:TWorldMatchStreak;
      ...
      public function TUIWorldMatchStreak(param1:TUIComponent)
      {
         super(param1);
      ...
      {
         this.FMC_Scene = TUtilityReflection.CreateDisplayObjectInstance("box_GlobalArenaStreak") as MovieClip;
      ...
      public function SetDate(param1:TWorldMatchStreak) : void
      {
         this.FWorldMatchStreak = param1;
         if(this.FWorldMatchStreak)
         {
            this.FUIReward.UpdateUI(this.FWorldMatchStreak.RewardList);
            this.FUISpecReward.UpdateUI(this.FWorldMatchStreak.TopRewardList);
            this.FMC_Scene["TF_Level"].text = this.FWorldMatchStreak.Level;
            this.FMC_Scene["TTF_Count"].text = this.FWorldMatchStreak.Count;
            this.FEffectGlow && this.FEffectGlow.Stop();
            if(this.FWorldMatchStreak.Reward == 1)
            {
            ...
            else
            {
               ...
               if(this.FWorldMatchStreak.Reward == 0)
               {
                  this.FEffectGlow && this.FEffectGlow.Run();
               }
            }
            if(this.FWorldMatchStreak.TopReward == 0)
            {
               TGameUtil.setButtonMode(this.FMC_Scene["BTN_SpecAward"],true);
            ...
            TGameUtil.ChangeBtnContent(this.FMC_Scene["BTN_SpecAward"],this.FWorldMatchStreak.TopReward == 1 ? STRING_BASEACTIVITY.FORMAT_BTN_STRING_1 : STRING_TONGLING.TONGLING_LINGQU);
         }
      }
      
      public function get WorldMatchStreak() : TWorldMatchStreak
      {
         return this.FWorldMatchStreak;
      }
      ...
      {
         if(this.OnRewardLevelGift != null && this.FWorldMatchStreak != null)
         {
            this.OnRewardLevelGift(this.FWorldMatchStreak.Identifier,GIFTS_NORMAL);
         }
      }
      ...
      protected function OnBtnSpecAward(param1:MouseEvent) : void
      {
         if(this.OnRewardLevelGift != null && this.FWorldMatchStreak != null)
         {
            this.OnRewardLevelGift(this.FWorldMatchStreak.Identifier,GIFTS_TOPUP);
         }
      }
