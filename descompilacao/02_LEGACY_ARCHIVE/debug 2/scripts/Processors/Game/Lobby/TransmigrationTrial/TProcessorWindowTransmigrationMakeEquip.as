package Processors.Game.Lobby.TransmigrationTrial
{
   ...
   import Processors.Game.Lobby.TransmigrationTrial.Component.TMakeEquip;
   ...
   public class TProcessorWindowTransmigrationMakeEquip extends TProcessorGame
   {
      ...
      protected var FEquipGenerateBin:TBins;
      ...
      public function TProcessorWindowTransmigrationMakeEquip(param1:TUIComponent)
      {
         super(param1);
      ...
      protected function UpdateMakeEquips() : void
      {
         ...
         var _loc6_:TEquipGenerate = null;
         var _loc7_:uint = 0;
         var _loc8_:uint = 0;
         if(this.FCurSelectMakeEquip == null)
         {
         ...
         else
         {
            ...
            _loc6_ = this.FEquipGenerateBin.GetDatebaseByIdentifier(_loc5_.IDTemplate) as TEquipGenerate;
      ...
      protected function OnMakeClick(param1:MouseEvent) : void
      {
         ...
         _loc2_ = SNetworkCore.PacketAcquire(CONST_NETWORK.PACKETID_CS_TransmigrationTrial_MakeEquip_Req);
      ...
      protected function TabOnSwitch(param1:Object) : void
      {
         ...
         this.FScrollBar.IsNoToUp = false;
         this.Update();
      }
      ...
      protected function GetMakeEquip() : TMakeEquip
      {
         ...
         {
            _loc1_ = this.FMC_FreeMakeEquipList.shift();
         }
         else
         {
      ...
      public function SetScene(param1:MovieClip) : void
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         var _loc4_:TEquipGenerate = null;
         ...
         this.FEquipGenerateBin = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_EquipGenerate) as TBins;
         _loc3_ = uint(this.FEquipGenerateBin.Count);
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            _loc4_ = this.FEquipGenerateBin.GetDatebaseByIndex(_loc2_) as TEquipGenerate;
            if(_loc4_.IsEpic > 0)
            {
