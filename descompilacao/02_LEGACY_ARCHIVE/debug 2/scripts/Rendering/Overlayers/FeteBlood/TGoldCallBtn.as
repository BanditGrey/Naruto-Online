package Rendering.Overlayers.FeteBlood
{
   ...
   public class TGoldCallBtn extends TOverlayer
   {
      ...
      protected var TPTimes:TPainterHtmlTextEffect;
      ...
      public function TGoldCallBtn(param1:TUIComponent)
      {
         super(param1);
         FWordWrapWidth = 270;
         this.TPTimes = this.ConstructPainterHtmlTextEffect(COLOR_Context_White);
      ...
      {
         this.FBTimes.Width = FBoundsContext.Width;
