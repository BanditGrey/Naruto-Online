package Externals
{
   ...
   public class TExternalCore
   {
      ...
      protected var FCallBackAccount:Function;
      ...
      public function TExternalCore()
      {
         ...
         if(ExternalInterface.available)
         {
            ExternalInterface.addCallback("RegisterAccountCallBack",this.RegisterAccountCallBack);
         }
      }
      ...
      public function get CallBackAccount() : Function
      {
         return this.FCallBackAccount;
      }
      
      public function set CallBackAccount(param1:Function) : void
      {
         this.FCallBackAccount = param1;
      }
      ...
      {
         if(SParametersCore.AgentID == CONST_PLATE.ID_PLATE_US || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_JOYGAME || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_RU_WIKI || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_DE || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_ESP || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_RU_OTHER || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_RU_GN || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_ID || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_UK || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_USFB || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_JOYFUN || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_EUROPE || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_IT || SParametersCore.AgentID == CONST_PLATE.ID_PLATE_FB_OTHER)
         {
            if(ExternalInterface.available)
            {
         ...
         else if(SParametersCore.AgentID == CONST_PLATE.ID_PLATE_TH_FACEBOOK)
         {
            if(ExternalInterface.available)
            {
      ...
      public function CommitAccountSafe(param1:String, param2:String) : void
      {
         if(ExternalInterface.available)
         {
            ExternalInterface.call("collectData",param1,param2);
         }
      }
      
      public function RegisterAccountCallBack(param1:Object) : void
      {
         if(this.FCallBackAccount != null)
         {
            this.FCallBackAccount(param1);
         }
      }
