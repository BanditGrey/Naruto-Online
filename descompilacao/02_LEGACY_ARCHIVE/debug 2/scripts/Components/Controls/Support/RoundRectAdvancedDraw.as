package Components.Controls.Support
{
   ...
   public class RoundRectAdvancedDraw
   {
      ...
      public static function drawAdvancedRoundRect(param1:Graphics, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Number, param12:Number, param13:Number, param14:Number, param15:Number) : void
      {
         var _loc16_:Number = param2 + param4;
         var _loc17_:Number = param3 + param5;
         var _loc18_:Number = param4 / 2;
         var _loc19_:Number = param5 / 2;
         _loc19_ = _loc18_ = Math.min(_loc18_,_loc19_);
         if(param7 == 0)
         {
            param7 = param6;
         }
         ...
         var _loc21_:Number = param14 * 0.292893218813453;
         var _loc22_:Number = param15 * 0.292893218813453;
         var _loc23_:Number = param14 * 0.585786437626905;
         var _loc24_:Number = param15 * 0.585786437626905;
         param1.moveTo(_loc16_,_loc17_ - param15);
         param1.curveTo(_loc16_,_loc17_ - _loc24_,_loc16_ - _loc21_,_loc17_ - _loc22_);
         param1.curveTo(_loc16_ - _loc23_,_loc17_,_loc16_ - param14,_loc17_);
         _loc21_ = param12 * 0.292893218813453;
         _loc22_ = param13 * 0.292893218813453;
         _loc23_ = param12 * 0.585786437626905;
         _loc24_ = param13 * 0.585786437626905;
         param1.lineTo(param2 + param12,_loc17_);
         param1.curveTo(param2 + _loc23_,_loc17_,param2 + _loc21_,_loc17_ - _loc22_);
         param1.curveTo(param2,_loc17_ - _loc24_,param2,_loc17_ - param13);
         _loc21_ = param8 * 0.292893218813453;
         _loc22_ = param9 * 0.292893218813453;
         _loc23_ = param8 * 0.585786437626905;
         _loc24_ = param9 * 0.585786437626905;
         param1.lineTo(param2,param3 + param9);
         param1.curveTo(param2,param3 + _loc24_,param2 + _loc21_,param3 + _loc22_);
         param1.curveTo(param2 + _loc23_,param3,param2 + param8,param3);
         _loc21_ = param10 * 0.292893218813453;
         _loc22_ = param11 * 0.292893218813453;
         _loc23_ = param10 * 0.585786437626905;
         _loc24_ = param11 * 0.585786437626905;
         param1.lineTo(_loc16_ - param10,param3);
         param1.curveTo(_loc16_ - _loc23_,param3,_loc16_ - _loc21_,param3 + _loc22_);
         param1.curveTo(_loc16_,param3 + _loc24_,_loc16_,param3 + param11);
         param1.lineTo(_loc16_,_loc17_ - param15);
      }
      
      public static function drawAdvancedRoundRectNoMax(param1:Graphics, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Number, param12:Number, param13:Number, param14:Number, param15:Number) : void
      {
         var _loc16_:Number = param2 + param4;
         var _loc17_:Number = param3 + param5;
         var _loc18_:Number = param4 / 2;
