package Logics.Streamization.Exercise
{
   ...
   public class TUnstreamizerEverydaySale extends TUnstreamizer
   {
      
      protected var FUnstreamizerInventoryReference:TUnstreamizerInventoryReference;
      
      public function TUnstreamizerEverydaySale()
      {
         super();
      ...
      override protected function UnstreamizationPerform(param1:ByteArray, param2:Object, param3:Object) : void
      {
         ...
         var _loc17_:TEverydaySale = null;
         _loc13_ = new Vector.<uint>();
         _loc14_ = new Vector.<uint>();
         _loc17_ = param2 as TEverydaySale;
         _loc15_ = SResourcesCore.ResourceBin.GetBinsByResourceID(CONST_DATEBASEVO.RESOURCEID_Article);
         _loc17_.Identify = CONST_BASEACTIVITY.TYPE_NewActiveList_EverydaySale;
         ...
         _loc17_.SaleType = param1.readUnsignedInt();
         _loc17_.Count = param1.readUnsignedInt();
         _loc17_.RechargeGold = param1.readUnsignedInt();
         _loc17_.BaseBox.Price = param1.readUnsignedInt();
         _loc17_.BaseBox.Count = param1.readUnsignedInt();
         _loc17_.BaseBox.BuyCount = param1.readUnsignedInt();
         _loc17_.BaseBox.Status = param1.readInt();
         ...
         _loc17_.BaseBox.Inventories = _loc9_;
         ...
         while(_loc4_ < _loc6_)
         {
            ...
            _loc17_.Rewards[_loc4_] = _loc16_;
            _loc4_++;
         }
      }
