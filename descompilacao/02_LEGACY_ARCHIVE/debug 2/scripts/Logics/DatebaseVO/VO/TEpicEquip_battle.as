package Logics.DatebaseVO.VO
{
   ...
   public class TEpicEquip_battle extends TDatebaseVO
   {
      ...
      protected var FPiecepoitAward:String;
      ...
      protected var FPiecepoitAwardItem:Vector.<Object>;
      
      protected var FPieceAwardItem:Vector.<Object>;
      
      public function TEpicEquip_battle()
      {
         super();
      }
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         TUtilityString.FlushUTF(param1,this.FPiecepoitAward);
      ...
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         ...
         this.FPiecepoitAward = TUtilityString.FetchUTF(param1);
         ...
         this.FPiecepoitAwardItem = Vector.<Object>(Json.decode(this.FPiecepoitAward));
         this.FPieceAwardItem = Vector.<Object>(Json.decode(this.FPieceAward));
      }
      ...
      public function get PiecepoitAward() : String
      {
         return this.FPiecepoitAward;
      }
      ...
      public function get PiecepoitAwardItem() : Vector.<Object>
      {
         return this.FPiecepoitAwardItem;
      }
      
      public function get PieceAwardItem() : Vector.<Object>
      {
         return this.FPieceAwardItem;
      }
   }
}
