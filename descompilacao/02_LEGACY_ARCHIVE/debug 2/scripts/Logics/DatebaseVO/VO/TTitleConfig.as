package Logics.DatebaseVO.VO
{
   ...
   public class TTitleConfig extends TDatebaseVO
   {
      ...
      override ResourcesSpace function WriteDataToStream(param1:ByteArray) : void
      {
         ...
         param1.writeUnsignedInt(this.FTitleType);
         ...
         param1.writeUnsignedInt(this.FIsHide);
      }
      ...
      override ResourcesSpace function ReadDataByStream(param1:ByteArray) : void
      {
         ...
         this.FTitleType = param1.readUnsignedInt();
         ...
         this.FIsHide = param1.readUnsignedInt();
      }
      ...
      public function get IsHide() : uint
      {
         return this.FIsHide;
      }
